...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.25.14-blue" alt="Version" />
...
|------------|-------|---------|
| **WS-AD** | Pre-Release Audit Remediation — 21 findings (7 actionable), Phase AD1: orphaned module integration, Phase AD2: code quality hardening, Phase AD3: production deployment documentation, Phase AD4: 33 cross-subsystem composition bridge lemmas covering all 31 kernel operations (5 phases, 19+ tasks) | v0.25.11–v0.25.14 |
