...
- **EDF + priority scheduling** with priority-bucketed `RunQueue`, domain-aware partitioning, inline `maxPriority` tracking, and bidirectional `membership ↔ flat` consistency lemmas (`flat_wf` + `membership_implies_flat`)
...
| **Completed** | WS-H6 (v0.12.20), WS-H5 (v0.12.19), WS-H4 (v0.12.18), WS-H3 (v0.12.17), WS-H2 (v0.12.16), WS-H1 (v0.12.16), WS-G (v0.12.15), WS-F1..F4 (v0.12.2), WS-E (v0.11.6), WS-D (v0.11.0), WS-C (v0.9.32), WS-B (v0.9.0) |
