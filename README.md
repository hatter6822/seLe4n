...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.25.15-blue" alt="Version" />
...
|------------|-------|---------|
| **WS-AE** | Production Audit Remediation — Phase AE1: API dispatch parity, wildcard unreachability, switchDomain NI composition, donation/PIP NI proofs, master dispatch NI theorem (8 tasks) | v0.25.15 |
