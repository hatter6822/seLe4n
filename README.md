...
| **Production Lean LoC** | 115,282 across 175 files |
| **Test Lean LoC** | 21,590 across 30 test suites |
| **Proved declarations** | 3,352 theorem/lemma declarations (zero sorry/axiom) |
| **Rust crates** | 5 (`sele4n-types`, `sele4n-abi`, `sele4n-sys`, `sele4n-hal`, `sele4n-host`) across 54 source files. `sele4n-host` is the host-side runtime added at WS-RH RH-H — std-opting, zero unsafe, never linked into the kernel TCB; see [`docs/planning/rust_host_runtime_plan.md`](docs/planning/rust_host_runtime_plan.md). |
