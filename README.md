...
- **Active development slice:** Comprehensive Audit 2026-02 execution (WS-B portfolio; WS-B1, WS-B2, and WS-B3 completed).
...
- **Current package version:** `0.9.9` (`lakefile.toml`).
