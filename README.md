...
- **EDF + priority scheduling** with priority-bucketed `RunQueue`, domain-aware partitioning, inline `maxPriority` tracking, and bidirectional membership/list consistency (`flat_wf`, `flat_wf_rev`, `membership_implies_flat`)
