...
def format_readme(manifest: dict) -> str:
    ...
    lines.append("[`docs/spec/SELE4N_SPEC.md`](../spec/SELE4N_SPEC.md).")
    lines.append("Upstream seL4 microkernel reference:")
    lines.append("[`docs/spec/SEL4_SPEC.md`](../spec/SEL4_SPEC.md).")
    lines.append("")
