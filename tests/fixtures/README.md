...
| `two_phase_arch_smoke.expected` | `two_phase_arch_smoke.expected.sha256` | **scenario-traceability manifest**, not golden output: same two gates, against `lake exe two_phase_arch_suite` |
