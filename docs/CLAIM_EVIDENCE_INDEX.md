...
|---|---|---|---|
| Active findings baseline is v0.12.2 audits + v0.12.5 hardware readiness audit. | `README.md`, `docs/spec/SELE4N_SPEC.md` | `./scripts/test_tier3_invariant_surface.sh` | Tier-3 doc-anchor checks over README/spec/planning references. |
| Hardware readiness audit confirms H2 complete, H3 ready to begin. | `docs/audits/AUDIT_HARDWARE_READINESS_v0.12.5.md` | `./scripts/test_full.sh` | 522 theorems, zero sorry/axiom, all 4 test tiers pass, WS-G workstreams planned. |
| All prior portfolios complete (WS-F, WS-E, WS-D, WS-C, WS-B). | `docs/audits/AUDIT_v0.12.2_WORKSTREAM_PLAN.md`, `docs/dev_history/audits/` | `./scripts/test_full.sh` | Historical; evidence preserved in prior tier runs. |
