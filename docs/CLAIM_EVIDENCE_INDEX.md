...
| TPI-D07 | Service dependency acyclicity invariant (Risk 0 resolved: vacuous definition fixed, declarative proof complete; BFS completeness bridge `sorry` tracked as TPI-D07-BRIDGE — M2 proof strategy documented with 10-step implementation roadmap, see `M2_BFS_SOUNDNESS.md` §5-§11) | WS-D4 | CLOSED |
