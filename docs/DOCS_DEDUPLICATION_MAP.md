...
| Active workstream (WS-R) | `docs/dev_history/audits/AUDIT_v0.17.14_WORKSTREAM_PLAN.md` | `05-specification-and-roadmap.md` | Keep status/closure evidence canonical in audit plan; chapter summarizes and links. |
