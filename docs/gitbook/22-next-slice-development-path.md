...
- **WS-H Phase 1–10** (v0.12.16–v0.13.6): Critical correctness fixes and
  security foundations — IPC call-path semantic fix (WS-H1), lifecycle safety
  ...
  coverage extension >80% (WS-H9), security model foundations including
  BIBA lattice, declassification model, and endpoint flow policy (WS-H10).
