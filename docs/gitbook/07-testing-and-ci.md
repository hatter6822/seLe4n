...
- **WS-R (Comprehensive Audit Remediation, v0.18.0+ — IN PROGRESS):** R1–R4 complete. Test additions include operation-chain suite extensions and cross-subsystem invariant tests.
