...
Current stage context: **WS-AK Phase AK4 COMPLETE (v0.29.8). Testing tiers enforce regression protection and evidence continuity across ~97k production LoC, ~12k test LoC (including AK3 regression suites — AsidPool, InterruptDispatch, W^X defense, decode validation — and the AK4 end-to-end ABI round-trip suite), and ~2,830 proved declarations.**
