...
- **Tier 2 (trace/behavior)**
  ...
  - all trace output lines (237 fixture lines at v0.34.113) tagged with scenario IDs across 15+ prefix families (ENT, CAT, SST, LEP, CIC, IMT, IMB, DDT, ICS, BME, STD, UMT, SGT, RCF, ITR, PTY, …),
