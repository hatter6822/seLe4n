...
Current state (as of v0.34.104): 351,182 lines of production Lean across 327 files, 71,319 lines across 70 Lean test suites,
11,729 theorem/lemma declarations, zero unsound constructs.
