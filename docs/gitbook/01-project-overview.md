...
Current state (as of v0.35.174): 405,953 lines of production Lean across 338 files, 83,005 lines across 70 Lean test suites,
13,442 theorem/lemma declarations, zero unsound constructs.
