...
Current state (as of v0.35.46): 381,844 lines of production Lean across 330 files, 77,346 lines across 70 Lean test suites,
12,733 theorem/lemma declarations, zero unsound constructs.
