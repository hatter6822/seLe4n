...
Current state (as of v0.34.130): 359,761 lines of production Lean across 328 files, 73,716 lines across 70 Lean test suites,
12,049 theorem/lemma declarations, zero unsound constructs.
