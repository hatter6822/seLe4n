...
Current state (as of v0.34.129): 359,285 lines of production Lean across 328 files, 73,670 lines across 70 Lean test suites,
12,041 theorem/lemma declarations, zero unsound constructs.
