...
Current state (as of v0.35.2): 364,378 lines of production Lean across 328 files, 74,602 lines across 70 Lean test suites,
12,164 theorem/lemma declarations, zero unsound constructs.
