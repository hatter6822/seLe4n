...
Current state (as of v0.35.108): 394,244 lines of production Lean across 333 files, 80,108 lines across 70 Lean test suites,
13,097 theorem/lemma declarations, zero unsound constructs.
