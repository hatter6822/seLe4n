...
Current state (as of v0.35.44): 380,540 lines of production Lean across 330 files, 77,224 lines across 70 Lean test suites,
12,706 theorem/lemma declarations, zero unsound constructs.
