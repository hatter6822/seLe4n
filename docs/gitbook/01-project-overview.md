...
Current state (as of v0.35.80): 386,776 lines of production Lean across 331 files, 78,841 lines across 70 Lean test suites,
12,902 theorem/lemma declarations, zero unsound constructs.
