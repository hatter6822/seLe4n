...
Current state (as of v0.36.5): 423,001 lines of production Lean across 343 files, 86,115 lines across 71 Lean test suites,
14,028 theorem/lemma declarations, zero unsound constructs.
