...
Current state (as of v0.35.165): 402,324 lines of production Lean across 334 files, 82,280 lines across 70 Lean test suites,
13,333 theorem/lemma declarations, zero unsound constructs.
