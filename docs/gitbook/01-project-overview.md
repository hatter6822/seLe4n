...
Current state (as of v0.35.58): 385,041 lines of production Lean across 330 files, 78,456 lines across 70 Lean test suites,
12,816 theorem/lemma declarations, zero unsound constructs.
