...
Current state (as of v0.35.131): 396,110 lines of production Lean across 334 files, 80,213 lines across 70 Lean test suites,
13,131 theorem/lemma declarations, zero unsound constructs.
