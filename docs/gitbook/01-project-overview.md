...
Current state (as of v0.35.78): 385,487 lines of production Lean across 331 files, 78,725 lines across 70 Lean test suites,
12,853 theorem/lemma declarations, zero unsound constructs.
