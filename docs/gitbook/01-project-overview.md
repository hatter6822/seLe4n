...
Current state (as of v0.35.182): 408,352 lines of production Lean across 338 files, 83,391 lines across 70 Lean test suites,
13,510 theorem/lemma declarations, zero unsound constructs.
