...
Current state (as of v0.34.107): 352,080 lines of production Lean across 327 files, 71,347 lines across 70 Lean test suites,
11,754 theorem/lemma declarations, zero unsound constructs.
