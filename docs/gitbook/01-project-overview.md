...
Current state (as of v0.35.179): 407,460 lines of production Lean across 338 files, 83,049 lines across 70 Lean test suites,
13,481 theorem/lemma declarations, zero unsound constructs.
