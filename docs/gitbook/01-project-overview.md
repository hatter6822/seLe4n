...
Current state (as of v0.35.135): 396,219 lines of production Lean across 334 files, 80,490 lines across 70 Lean test suites,
13,126 theorem/lemma declarations, zero unsound constructs.
