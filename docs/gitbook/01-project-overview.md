...
Current state (as of v0.35.96): 391,466 lines of production Lean across 333 files, 79,392 lines across 70 Lean test suites,
13,046 theorem/lemma declarations, zero unsound constructs.
