...
Current state (as of v0.34.95): 346,230 lines of production Lean across 324 files, 71,194 lines across 70 Lean test suites,
11,529 theorem/lemma declarations, zero unsound constructs.
