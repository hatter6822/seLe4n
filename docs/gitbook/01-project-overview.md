...
Current state (as of v0.35.40): 380,420 lines of production Lean across 330 files, 77,140 lines across 70 Lean test suites,
12,704 theorem/lemma declarations, zero unsound constructs.
