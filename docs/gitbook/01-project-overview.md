...
Current state (as of v0.35.52): 383,733 lines of production Lean across 330 files, 78,086 lines across 70 Lean test suites,
12,769 theorem/lemma declarations, zero unsound constructs.
