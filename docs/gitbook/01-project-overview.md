...
Current state (as of v0.34.100): 348,145 lines of production Lean across 326 files, 71,289 lines across 70 Lean test suites,
11,607 theorem/lemma declarations, zero unsound constructs.
