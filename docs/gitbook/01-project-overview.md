...
Current state (as of v0.34.135): 360,920 lines of production Lean across 328 files, 73,943 lines across 70 Lean test suites,
12,076 theorem/lemma declarations, zero unsound constructs.
