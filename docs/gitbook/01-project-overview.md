...
Current state (as of v0.35.36): 378,753 lines of production Lean across 330 files, 76,540 lines across 70 Lean test suites,
12,671 theorem/lemma declarations, zero unsound constructs.
