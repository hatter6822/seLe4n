...
Current state (as of v0.34.102): 349,349 lines of production Lean across 326 files, 71,289 lines across 70 Lean test suites,
11,667 theorem/lemma declarations, zero unsound constructs.
