...
Current state (as of v0.35.10): 375,003 lines of production Lean across 329 files, 75,860 lines across 70 Lean test suites,
12,599 theorem/lemma declarations, zero unsound constructs.
