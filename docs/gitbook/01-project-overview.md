...
Current state (as of v0.35.97): 391,604 lines of production Lean across 333 files, 79,392 lines across 70 Lean test suites,
13,052 theorem/lemma declarations, zero unsound constructs.
