...
Current state (as of v0.35.50): 382,916 lines of production Lean across 330 files, 77,855 lines across 70 Lean test suites,
12,754 theorem/lemma declarations, zero unsound constructs.
