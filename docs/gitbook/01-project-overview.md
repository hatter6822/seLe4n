...
Current state (as of v0.34.142): 361,981 lines of production Lean across 328 files, 74,275 lines across 70 Lean test suites,
12,106 theorem/lemma declarations, zero unsound constructs.
