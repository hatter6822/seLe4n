...
Current state (as of v0.35.171): 404,987 lines of production Lean across 336 files, 82,900 lines across 70 Lean test suites,
13,424 theorem/lemma declarations, zero unsound constructs.
