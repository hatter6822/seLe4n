...
Current state (as of v0.35.3): 364,812 lines of production Lean across 328 files, 74,909 lines across 70 Lean test suites,
12,185 theorem/lemma declarations, zero unsound constructs.
