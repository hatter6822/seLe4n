...
Current state (as of v0.34.127): 357,749 lines of production Lean across 328 files, 73,315 lines across 70 Lean test suites,
11,997 theorem/lemma declarations, zero unsound constructs.
