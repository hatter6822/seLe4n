...
Current state (as of v0.35.37): 378,887 lines of production Lean across 330 files, 76,620 lines across 70 Lean test suites,
12,676 theorem/lemma declarations, zero unsound constructs.
