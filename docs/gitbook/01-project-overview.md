...
Current state (as of v0.35.86): 389,153 lines of production Lean across 332 files, 79,007 lines across 70 Lean test suites,
12,967 theorem/lemma declarations, zero unsound constructs.
