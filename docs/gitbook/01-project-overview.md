...
Current state (as of v0.35.187): 410,383 lines of production Lean across 338 files, 83,589 lines across 70 Lean test suites,
13,573 theorem/lemma declarations, zero unsound constructs.
