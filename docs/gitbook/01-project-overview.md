...
Current state (as of v0.35.67): 385,998 lines of production Lean across 330 files, 78,763 lines across 70 Lean test suites,
12,876 theorem/lemma declarations, zero unsound constructs.
