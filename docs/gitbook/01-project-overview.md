...
Current state (as of v0.35.83): 387,521 lines of production Lean across 331 files, 78,892 lines across 70 Lean test suites,
12,918 theorem/lemma declarations, zero unsound constructs.
