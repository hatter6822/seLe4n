...
Current state (as of v0.34.103): 349,806 lines of production Lean across 327 files, 71,289 lines across 70 Lean test suites,
11,680 theorem/lemma declarations, zero unsound constructs.
