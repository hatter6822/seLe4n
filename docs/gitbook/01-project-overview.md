...
Current state (as of v0.35.193): 413,049 lines of production Lean across 339 files, 84,109 lines across 70 Lean test suites,
13,648 theorem/lemma declarations, zero unsound constructs.
