...
Current state (as of v0.35.199): 415,446 lines of production Lean across 339 files, 84,404 lines across 70 Lean test suites,
13,739 theorem/lemma declarations, zero unsound constructs.
