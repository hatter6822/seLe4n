...
Current state (as of v0.34.125): 356,971 lines of production Lean across 328 files, 73,043 lines across 70 Lean test suites,
11,935 theorem/lemma declarations, zero unsound constructs.
