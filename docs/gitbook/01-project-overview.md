...
Current state (as of v0.35.166): 402,742 lines of production Lean across 335 files, 82,280 lines across 70 Lean test suites,
13,344 theorem/lemma declarations, zero unsound constructs.
