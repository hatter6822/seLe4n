...
Current state (as of v0.34.92): 343,521 lines of production Lean across 323 files, 71,084 lines across 70 Lean test suites,
11,444 theorem/lemma declarations, zero unsound constructs.
