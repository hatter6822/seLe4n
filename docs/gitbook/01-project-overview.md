...
Current state (as of v0.35.189): 410,884 lines of production Lean across 338 files, 83,710 lines across 70 Lean test suites,
13,591 theorem/lemma declarations, zero unsound constructs.
