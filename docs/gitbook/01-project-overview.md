...
Current state (as of v0.34.87): 339,955 lines of production Lean across 317 files, 70,722 lines across 70 Lean test suites,
11,305 theorem/lemma declarations, zero unsound constructs.
