...
Current state (as of v0.34.108): 352,854 lines of production Lean across 327 files, 71,412 lines across 70 Lean test suites,
11,788 theorem/lemma declarations, zero unsound constructs.
