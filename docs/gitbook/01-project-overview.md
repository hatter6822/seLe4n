...
Current state (as of v0.35.64): 385,804 lines of production Lean across 330 files, 78,722 lines across 70 Lean test suites,
12,867 theorem/lemma declarations, zero unsound constructs.
