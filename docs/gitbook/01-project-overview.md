...
Current state (as of v0.34.109): 353,568 lines of production Lean across 327 files, 71,487 lines across 70 Lean test suites,
11,817 theorem/lemma declarations, zero unsound constructs.
