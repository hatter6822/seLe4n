...
Current state (as of v0.35.167): 403,351 lines of production Lean across 336 files, 82,491 lines across 70 Lean test suites,
13,368 theorem/lemma declarations, zero unsound constructs.
