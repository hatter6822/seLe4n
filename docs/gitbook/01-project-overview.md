...
Current state (as of v0.35.162): 399,995 lines of production Lean across 334 files, 81,812 lines across 70 Lean test suites,
13,242 theorem/lemma declarations, zero unsound constructs.
