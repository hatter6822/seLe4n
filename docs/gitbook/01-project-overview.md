...
Current state (as of v0.35.45): 382,025 lines of production Lean across 330 files, 77,280 lines across 70 Lean test suites,
12,741 theorem/lemma declarations, zero unsound constructs.
