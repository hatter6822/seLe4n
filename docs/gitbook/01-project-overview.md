...
Current state (as of v0.35.26): 376,821 lines of production Lean across 330 files, 76,127 lines across 70 Lean test suites,
12,613 theorem/lemma declarations, zero unsound constructs.
