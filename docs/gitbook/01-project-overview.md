...
Current state (as of v0.35.112): 394,808 lines of production Lean across 333 files, 80,213 lines across 70 Lean test suites,
13,115 theorem/lemma declarations, zero unsound constructs.
