...
Current state (as of v0.35.63): 385,300 lines of production Lean across 330 files, 78,723 lines across 70 Lean test suites,
12,804 theorem/lemma declarations, zero unsound constructs.
