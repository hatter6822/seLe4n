...
Current state (as of v0.35.85): 388,275 lines of production Lean across 332 files, 78,892 lines across 70 Lean test suites,
12,931 theorem/lemma declarations, zero unsound constructs.
