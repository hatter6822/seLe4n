...
Current state (as of v0.35.21): 376,395 lines of production Lean across 330 files, 76,029 lines across 70 Lean test suites,
12,607 theorem/lemma declarations, zero unsound constructs.
