...
Current state (as of v0.34.118): 355,606 lines of production Lean across 328 files, 72,488 lines across 70 Lean test suites,
11,889 theorem/lemma declarations, zero unsound constructs.
