...
Current state (as of v0.35.183): 409,202 lines of production Lean across 338 files, 83,391 lines across 70 Lean test suites,
13,536 theorem/lemma declarations, zero unsound constructs.
