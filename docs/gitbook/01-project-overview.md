...
Current state (as of v0.35.192): 412,636 lines of production Lean across 339 files, 83,961 lines across 70 Lean test suites,
13,638 theorem/lemma declarations, zero unsound constructs.
