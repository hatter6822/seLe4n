...
Current state (as of v0.35.181): 408,061 lines of production Lean across 338 files, 83,207 lines across 70 Lean test suites,
13,504 theorem/lemma declarations, zero unsound constructs.
