...
Current state (as of v0.35.172): 405,258 lines of production Lean across 336 files, 83,005 lines across 70 Lean test suites,
13,430 theorem/lemma declarations, zero unsound constructs.
