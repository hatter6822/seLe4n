...
Current state (as of v0.35.190): 411,743 lines of production Lean across 338 files, 83,880 lines across 70 Lean test suites,
13,613 theorem/lemma declarations, zero unsound constructs.
