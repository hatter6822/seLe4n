...
Current state (as of v0.34.85): 339,431 lines of production Lean across 317 files, 70,566 lines across 70 Lean test suites,
11,287 theorem/lemma declarations, zero unsound constructs.
