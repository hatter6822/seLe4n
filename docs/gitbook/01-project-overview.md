...
Current state (as of v0.35.188): 410,635 lines of production Lean across 338 files, 83,589 lines across 70 Lean test suites,
13,584 theorem/lemma declarations, zero unsound constructs.
