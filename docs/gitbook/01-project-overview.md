...
Current state (as of v0.35.95): 391,269 lines of production Lean across 333 files, 79,176 lines across 70 Lean test suites,
13,043 theorem/lemma declarations, zero unsound constructs.
