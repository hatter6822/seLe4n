...
Current state (as of v0.35.133): 396,021 lines of production Lean across 334 files, 80,339 lines across 70 Lean test suites,
13,127 theorem/lemma declarations, zero unsound constructs.
