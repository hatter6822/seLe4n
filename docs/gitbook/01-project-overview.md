...
Current state (as of v0.35.164): 401,833 lines of production Lean across 334 files, 82,175 lines across 70 Lean test suites,
13,302 theorem/lemma declarations, zero unsound constructs.
