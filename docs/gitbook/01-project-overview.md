...
Current state (as of v0.35.142): 396,419 lines of production Lean across 334 files, 80,680 lines across 70 Lean test suites,
13,128 theorem/lemma declarations, zero unsound constructs.
