...
Current state (as of v0.36.4): 422,300 lines of production Lean across 343 files, 85,915 lines across 71 Lean test suites,
14,011 theorem/lemma declarations, zero unsound constructs.
