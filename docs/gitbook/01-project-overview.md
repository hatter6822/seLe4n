...
Current state (as of v0.35.38): 379,856 lines of production Lean across 330 files, 76,925 lines across 70 Lean test suites,
12,693 theorem/lemma declarations, zero unsound constructs.
