...
Current state (as of v0.35.160): 397,589 lines of production Lean across 334 files, 81,318 lines across 70 Lean test suites,
13,152 theorem/lemma declarations, zero unsound constructs.
