...
Current state (as of v0.34.101): 348,316 lines of production Lean across 326 files, 71,289 lines across 70 Lean test suites,
11,613 theorem/lemma declarations, zero unsound constructs.
