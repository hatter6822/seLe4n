...
Current state (as of v0.35.176): 406,451 lines of production Lean across 338 files, 83,005 lines across 70 Lean test suites,
13,455 theorem/lemma declarations, zero unsound constructs.
