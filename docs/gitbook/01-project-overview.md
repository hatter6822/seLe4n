...
Current state (as of v0.34.137): 361,351 lines of production Lean across 328 files, 74,073 lines across 70 Lean test suites,
12,089 theorem/lemma declarations, zero unsound constructs.
