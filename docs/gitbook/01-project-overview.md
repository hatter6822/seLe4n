...
Current state (as of v0.35.125): 395,341 lines of production Lean across 334 files, 80,213 lines across 70 Lean test suites,
13,117 theorem/lemma declarations, zero unsound constructs.
