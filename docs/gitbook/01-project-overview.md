...
Current state (as of v0.35.48): 381,980 lines of production Lean across 330 files, 77,688 lines across 70 Lean test suites,
12,734 theorem/lemma declarations, zero unsound constructs.
