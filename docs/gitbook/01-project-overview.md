...
Current state (as of v0.34.131): 359,936 lines of production Lean across 328 files, 73,737 lines across 70 Lean test suites,
12,054 theorem/lemma declarations, zero unsound constructs.
