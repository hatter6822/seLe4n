...
Current state (as of v0.35.23): 376,503 lines of production Lean across 330 files, 76,048 lines across 70 Lean test suites,
12,610 theorem/lemma declarations, zero unsound constructs.
