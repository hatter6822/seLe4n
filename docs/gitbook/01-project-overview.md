...
Current state (as of v0.35.61): 385,353 lines of production Lean across 330 files, 78,723 lines across 70 Lean test suites,
12,823 theorem/lemma declarations, zero unsound constructs.
