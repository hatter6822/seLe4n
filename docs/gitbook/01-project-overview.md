...
Current state (as of v0.34.136): 361,146 lines of production Lean across 328 files, 74,027 lines across 70 Lean test suites,
12,084 theorem/lemma declarations, zero unsound constructs.
