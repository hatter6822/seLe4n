...
Current state (as of v0.35.49): 382,430 lines of production Lean across 330 files, 77,749 lines across 70 Lean test suites,
12,742 theorem/lemma declarations, zero unsound constructs.
