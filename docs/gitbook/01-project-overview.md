...
Current state (as of v0.35.51): 383,641 lines of production Lean across 330 files, 77,948 lines across 70 Lean test suites,
12,767 theorem/lemma declarations, zero unsound constructs.
