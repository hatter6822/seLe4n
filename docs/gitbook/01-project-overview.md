...
Current state (as of v0.35.161): 399,198 lines of production Lean across 334 files, 81,487 lines across 70 Lean test suites,
13,210 theorem/lemma declarations, zero unsound constructs.
