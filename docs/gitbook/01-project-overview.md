...
Current state (as of v0.35.169): 404,112 lines of production Lean across 336 files, 82,662 lines across 70 Lean test suites,
13,396 theorem/lemma declarations, zero unsound constructs.
