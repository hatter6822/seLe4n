...
Current state (as of v0.35.59): 385,223 lines of production Lean across 330 files, 78,645 lines across 70 Lean test suites,
12,821 theorem/lemma declarations, zero unsound constructs.
