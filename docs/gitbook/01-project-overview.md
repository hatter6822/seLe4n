...
Current state (as of v0.35.178): 407,096 lines of production Lean across 338 files, 83,035 lines across 70 Lean test suites,
13,473 theorem/lemma declarations, zero unsound constructs.
