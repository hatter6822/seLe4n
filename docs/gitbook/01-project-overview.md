...
Current state (as of v0.34.132): 360,465 lines of production Lean across 328 files, 73,833 lines across 70 Lean test suites,
12,064 theorem/lemma declarations, zero unsound constructs.
