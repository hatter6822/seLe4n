...
Current state (as of v0.35.35): 377,396 lines of production Lean across 330 files, 76,463 lines across 70 Lean test suites,
12,626 theorem/lemma declarations, zero unsound constructs.
