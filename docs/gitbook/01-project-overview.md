...
Current state (as of v0.35.72): 386,458 lines of production Lean across 331 files, 78,776 lines across 70 Lean test suites,
12,905 theorem/lemma declarations, zero unsound constructs.
