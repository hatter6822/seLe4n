...
Current state (as of v0.35.157): 396,888 lines of production Lean across 334 files, 81,087 lines across 70 Lean test suites,
13,137 theorem/lemma declarations, zero unsound constructs.
