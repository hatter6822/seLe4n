...
Current state (as of v0.35.168): 403,754 lines of production Lean across 336 files, 82,595 lines across 70 Lean test suites,
13,385 theorem/lemma declarations, zero unsound constructs.
