...
Current state (as of v0.35.195): 413,406 lines of production Lean across 339 files, 84,248 lines across 70 Lean test suites,
13,654 theorem/lemma declarations, zero unsound constructs.
