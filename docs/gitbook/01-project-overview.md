...
Current state (as of v0.34.88): 340,168 lines of production Lean across 317 files, 70,817 lines across 70 Lean test suites,
11,316 theorem/lemma declarations, zero unsound constructs.
