...
Current state (as of v0.35.163): 401,319 lines of production Lean across 334 files, 81,967 lines across 70 Lean test suites,
13,282 theorem/lemma declarations, zero unsound constructs.
