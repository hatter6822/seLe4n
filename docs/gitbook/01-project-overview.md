...
Current state (as of v0.34.134): 360,710 lines of production Lean across 328 files, 73,857 lines across 70 Lean test suites,
12,070 theorem/lemma declarations, zero unsound constructs.
