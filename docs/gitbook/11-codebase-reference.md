...
Machine-readable mirror: `docs/codebase_map.json` (generated by `./scripts/generate_codebase_map.py --pretty`) exports module + declaration inventory with commit-derived cache metadata for website cache invalidation.
