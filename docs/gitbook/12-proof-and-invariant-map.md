...
- **WS-RC R5 (DEEP-SUSP-01/02, DEEP-SCH-02..06) (v0.31.0)** — scheduler / lifecycle behaviour symmetry closes seven audit findings whose remediation is a behavioural symmetry or function-split.
  ...
  - Tests: 12 new Lean regression tests (4 R5.A + 2 R5.B + 2 R5.D + 1 R5.E + 3 R5.G) plus 1 R5.E discriminant pin in `SyscallDispatchSuite`, 23 R5 surface anchors in `LivenessSuite`, 2 new Rust tests for the new discriminant.  AK7 cascade monotonicity preserved at the v0.30.11 floor.
