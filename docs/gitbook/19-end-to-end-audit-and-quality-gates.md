...
- **898 theorem/lemma declarations** across 7 kernel subsystems.
...
| v0.13.8 | WS-H12 | **Completed** — Scheduler/IPC semantic alignment: dequeue-on-dispatch, per-TCB context, IPC bounds, legacy cleanup. 898 proved declarations |
