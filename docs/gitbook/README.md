...
- **Version:** 0.35.148 (Lean v4.28.0).
- **Codebase metrics:** 396,557 production LoC across 334 Lean files, 80,872 test LoC across 70 suites, 13,128 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
