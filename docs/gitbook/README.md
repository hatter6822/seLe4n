...
- **Version:** 0.35.125 (Lean v4.28.0).
- **Codebase metrics:** 395,341 production LoC across 334 Lean files, 80,213 test LoC across 70 suites, 13,117 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
