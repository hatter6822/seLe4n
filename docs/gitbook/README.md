...
- **Version:** 0.34.108 (Lean v4.28.0).
- **Codebase metrics:** 352,854 production LoC across 327 Lean files, 71,412 test LoC across 70 suites, 11,788 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
