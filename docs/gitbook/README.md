...
- **Version:** 0.35.191 (Lean v4.28.0).
- **Codebase metrics:** 412,643 production LoC across 339 Lean files, 83,880 test LoC across 70 suites, 13,638 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
