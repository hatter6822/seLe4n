...
- **Version:** 0.34.90 (Lean v4.28.0).
- **Codebase metrics:** 342,776 production LoC across 323 Lean files, 71,065 test LoC across 70 suites, 11,427 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
