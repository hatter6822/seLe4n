...
- **Version:** 0.35.161 (Lean v4.28.0).
- **Codebase metrics:** 399,198 production LoC across 334 Lean files, 81,487 test LoC across 70 suites, 13,210 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
