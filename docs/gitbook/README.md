...
- **Version:** 0.35.162 (Lean v4.28.0).
- **Codebase metrics:** 399,995 production LoC across 334 Lean files, 81,812 test LoC across 70 suites, 13,242 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
