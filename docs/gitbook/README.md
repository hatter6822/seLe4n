...
- **Version:** 0.35.160 (Lean v4.28.0).
- **Codebase metrics:** 397,589 production LoC across 334 Lean files, 81,318 test LoC across 70 suites, 13,152 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
