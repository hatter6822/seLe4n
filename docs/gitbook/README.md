...
- **Version:** 0.36.3 (Lean v4.28.0).
- **Codebase metrics:** 421,705 production LoC across 343 Lean files, 85,663 test LoC across 71 suites, 13,993 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
