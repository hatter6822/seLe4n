...
- **Version:** 0.35.192 (Lean v4.28.0).
- **Codebase metrics:** 412,636 production LoC across 339 Lean files, 83,961 test LoC across 70 suites, 13,638 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
