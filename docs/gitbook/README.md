...
- **Version:** 0.34.137 (Lean v4.28.0).
- **Codebase metrics:** 361,351 production LoC across 328 Lean files, 74,073 test LoC across 70 suites, 12,089 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
