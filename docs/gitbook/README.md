...
- **Version:** 0.34.93 (Lean v4.28.0).
- **Codebase metrics:** 343,801 production LoC across 323 Lean files, 71,095 test LoC across 70 suites, 11,449 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
