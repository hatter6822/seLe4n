...
- **Version:** 0.35.84 (Lean v4.28.0).
- **Codebase metrics:** 387,893 production LoC across 331 Lean files, 78,892 test LoC across 70 suites, 12,925 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
