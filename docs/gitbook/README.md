...
- **Version:** 0.35.53 (Lean v4.28.0).
- **Codebase metrics:** 383,950 production LoC across 330 Lean files, 78,257 test LoC across 70 suites, 12,771 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
