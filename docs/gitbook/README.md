...
- **Version:** 0.35.96 (Lean v4.28.0).
- **Codebase metrics:** 391,466 production LoC across 333 Lean files, 79,392 test LoC across 70 suites, 13,046 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
