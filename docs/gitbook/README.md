...
- **Version:** 0.35.66 (Lean v4.28.0).
- **Codebase metrics:** 385,892 production LoC across 330 Lean files, 78,722 test LoC across 70 suites, 12,873 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
