...
- **Version:** 0.35.189 (Lean v4.28.0).
- **Codebase metrics:** 410,884 production LoC across 338 Lean files, 83,710 test LoC across 70 suites, 13,591 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
