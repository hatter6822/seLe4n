...
- **Version:** 0.35.90 (Lean v4.28.0).
- **Codebase metrics:** 389,382 production LoC across 332 Lean files, 79,141 test LoC across 70 suites, 12,989 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
