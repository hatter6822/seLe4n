...
- **Version:** 0.35.10 (Lean v4.28.0).
- **Codebase metrics:** 375,003 production LoC across 329 Lean files, 75,860 test LoC across 70 suites, 12,599 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
