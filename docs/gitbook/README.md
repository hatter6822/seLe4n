...
- **Version:** 0.34.95 (Lean v4.28.0).
- **Codebase metrics:** 346,230 production LoC across 324 Lean files, 71,194 test LoC across 70 suites, 11,529 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
