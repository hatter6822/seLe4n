...
- **Version:** 0.35.99 (Lean v4.28.0).
- **Codebase metrics:** 391,919 production LoC across 333 Lean files, 79,621 test LoC across 70 suites, 13,056 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
