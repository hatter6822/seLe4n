...
- **Version:** 0.35.3 (Lean v4.28.0).
- **Codebase metrics:** 364,812 production LoC across 328 Lean files, 74,909 test LoC across 70 suites, 12,185 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
