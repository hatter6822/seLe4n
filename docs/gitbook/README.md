...
- **Codebase metrics:** 420,685 production LoC across 343 Lean files, 85,461 test LoC across 71 suites, 13,928 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
