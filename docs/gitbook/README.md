...
- **Version:** 0.35.177 (Lean v4.28.0).
- **Codebase metrics:** 406,667 production LoC across 338 Lean files, 83,019 test LoC across 70 suites, 13,463 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
