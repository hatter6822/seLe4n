...
- **Version:** 0.35.51 (Lean v4.28.0).
- **Codebase metrics:** 383,641 production LoC across 330 Lean files, 77,948 test LoC across 70 suites, 12,767 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
