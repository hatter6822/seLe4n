...
- **Version:** 0.35.181 (Lean v4.28.0).
- **Codebase metrics:** 408,061 production LoC across 338 Lean files, 83,207 test LoC across 70 suites, 13,504 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
