...
- **Version:** 0.36.1 (Lean v4.28.0).
- **Codebase metrics:** 417,841 production LoC across 340 Lean files, 84,834 test LoC across 70 suites, 13,815 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
