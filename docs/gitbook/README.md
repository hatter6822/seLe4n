...
- **Version:** 0.35.158 (Lean v4.28.0).
- **Codebase metrics:** 397,042 production LoC across 334 Lean files, 81,232 test LoC across 70 suites, 13,131 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
