...
- **Version:** 0.35.169 (Lean v4.28.0).
- **Codebase metrics:** 404,112 production LoC across 336 Lean files, 82,662 test LoC across 70 suites, 13,396 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
