...
- **Codebase metrics:** 417,966 production LoC across 340 Lean files, 85,076 test LoC across 70 suites, 13,815 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
