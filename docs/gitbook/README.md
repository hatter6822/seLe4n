...
- **Version:** 0.34.112 (Lean v4.28.0).
- **Codebase metrics:** 354,786 production LoC across 328 Lean files, 71,694 test LoC across 70 suites, 11,875 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
