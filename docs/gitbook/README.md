...
- **Version:** 0.35.23 (Lean v4.28.0).
- **Codebase metrics:** 376,503 production LoC across 330 Lean files, 76,048 test LoC across 70 suites, 12,610 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
