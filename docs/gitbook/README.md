...
- **Version:** 0.35.157 (Lean v4.28.0).
- **Codebase metrics:** 396,888 production LoC across 334 Lean files, 81,087 test LoC across 70 suites, 13,137 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
