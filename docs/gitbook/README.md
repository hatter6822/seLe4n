...
- **Version:** 0.34.111 (Lean v4.28.0).
- **Codebase metrics:** 354,553 production LoC across 328 Lean files, 71,633 test LoC across 70 suites, 11,868 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
