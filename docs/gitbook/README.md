...
- **Version:** 0.34.106 (Lean v4.28.0).
- **Codebase metrics:** 352,080 production LoC across 327 Lean files, 71,347 test LoC across 70 suites, 11,754 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
