...
- **Version:** 0.35.85 (Lean v4.28.0).
- **Codebase metrics:** 388,275 production LoC across 332 Lean files, 78,892 test LoC across 70 suites, 12,931 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
