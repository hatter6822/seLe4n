...
- **Version:** 0.35.6 (Lean v4.28.0).
- **Codebase metrics:** 374,568 production LoC across 329 Lean files, 75,813 test LoC across 70 suites, 12,576 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
