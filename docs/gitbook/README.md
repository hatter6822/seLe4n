...
- **Version:** 0.35.195 (Lean v4.28.0).
- **Codebase metrics:** 413,406 production LoC across 339 Lean files, 84,248 test LoC across 70 suites, 13,654 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
