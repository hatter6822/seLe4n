...
- **Version:** 0.35.58 (Lean v4.28.0).
- **Codebase metrics:** 385,041 production LoC across 330 Lean files, 78,456 test LoC across 70 suites, 12,816 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
