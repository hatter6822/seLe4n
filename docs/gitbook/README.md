...
- **Version:** 0.35.86 (Lean v4.28.0).
- **Codebase metrics:** 389,153 production LoC across 332 Lean files, 79,007 test LoC across 70 suites, 12,967 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
