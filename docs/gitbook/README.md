...
- **Version:** 0.35.106 (Lean v4.28.0).
- **Codebase metrics:** 393,612 production LoC across 333 Lean files, 79,985 test LoC across 70 suites, 13,082 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
