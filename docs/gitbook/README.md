...
- **Version:** 0.35.104 (Lean v4.28.0).
- **Codebase metrics:** 392,382 production LoC across 333 Lean files, 79,773 test LoC across 70 suites, 13,063 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
