...
- **Version:** 0.35.176 (Lean v4.28.0).
- **Codebase metrics:** 406,451 production LoC across 338 Lean files, 83,005 test LoC across 70 suites, 13,455 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
