...
- **Version:** 0.35.46 (Lean v4.28.0).
- **Codebase metrics:** 381,844 production LoC across 330 Lean files, 77,346 test LoC across 70 suites, 12,733 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
