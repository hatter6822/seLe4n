...
- **Version:** 0.35.22 (Lean v4.28.0).
- **Codebase metrics:** 376,395 production LoC across 330 Lean files, 76,029 test LoC across 70 suites, 12,607 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
