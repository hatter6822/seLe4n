...
- **Active workstream:** All software-level workstreams (WS-B through WS-AE) complete. **WS-AE PORTFOLIO COMPLETE** (v0.25.15–v0.25.21) — 6 phases (AE1–AE6), 53 sub-tasks. Prior: WS-B through WS-AD complete (v0.9.0–v0.25.14).
