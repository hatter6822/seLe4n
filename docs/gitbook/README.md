...
- **Active workstream:** All software-level workstreams (WS-B through WS-AE) complete. WS-AE Phase AE3 (Scheduler & SchedContext Correctness) completed at v0.25.18. Prior: WS-B through WS-AD complete (v0.9.0–v0.25.14).
