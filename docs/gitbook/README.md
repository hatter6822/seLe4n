...
- **Version:** 0.35.111 (Lean v4.28.0).
- **Codebase metrics:** 394,244 production LoC across 333 Lean files, 80,133 test LoC across 70 suites, 13,097 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
