...
- **Version:** 0.35.69 (Lean v4.28.0).
- **Codebase metrics:** 386,157 production LoC across 331 Lean files, 78,776 test LoC across 70 suites, 12,887 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
