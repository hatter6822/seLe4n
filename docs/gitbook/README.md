...
- **Codebase metrics:** 420,295 production LoC across 343 Lean files, 85,416 test LoC across 71 suites, 13,916 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
