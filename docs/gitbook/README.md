...
- **Version:** 0.35.44 (Lean v4.28.0).
- **Codebase metrics:** 380,540 production LoC across 330 Lean files, 77,224 test LoC across 70 suites, 12,706 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
