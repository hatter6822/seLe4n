...
- **Version:** 0.35.1 (Lean v4.28.0).
- **Codebase metrics:** 362,103 production LoC across 328 Lean files, 74,287 test LoC across 70 suites, 12,106 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
