...
- **Version:** 0.35.193 (Lean v4.28.0).
- **Codebase metrics:** 413,049 production LoC across 339 Lean files, 84,109 test LoC across 70 suites, 13,648 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
