...
- **Version:** 0.35.190 (Lean v4.28.0).
- **Codebase metrics:** 411,743 production LoC across 338 Lean files, 83,880 test LoC across 70 suites, 13,613 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
