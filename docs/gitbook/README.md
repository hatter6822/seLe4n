...
- **Version:** 0.35.83 (Lean v4.28.0).
- **Codebase metrics:** 387,521 production LoC across 331 Lean files, 78,892 test LoC across 70 suites, 12,918 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
