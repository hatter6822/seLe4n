...
- **Version:** 0.34.94 (Lean v4.28.0).
- **Codebase metrics:** 344,934 production LoC across 324 Lean files, 71,128 test LoC across 70 suites, 11,490 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
