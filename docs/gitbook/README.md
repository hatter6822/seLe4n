...
- **Version:** 0.35.39 (Lean v4.28.0).
- **Codebase metrics:** 380,359 production LoC across 330 Lean files, 77,138 test LoC across 70 suites, 12,704 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
