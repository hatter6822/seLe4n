...
- **Version:** 0.35.94 (Lean v4.28.0).
- **Codebase metrics:** 390,824 production LoC across 333 Lean files, 79,176 test LoC across 70 suites, 13,029 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
