...
- **Version:** 0.35.2 (Lean v4.28.0).
- **Codebase metrics:** 364,378 production LoC across 328 Lean files, 74,602 test LoC across 70 suites, 12,164 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
