...
- **Version:** 0.35.185 (Lean v4.28.0).
- **Codebase metrics:** 410,148 production LoC across 338 Lean files, 83,492 test LoC across 70 suites, 13,560 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
