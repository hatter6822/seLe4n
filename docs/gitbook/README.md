...
- **Version:** 0.36.0 (Lean v4.28.0).
- **Codebase metrics:** 417,640 production LoC across 340 Lean files, 84,644 test LoC across 70 suites, 13,813 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
