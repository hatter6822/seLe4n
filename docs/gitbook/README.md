...
- **Version:** 0.35.183 (Lean v4.28.0).
- **Codebase metrics:** 409,202 production LoC across 338 Lean files, 83,391 test LoC across 70 suites, 13,536 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
