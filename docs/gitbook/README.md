...
- **Version:** 0.34.135 (Lean v4.28.0).
- **Codebase metrics:** 360,920 production LoC across 328 Lean files, 73,943 test LoC across 70 suites, 12,076 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
