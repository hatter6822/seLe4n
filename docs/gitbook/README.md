...
- **Version:** 0.34.127 (Lean v4.28.0).
- **Codebase metrics:** 357,749 production LoC across 328 Lean files, 73,315 test LoC across 70 suites, 11,997 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
