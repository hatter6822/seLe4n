...
- **Version:** 0.34.139 (Lean v4.28.0).
- **Codebase metrics:** 361,406 production LoC across 328 Lean files, 74,100 test LoC across 70 suites, 12,090 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
