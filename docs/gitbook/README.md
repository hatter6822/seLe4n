...
- **Codebase metrics:** 420,101 production LoC across 343 Lean files, 85,359 test LoC across 71 suites, 13,906 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
