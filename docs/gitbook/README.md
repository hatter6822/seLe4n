...
- **Version:** 0.35.172 (Lean v4.28.0).
- **Codebase metrics:** 405,258 production LoC across 336 Lean files, 83,005 test LoC across 70 suites, 13,430 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
