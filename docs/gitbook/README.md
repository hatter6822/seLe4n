...
- **Version:** 0.35.200 (Lean v4.28.0).
- **Codebase metrics:** 417,397 production LoC across 340 Lean files, 84,404 test LoC across 70 suites, 13,805 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
