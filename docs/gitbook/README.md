...
- **Version:** 0.35.132 (Lean v4.28.0).
- **Codebase metrics:** 396,110 production LoC across 334 Lean files, 80,213 test LoC across 70 suites, 13,131 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
