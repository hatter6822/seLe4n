...
- **Version:** 0.35.35 (Lean v4.28.0).
- **Codebase metrics:** 377,396 production LoC across 330 Lean files, 76,463 test LoC across 70 suites, 12,626 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
