...
- **Version:** 0.34.92 (Lean v4.28.0).
- **Codebase metrics:** 343,521 production LoC across 323 Lean files, 71,084 test LoC across 70 suites, 11,444 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
