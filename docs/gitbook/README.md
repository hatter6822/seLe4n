...
- **Version:** 0.35.197 (Lean v4.28.0).
- **Codebase metrics:** 414,657 production LoC across 339 Lean files, 84,404 test LoC across 70 suites, 13,702 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
