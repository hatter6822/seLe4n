...
- **Version:** 0.35.36 (Lean v4.28.0).
- **Codebase metrics:** 378,753 production LoC across 330 Lean files, 76,540 test LoC across 70 suites, 12,671 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
