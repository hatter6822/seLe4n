...
- **Codebase metrics:** 420,033 production LoC across 342 Lean files, 85,359 test LoC across 71 suites, 13,905 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
