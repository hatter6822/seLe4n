...
- **Version:** 0.35.196 (Lean v4.28.0).
- **Codebase metrics:** 413,957 production LoC across 339 Lean files, 84,404 test LoC across 70 suites, 13,674 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
