...
- **Version:** 0.36.4 (Lean v4.28.0).
- **Codebase metrics:** 422,300 production LoC across 343 Lean files, 85,915 test LoC across 71 suites, 14,011 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
