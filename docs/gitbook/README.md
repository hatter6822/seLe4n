...
- **Version:** 0.35.187 (Lean v4.28.0).
- **Codebase metrics:** 410,383 production LoC across 338 Lean files, 83,589 test LoC across 70 suites, 13,573 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
