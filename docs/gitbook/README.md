...
- **Version:** 0.35.26 (Lean v4.28.0).
- **Codebase metrics:** 376,821 production LoC across 330 Lean files, 76,127 test LoC across 70 suites, 12,613 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
