...
- **Version:** 0.35.97 (Lean v4.28.0).
- **Codebase metrics:** 391,604 production LoC across 333 Lean files, 79,392 test LoC across 70 suites, 13,052 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
