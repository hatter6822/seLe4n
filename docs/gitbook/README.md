...
- **Version:** 0.35.37 (Lean v4.28.0).
- **Codebase metrics:** 378,887 production LoC across 330 Lean files, 76,620 test LoC across 70 suites, 12,676 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
