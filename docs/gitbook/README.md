...
- **Version:** 0.35.93 (Lean v4.28.0).
- **Codebase metrics:** 390,670 production LoC across 333 Lean files, 79,176 test LoC across 70 suites, 13,014 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
