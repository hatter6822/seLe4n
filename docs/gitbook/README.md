...
- **Version:** 0.35.48 (Lean v4.28.0).
- **Codebase metrics:** 381,980 production LoC across 330 Lean files, 77,688 test LoC across 70 suites, 12,734 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
