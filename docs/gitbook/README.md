...
- **Version:** 0.34.100 (Lean v4.28.0).
- **Codebase metrics:** 348,145 production LoC across 326 Lean files, 71,289 test LoC across 70 suites, 11,607 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
