...
- **Version:** 0.35.180 (Lean v4.28.0).
- **Codebase metrics:** 407,635 production LoC across 338 Lean files, 83,095 test LoC across 70 suites, 13,486 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
