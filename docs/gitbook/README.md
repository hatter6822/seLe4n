...
- **Version:** 0.35.179 (Lean v4.28.0).
- **Codebase metrics:** 407,460 production LoC across 338 Lean files, 83,049 test LoC across 70 suites, 13,481 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
