...
- **Version:** 0.36.5 (Lean v4.28.0).
- **Codebase metrics:** 423,001 production LoC across 343 Lean files, 86,115 test LoC across 71 suites, 14,028 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
