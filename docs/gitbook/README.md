...
- **Version:** 0.35.163 (Lean v4.28.0).
- **Codebase metrics:** 401,319 production LoC across 334 Lean files, 81,967 test LoC across 70 suites, 13,282 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
