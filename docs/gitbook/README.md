...
- **Version:** 0.35.164 (Lean v4.28.0).
- **Codebase metrics:** 401,833 production LoC across 334 Lean files, 82,175 test LoC across 70 suites, 13,302 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
