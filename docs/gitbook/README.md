...
- **Version:** 0.34.104 (Lean v4.28.0).
- **Codebase metrics:** 351,182 production LoC across 327 Lean files, 71,319 test LoC across 70 suites, 11,729 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
