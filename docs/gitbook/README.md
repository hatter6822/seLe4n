...
- **Version:** 0.35.165 (Lean v4.28.0).
- **Codebase metrics:** 402,324 production LoC across 334 Lean files, 82,280 test LoC across 70 suites, 13,333 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
