...
- **Version:** 0.21.4 (Lean v4.28.0).
- **Codebase metrics:** 64,271 production LoC across 101 files; 8,322 test LoC across 10 suites; 1,907 theorem/lemma declarations (zero sorry/axiom).
