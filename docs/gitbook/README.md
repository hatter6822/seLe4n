...
- **Version:** 0.35.45 (Lean v4.28.0).
- **Codebase metrics:** 382,025 production LoC across 330 Lean files, 77,280 test LoC across 70 suites, 12,741 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
