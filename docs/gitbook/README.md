...
- **Version:** 0.35.52 (Lean v4.28.0).
- **Codebase metrics:** 383,733 production LoC across 330 Lean files, 78,086 test LoC across 70 suites, 12,769 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
