...
- **Version:** 0.35.168 (Lean v4.28.0).
- **Codebase metrics:** 403,754 production LoC across 336 Lean files, 82,595 test LoC across 70 suites, 13,385 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
