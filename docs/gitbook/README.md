...
- **Version:** 0.34.102 (Lean v4.28.0).
- **Codebase metrics:** 349,349 production LoC across 326 Lean files, 71,289 test LoC across 70 suites, 11,667 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
