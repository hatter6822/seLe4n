...
- **Version:** 0.35.171 (Lean v4.28.0).
- **Codebase metrics:** 404,987 production LoC across 336 Lean files, 82,900 test LoC across 70 suites, 13,424 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
