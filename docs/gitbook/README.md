...
- **Version:** 0.35.95 (Lean v4.28.0).
- **Codebase metrics:** 391,269 production LoC across 333 Lean files, 79,176 test LoC across 70 suites, 13,043 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
