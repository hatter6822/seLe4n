...
- **Version:** 0.35.201 (Lean v4.28.0).
- **Codebase metrics:** 417,407 production LoC across 340 Lean files, 84,545 test LoC across 70 suites, 13,810 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
