...
- **Version:** 0.36.6 (Lean v4.28.0).
- **Codebase metrics:** 423,960 production LoC across 344 Lean files, 86,280 test LoC across 71 suites, 14,056 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
