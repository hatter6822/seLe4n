...
- **Version:** 0.35.57 (Lean v4.28.0).
- **Codebase metrics:** 384,812 production LoC across 330 Lean files, 78,352 test LoC across 70 suites, 12,802 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
