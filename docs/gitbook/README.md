...
- **Version:** 0.34.120 (Lean v4.28.0).
- **Codebase metrics:** 355,799 production LoC across 328 Lean files, 72,662 test LoC across 70 suites, 11,889 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
