...
- **Version:** 0.34.109 (Lean v4.28.0).
- **Codebase metrics:** 353,568 production LoC across 327 Lean files, 71,487 test LoC across 70 suites, 11,817 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
