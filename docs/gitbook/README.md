...
- **Version:** 0.35.184 (Lean v4.28.0).
- **Codebase metrics:** 409,214 production LoC across 338 Lean files, 83,492 test LoC across 70 suites, 13,536 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
