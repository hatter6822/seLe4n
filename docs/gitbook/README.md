...
- **Version:** 0.35.67 (Lean v4.28.0).
- **Codebase metrics:** 385,998 production LoC across 330 Lean files, 78,763 test LoC across 70 suites, 12,876 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
