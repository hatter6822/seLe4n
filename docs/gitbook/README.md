...
- **Version:** 0.34.113 (Lean v4.28.0).
- **Codebase metrics:** 355,159 production LoC across 328 Lean files, 71,970 test LoC across 70 suites, 11,886 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
