...
- **Version:** 0.35.170 (Lean v4.28.0).
- **Codebase metrics:** 404,629 production LoC across 336 Lean files, 82,811 test LoC across 70 suites, 13,414 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
