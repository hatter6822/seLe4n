...
- **Version:** 0.35.105 (Lean v4.28.0).
- **Codebase metrics:** 392,459 production LoC across 333 Lean files, 79,904 test LoC across 70 suites, 13,063 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
