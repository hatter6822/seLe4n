...
- **Version:** 0.35.49 (Lean v4.28.0).
- **Codebase metrics:** 382,430 production LoC across 330 Lean files, 77,749 test LoC across 70 suites, 12,742 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
