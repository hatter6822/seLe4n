...
- **Active workstream:** **All workstreams COMPLETE** (WS-B through WS-AB, v0.9.0–v0.25.5). WS-AB delivered all 5 deferred seL4 operations, Priority Inheritance Protocol, and Bounded Latency Theorem.
