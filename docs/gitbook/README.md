...
- **Version:** 0.34.132 (Lean v4.28.0).
- **Codebase metrics:** 360,465 production LoC across 328 Lean files, 73,833 test LoC across 70 suites, 12,064 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
