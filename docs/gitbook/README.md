...
- **Version:** 0.34.96 (Lean v4.28.0).
- **Codebase metrics:** 347,188 production LoC across 325 Lean files, 71,244 test LoC across 70 suites, 11,567 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
