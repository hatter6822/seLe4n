...
- **Version:** 0.35.174 (Lean v4.28.0).
- **Codebase metrics:** 405,953 production LoC across 338 Lean files, 83,005 test LoC across 70 suites, 13,442 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
