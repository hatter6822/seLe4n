...
- **Version:** 0.16.11 (Lean v4.28.0).
- **Codebase metrics:** 37,866 production LoC across 69 files; 4,098 test LoC across 4 suites; 1,216 theorem/lemma declarations (zero sorry/axiom).
