...
- **Version:** 0.34.86 (Lean v4.28.0).
- **Codebase metrics:** 339,955 production LoC across 317 Lean files, 70,646 test LoC across 70 suites, 11,305 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
