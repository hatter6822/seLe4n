...
- **Version:** 0.35.38 (Lean v4.28.0).
- **Codebase metrics:** 379,856 production LoC across 330 Lean files, 76,925 test LoC across 70 suites, 12,693 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
