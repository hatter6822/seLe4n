...
- **Version:** 0.35.166 (Lean v4.28.0).
- **Codebase metrics:** 402,742 production LoC across 335 Lean files, 82,280 test LoC across 70 suites, 13,344 proved declarations, zero `sorry` and zero `axiom`. Regenerate with `python3 scripts/report_current_state.py`.
