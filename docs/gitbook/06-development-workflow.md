...
1. Pick one coherent WS-F7..F8 target (or another identified workstream slice).
...
- include workstream ID(s) (WS-F7..F8 for current focus),
...
## Remaining workstream sequence (WS-F7..F8)

WS-G (kernel performance), WS-F1..F6 (critical/high/medium audit remediation),
