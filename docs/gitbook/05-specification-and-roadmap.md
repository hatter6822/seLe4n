...
| Active workstream | **WS-AG Phase AG9 COMPLETE** (v0.27.0). Testing + Validation. Prior: AG8 (v0.26.9), AG7 (v0.26.8), AG6 (v0.26.7), AG5 (v0.26.6), AG4 (v0.26.5), AG3 (v0.26.4), AG2 Audit (v0.26.2), AG2 (v0.26.1), AG1 (v0.26.0), WS-AF (v0.25.22–v0.25.27), WS-AE (v0.25.15–v0.25.21), WS-AD (v0.25.11–v0.25.14), WS-AC (v0.25.3–v0.25.10), WS-B through WS-AB (v0.9.0–v0.25.5). **Next: AG10 (kernel entry point).** |
