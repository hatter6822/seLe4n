...
| Active workstream | **WS-V Phases V1–V4 COMPLETE** (v0.22.0–v0.22.4). V4: Platform & Hardware Fidelity — boot-to-runtime invariant bridge, MMIO alignment/W1C, DTB hardening, W^X decode enforcement. Prior: **WS-U PORTFOLIO COMPLETE** (v0.21.0–v0.21.7), **WS-T COMPLETE** (v0.20.0–v0.20.7), WS-S through WS-B — all COMPLETE. |
