...
| Production LoC | 36,868 across 69 files |
...
## In Progress: WS-K Full Syscall Dispatch Completion (v0.16.5–v0.16.8)
...
and NI coverage for all new paths. 8 phases (K-A through K-H). K-A through K-F
completed (v0.16.0–v0.16.5); K-G through K-H remaining. See
