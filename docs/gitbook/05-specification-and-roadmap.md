...
| SM10.1 | The bootable image: a `[[bin]]`, aarch64 Lean object code, bare-metal runtime hosting, `lean_kernel_main` | **WS-BP**, unblocked at v0.35.203; BP0 and BP1 (the aarch64 Lean object code, `libsele4n.a`) landed at v0.36.2, and `lean_kernel_main` exists since BP4.1 (v0.36.2) |
