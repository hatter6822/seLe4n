...
| Latest audit | [`AUDIT_v0.30.11_COMPREHENSIVE`](../audits/AUDIT_v0.30.11_COMPREHENSIVE.md) — pre-1.0 readiness audit cut after WS-AN closure. WS-AN remediation artefacts archived: [`AUDIT_v0.30.6_COMPREHENSIVE`](../dev_history/audits/AUDIT_v0.30.6_COMPREHENSIVE.md) (2 actionable CRITICAL, 23 actionable HIGH, 71 MED, 58 LOW, 40 INFO; **WS-AN Phases AN0–AN12 COMPLETE**, v0.30.6 → v0.30.11). Discharge index: [`AUDIT_v0.30.6_DISCHARGE_INDEX.md`](../dev_history/audits/AUDIT_v0.30.6_DISCHARGE_INDEX.md). Predecessor (also archived): [`AUDIT_v0.29.0_COMPREHENSIVE`](../dev_history/audits/AUDIT_v0.29.0_COMPREHENSIVE.md), [`AUDIT_v0.29.0_ERRATA.md`](../dev_history/audits/AUDIT_v0.29.0_ERRATA.md), [`AUDIT_v0.29.0_DEFERRED.md`](../dev_history/audits/AUDIT_v0.29.0_DEFERRED.md) (14/15 RESOLVED at WS-AN closure). |
