...
| Active workstream | **WS-RC IN FLIGHT** (v0.30.11 → v0.31.0 → v1.0.0). Closes the v0.30.11 audit cycle via 15 phases (R0..R14). Pre-v1.0 must-fix: R0 (audit baseline), R1 (one-line IPC NI symmetry), R2 (FFI dispatch wiring), R3 (boot VSpace threading), R4 (structural-invariant promotions including R4.D witness theorem for DEEP-CAP-02 false positive), R5 (scheduler/lifecycle symmetry), R6 (architecture/info-flow completeness). Post-FFI hygiene: R7..R12 (capability deferred items, test renames, pre-commit hardening, inline polish, documentation accuracy, CI hygiene + R12.B/C/D structural enforcement gates that close DEEP-ARCH-01, DEEP-RUST-01/02, DEEP-ARCH-02 false positives at the CI level). R13 reserved for emergent items; R14 the post-1.0 maintainability backlog. **WS-RC R0 — Audit baseline and bookkeeping — COMPLETE** (branch `claude/audit-phase-r0-baseline-tBblA`): R0.1 baseline cut [`AUDIT_v0.30.11_WS_RC_BASELINE.txt`](../audits/AUDIT_v0.30.11_WS_RC_BASELINE.txt) (12 sections; KEY=value tail; 302 lake jobs / 462 cargo tests / 0 clippy warnings / 0 sorry / 0 axiom; 167 prod Lean files / 109,791 lines; 158/10 production/staged modules; 59 HAL unsafe blocks; source digest `0ac75f31…`); R0.2 ERRATA E-1..E-4 re-verified against live tree; R0.3 [`AUDIT_v0.30.11_DISCHARGE_INDEX.md`](../audits/AUDIT_v0.30.11_DISCHARGE_INDEX.md) seed (carries §3.A–§3.C from predecessor; opens §3.D NoDup promotions, §3.E reroutings, §3.F false-positive structural witnesses, §3.G predecessor reconfirmations); R0.4 DEBT-RUST-02 / H-24 closure annotation in archived [`AUDIT_v0.30.6_DISCHARGE_INDEX.md`](../dev_history/audits/AUDIT_v0.30.6_DISCHARGE_INDEX.md) §6 (three independent grep passes return 0 hits); R0.5 [`docs/audits/README.md`](../audits/README.md) "Files currently live" sync; R0.6 [`docs/WORKSTREAM_HISTORY.md`](../WORKSTREAM_HISTORY.md) WS-RC opening row + R0 phase breakdown. Prior plan-author landings (WS-RC R0 prep, PR #760): SPDX header on `SeLe4n.lean` (R10.1), audit errata file scaffold (R0.2 seed), staged-module allowlist + partition gate (R12.B.1/2 — caught 2 stale "STATUS: staged" markers on production-wired contract files), orphan-fields gate (R12.D.1), Tier-0 wiring of both gates. Release path: `v0.31.0` "verified specification release" once R0+R1+R8..R12 land; `v1.0.0` "bootable verified microkernel" once R2..R6 additionally land. |
| Predecessor workstream | **WS-AN Phase AN12 COMPLETE — PORTFOLIO CLOSED** (v0.30.11). AN12 lands the cross-cutting Theme 4.1 closure-form discharge index (`docs/dev_history/audits/AUDIT_v0.30.6_DISCHARGE_INDEX.md`, marker theorem `closureForm_discharge_index_documented` in `SeLe4n/Kernel/CrossSubsystem.lean`), Theme 4.4 SMP-latent assumption inventory (`SeLe4n/Kernel/Concurrency/Assumptions.lean` with 8-entry `smpLatentInventory`, mirrored at SPEC §6.8), DOC-M01..M08 batch (SPDX headers added to all 247 `.lean`/`.rs` files; `CONTRIBUTING.md` rewritten), DOC LOW batch (`docs/audits/README.md`, `docs/CLAUDE_HISTORY.md`), in-place RESOLVED annotations on 14 of 15 absorbed `AUDIT_v0.29.0_DEFERRED.md` rows (DEF-F-L9 retained as a post-1.0 cosmetic refactor with no correctness impact), version bump 0.30.10 → 0.30.11. **Items deferred past v1.0.0 with correctness impact: NONE.** Prior phases AN0..AN11 detail in [`docs/WORKSTREAM_HISTORY.md`](../WORKSTREAM_HISTORY.md). **Next:** v1.0.0 release-tag application is a separate manual maintainer action per the AK10-C precedent. |
