...
- **352,854 lines** of production Lean code across 327 files (as of
  v0.34.108; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **11,788 theorem/lemma declarations** with zero sorry/axiom.
