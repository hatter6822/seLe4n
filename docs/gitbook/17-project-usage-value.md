...
- **422,300 lines** of production Lean code across 343 files (as of
  v0.36.4; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **14,011 theorem/lemma declarations** with zero sorry/axiom.
