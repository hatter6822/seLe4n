...
- **389,122 lines** of production Lean code across 332 files (as of
  v0.35.87; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,977 theorem/lemma declarations** with zero sorry/axiom.
