...
- **360,920 lines** of production Lean code across 328 files (as of
  v0.34.135; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,076 theorem/lemma declarations** with zero sorry/axiom.
