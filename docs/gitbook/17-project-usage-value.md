...
- **394,808 lines** of production Lean code across 333 files (as of
  v0.35.113; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,115 theorem/lemma declarations** with zero sorry/axiom.
