...
- **408,352 lines** of production Lean code across 338 files (as of
  v0.35.182; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,510 theorem/lemma declarations** with zero sorry/axiom.
