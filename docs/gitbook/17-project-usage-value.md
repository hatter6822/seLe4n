...
- **395,341 lines** of production Lean code across 334 files (as of
  v0.35.125; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,117 theorem/lemma declarations** with zero sorry/axiom.
