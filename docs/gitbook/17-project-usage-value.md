...
- **344,934 lines** of production Lean code across 324 files (as of
  v0.34.94; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **11,490 theorem/lemma declarations** with zero sorry/axiom.
