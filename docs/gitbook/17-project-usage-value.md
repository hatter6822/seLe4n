...
- **364,812 lines** of production Lean code across 328 files (as of
  v0.35.3; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,185 theorem/lemma declarations** with zero sorry/axiom.
