...
- **374,707 lines** of production Lean code across 329 files (as of
  v0.35.8; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,593 theorem/lemma declarations** with zero sorry/axiom.
