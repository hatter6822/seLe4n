...
- **401,833 lines** of production Lean code across 334 files (as of
  v0.35.164; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,302 theorem/lemma declarations** with zero sorry/axiom.
