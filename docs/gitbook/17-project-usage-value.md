...
- **390,670 lines** of production Lean code across 333 files (as of
  v0.35.93; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,014 theorem/lemma declarations** with zero sorry/axiom.
