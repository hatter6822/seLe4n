...
- **359,285 lines** of production Lean code across 328 files (as of
  v0.34.129; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,041 theorem/lemma declarations** with zero sorry/axiom.
