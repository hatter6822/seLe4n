...
- **385,223 lines** of production Lean code across 330 files (as of
  v0.35.59; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,821 theorem/lemma declarations** with zero sorry/axiom.
