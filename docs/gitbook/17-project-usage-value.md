...
- **386,493 lines** of production Lean code across 331 files (as of
  v0.35.73; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,909 theorem/lemma declarations** with zero sorry/axiom.
