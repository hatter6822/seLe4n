...
- **389,153 lines** of production Lean code across 332 files (as of
  v0.35.86; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,967 theorem/lemma declarations** with zero sorry/axiom.
