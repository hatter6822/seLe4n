...
- **402,742 lines** of production Lean code across 335 files (as of
  v0.35.166; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,344 theorem/lemma declarations** with zero sorry/axiom.
