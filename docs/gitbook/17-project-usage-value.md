...
- **342,838 lines** of production Lean code across 323 files (as of
  v0.34.91; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **11,429 theorem/lemma declarations** with zero sorry/axiom.
