...
- **340,168 lines** of production Lean code across 317 files (as of
  v0.34.88; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **11,316 theorem/lemma declarations** with zero sorry/axiom.
