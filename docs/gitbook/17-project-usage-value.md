...
- **412,636 lines** of production Lean code across 339 files (as of
  v0.35.192; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,638 theorem/lemma declarations** with zero sorry/axiom.
