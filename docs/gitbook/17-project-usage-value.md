...
- **414,657 lines** of production Lean code across 339 files (as of
  v0.35.198; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,702 theorem/lemma declarations** with zero sorry/axiom.
