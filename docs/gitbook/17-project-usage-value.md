...
- **377,186 lines** of production Lean code across 330 files (as of
  v0.35.31; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,621 theorem/lemma declarations** with zero sorry/axiom.
