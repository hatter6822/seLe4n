...
- **396,708 lines** of production Lean code across 334 files (as of
  v0.35.156; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,131 theorem/lemma declarations** with zero sorry/axiom.
