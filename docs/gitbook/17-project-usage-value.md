...
- **349,349 lines** of production Lean code across 326 files (as of
  v0.34.102; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **11,667 theorem/lemma declarations** with zero sorry/axiom.
