...
- **359,936 lines** of production Lean code across 328 files (as of
  v0.34.131; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,054 theorem/lemma declarations** with zero sorry/axiom.
