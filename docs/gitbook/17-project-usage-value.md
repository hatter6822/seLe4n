...
- **421,705 lines** of production Lean code across 343 files (as of
  v0.36.3; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,993 theorem/lemma declarations** with zero sorry/axiom.
