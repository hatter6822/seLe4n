...
- **375,003 lines** of production Lean code across 329 files (as of
  v0.35.10; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,599 theorem/lemma declarations** with zero sorry/axiom.
