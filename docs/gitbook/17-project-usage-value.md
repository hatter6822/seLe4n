...
- **386,124 lines** of production Lean code across 331 files (as of
  v0.35.70; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,887 theorem/lemma declarations** with zero sorry/axiom.
