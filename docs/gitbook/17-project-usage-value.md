...
- **342,776 lines** of production Lean code across 323 files (as of
  v0.34.90; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **11,427 theorem/lemma declarations** with zero sorry/axiom.
