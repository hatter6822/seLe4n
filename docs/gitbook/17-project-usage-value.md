...
- **390,824 lines** of production Lean code across 333 files (as of
  v0.35.94; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,029 theorem/lemma declarations** with zero sorry/axiom.
