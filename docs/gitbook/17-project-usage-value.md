...
- **286,841 lines** of production Lean code across 286 files (as of
  v0.33.101; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **9,601 theorem/lemma declarations** with zero sorry/axiom.
