...
- **423,001 lines** of production Lean code across 343 files (as of
  v0.36.5; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **14,028 theorem/lemma declarations** with zero sorry/axiom.
