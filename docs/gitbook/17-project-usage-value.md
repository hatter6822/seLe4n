...
- **404,629 lines** of production Lean code across 336 files (as of
  v0.35.170; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,414 theorem/lemma declarations** with zero sorry/axiom.
