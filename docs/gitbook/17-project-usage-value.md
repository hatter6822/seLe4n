...
- **389,944 lines** of production Lean code across 333 files (as of
  v0.35.91; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,989 theorem/lemma declarations** with zero sorry/axiom.
