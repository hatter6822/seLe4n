...
- **409,214 lines** of production Lean code across 338 files (as of
  v0.35.184; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,536 theorem/lemma declarations** with zero sorry/axiom.
