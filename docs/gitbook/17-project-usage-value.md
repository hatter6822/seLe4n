...
- **341,796 lines** of production Lean code across 321 files (as of
  v0.34.89; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **11,393 theorem/lemma declarations** with zero sorry/axiom.
