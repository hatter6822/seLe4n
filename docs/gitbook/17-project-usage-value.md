...
- **396,219 lines** of production Lean code across 334 files (as of
  v0.35.135; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,126 theorem/lemma declarations** with zero sorry/axiom.
