...
- **349,806 lines** of production Lean code across 327 files (as of
  v0.34.103; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **11,680 theorem/lemma declarations** with zero sorry/axiom.
