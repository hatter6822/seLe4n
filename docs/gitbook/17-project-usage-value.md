...
- **396,888 lines** of production Lean code across 334 files (as of
  v0.35.157; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,137 theorem/lemma declarations** with zero sorry/axiom.
