...
- **339,431 lines** of production Lean code across 317 files (as of
  v0.34.85; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **11,287 theorem/lemma declarations** with zero sorry/axiom.
