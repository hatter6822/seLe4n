...
- **354,786 lines** of production Lean code across 328 files (as of
  v0.34.112; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **11,875 theorem/lemma declarations** with zero sorry/axiom.
