...
- **417,612 lines** of production Lean code across 340 files (as of
  v0.35.204; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,813 theorem/lemma declarations** with zero sorry/axiom.
