...
- **401,319 lines** of production Lean code across 334 files (as of
  v0.35.163; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,282 theorem/lemma declarations** with zero sorry/axiom.
