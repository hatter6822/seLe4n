...
- **386,726 lines** of production Lean code across 331 files (as of
  v0.35.77; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,913 theorem/lemma declarations** with zero sorry/axiom.
