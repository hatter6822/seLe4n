...
- **388,275 lines** of production Lean code across 332 files (as of
  v0.35.85; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,931 theorem/lemma declarations** with zero sorry/axiom.
