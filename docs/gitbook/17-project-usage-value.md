...
- **423,960 lines** of production Lean code across 344 files (as of
  v0.36.6; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **14,056 theorem/lemma declarations** with zero sorry/axiom.
