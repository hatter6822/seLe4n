...
- **361,146 lines** of production Lean code across 328 files (as of
  v0.34.136; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,084 theorem/lemma declarations** with zero sorry/axiom.
