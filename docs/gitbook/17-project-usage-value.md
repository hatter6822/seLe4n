...
- **415,446 lines** of production Lean code across 339 files (as of
  v0.35.199; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,739 theorem/lemma declarations** with zero sorry/axiom.
