...
- **361,390 lines** of production Lean code across 328 files (as of
  v0.34.138; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,090 theorem/lemma declarations** with zero sorry/axiom.
