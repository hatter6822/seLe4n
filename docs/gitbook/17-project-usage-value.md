...
- **394,244 lines** of production Lean code across 333 files (as of
  v0.35.109; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,097 theorem/lemma declarations** with zero sorry/axiom.
