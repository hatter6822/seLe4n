...
- **354,553 lines** of production Lean code across 328 files (as of
  v0.34.111; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **11,868 theorem/lemma declarations** with zero sorry/axiom.
