...
- **391,805 lines** of production Lean code across 333 files (as of
  v0.35.98; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,054 theorem/lemma declarations** with zero sorry/axiom.
