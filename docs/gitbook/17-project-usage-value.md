...
- **353,568 lines** of production Lean code across 327 files (as of
  v0.34.109; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **11,817 theorem/lemma declarations** with zero sorry/axiom.
