...
- **364,378 lines** of production Lean code across 328 files (as of
  v0.35.2; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,164 theorem/lemma declarations** with zero sorry/axiom.
