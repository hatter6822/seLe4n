...
- **413,957 lines** of production Lean code across 339 files (as of
  v0.35.196; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,674 theorem/lemma declarations** with zero sorry/axiom.
