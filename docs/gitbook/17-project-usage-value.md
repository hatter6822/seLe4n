...
- **374,568 lines** of production Lean code across 329 files (as of
  v0.35.6; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,576 theorem/lemma declarations** with zero sorry/axiom.
