...
- **351,182 lines** of production Lean code across 327 files (as of
  v0.34.104; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **11,729 theorem/lemma declarations** with zero sorry/axiom.
