...
- **417,841 lines** of production Lean code across 340 files (as of
  v0.36.1; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,815 theorem/lemma declarations** with zero sorry/axiom.
