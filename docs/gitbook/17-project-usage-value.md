...
- **347,188 lines** of production Lean code across 325 files (as of
  v0.34.96; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **11,567 theorem/lemma declarations** with zero sorry/axiom.
