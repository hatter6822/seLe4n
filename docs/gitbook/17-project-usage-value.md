...
- **343,801 lines** of production Lean code across 323 files (as of
  v0.34.93; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **11,449 theorem/lemma declarations** with zero sorry/axiom.
