...
- **387,521 lines** of production Lean code across 331 files (as of
  v0.35.83; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **12,918 theorem/lemma declarations** with zero sorry/axiom.
