...
- **403,351 lines** of production Lean code across 336 files (as of
  v0.35.167; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,368 theorem/lemma declarations** with zero sorry/axiom.
