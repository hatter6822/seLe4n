...
- **413,049 lines** of production Lean code across 339 files (as of
  v0.35.193; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **13,648 theorem/lemma declarations** with zero sorry/axiom.
