...
- **348,316 lines** of production Lean code across 326 files (as of
  v0.34.101; live metrics in `docs/codebase_map.json` → `readme_sync`).
- **11,613 theorem/lemma declarations** with zero sorry/axiom.
