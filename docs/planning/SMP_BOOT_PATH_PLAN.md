...
> **Status**: **IN FLIGHT — BP0, BP1, BP2, BP3 and BP4.1–BP4.6 LANDED at `v0.36.2`**; BP4.7 and BP5..BP8 not started.
...
> re-pricing it
> **Sub-task count**: 48 across 9 phases (BP0..BP8), each phase numbered in
> execution order
