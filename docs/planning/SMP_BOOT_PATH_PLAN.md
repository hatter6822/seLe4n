...
| BP7 | The context restore — TTBR0, the full frame, delivery, per-thread FP/SIMD state, the firmware's memory account, the root task's start | 11 | XL |
