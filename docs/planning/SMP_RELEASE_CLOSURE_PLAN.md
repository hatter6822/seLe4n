...
**46 sub-tasks across 9 phases `BP0..BP8`**, in execution order, with
...
[`SMP_BOOT_PATH_PLAN.md`](SMP_BOOT_PATH_PLAN.md)'s 46 sub-tasks, and `SM10.1.1`
...
[`SMP_BOOT_PATH_PLAN.md`](SMP_BOOT_PATH_PLAN.md)** (WS-BP, 46 sub-tasks
