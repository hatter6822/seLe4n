...
> **Sub-task count**: 48 across 6 phases (OD1..OD6), each phase numbered in the
...
| OD3 | The pop, generalised and behaviourally inert — signature, head validation, pre-state resolver, and the footprint split its growth needs | 14 | XL |
