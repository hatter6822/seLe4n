...
is item 4 below, which WS-BP BP4.5 closed at `v0.36.2`: both sites now emit, and
`kernelCodeWriteSites_all_emitted` replaced the partition marker that had
reported it as the last site owing an emission.)
