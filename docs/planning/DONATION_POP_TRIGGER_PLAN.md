...
> **Status**: **COMPLETE** — registered `v0.35.16`, all 55 sub-tasks landed
> `v0.35.35` → `v0.35.54`.  The donation accounting now holds at **every**
> reply-stack depth, which is a claim seL4-MCS cannot make.
> *(This line read "PLANNED — no sub-task has started" through nine landed
...
| HP10 | The reservation's origin, so the return does not depend on chain connectivity — **COMPLETE** (HP10.1–HP10.5 `v0.35.49`, HP10.6 `v0.35.50`, HP10.7 `v0.35.51`, HP10.8 `v0.35.52`, HP10.9 `v0.35.53`, HP10.10 `v0.35.54`) | 10 |
...
### HP10 — The reservation's origin, so the return does not depend on chain connectivity — COMPLETE (10 sub-tasks; HP10.1–HP10.5 `v0.35.49`, HP10.6 `v0.35.50`, HP10.7 `v0.35.51`, HP10.8 `v0.35.52`, HP10.9 `v0.35.53`, HP10.10 `v0.35.54`)
...
10. ~~`docs/REGISTERED_DEBT.md` table C's donation-accounting row is closed~~ —
    **this box is WRONG and is corrected at `v0.35.48` rather than acted on.**  It
    ...
    row is what RR8.15's hand-off check reads.  The *upstream-parity* half of
