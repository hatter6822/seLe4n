...
- **active workstream:** **WS-AG Phase AG1 COMPLETE** (v0.25.28): H3 Hardware Binding Audit Remediation — Phase AG1: Pre-Hardware Lean Code Fixes — 6 sub-tasks (AG1-A through AG1-F). AG1-A (S-04): CBS re-enqueue at effective priority (`resolveInsertPriority`, 5 call sites). AG1-B (S-05): `timeoutBlockedThreads` diagnostic error collection. AG1-C (F-T02): `uniqueWaiters` composed into `ipcInvariantFull` (14→15 conjuncts). AG1-D (P-03): `bootFromPlatformWithWarnings` duplicate detection. AG1-E (F-F04): `FrozenSchedulerState` `replenishQueue` field. AG1-F (T-01): Runtime `crossSubsystemInvariant` checks (10 decidable predicates, full coverage). Plan: [`docs/audits/AUDIT_H3_HARDWARE_BINDING_WORKSTREAM_PLAN.md`](audits/AUDIT_H3_HARDWARE_BINDING_WORKSTREAM_PLAN.md). **WS-AF PORTFOLIO COMPLETE** (v0.25.22–v0.25.27). **WS-AE PORTFOLIO COMPLETE** (v0.25.15–v0.25.21). **WS-AD PORTFOLIO COMPLETE** (v0.25.11–v0.25.14). **WS-AC PORTFOLIO COMPLETE** (v0.25.3–v0.25.10). **WS-AB PORTFOLIO COMPLETE** (v0.24.0–v0.25.5). **WS-AA COMPLETE** (v0.23.22–v0.23.23). **WS-Z PORTFOLIO COMPLETE** (v0.23.0–v0.23.21). All prior portfolios complete: WS-Y, WS-X, WS-W, WS-V, WS-U, WS-T, WS-S–WS-B (see `docs/WORKSTREAM_HISTORY.md`),
