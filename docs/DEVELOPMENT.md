...
- **active workstream:** **WS-Z IN PROGRESS** — Phases Z1–Z4 complete (v0.23.0–v0.23.8). Z4: Scheduler Integration (33 sub-tasks, CBS budget engine + replenishment queue wired into scheduler, 6 new invariants, `schedulerInvariantBundleExtended` 15-tuple). **WS-Y PORTFOLIO COMPLETE** (v0.22.23–v0.22.26). **WS-X PORTFOLIO COMPLETE** (v0.22.18–v0.22.22). All prior portfolios complete: WS-W (v0.22.11–v0.22.17), WS-V (v0.22.0–v0.22.9), WS-U (v0.21.0–v0.21.7), WS-T (v0.20.0–v0.20.7), WS-S–WS-B (see `docs/WORKSTREAM_HISTORY.md`),
