...
- **active workstream:** **WS-AG Phase AG4 COMPLETE** (v0.26.5): HAL Crate + Boot Foundation — 7 sub-tasks (AG4-A through AG4-G). New `sele4n-hal` Rust crate (4th workspace crate) with ARM64 boot sequence, PL011 UART driver, MMU initialization (identity-mapped L1 block descriptors), exception vector table (16 entries, 2048-byte aligned), trap entry/exit assembly (272-byte TrapFrame, full GPR save/restore), kernel linker script (0x80000 entry). GIC-400 and timer stubs for AG5. **Phase AG3 COMPLETE** (v0.26.4): Platform Model Completion. **Phase AG2 Audit COMPLETE** (v0.26.2). **Phase AG2 COMPLETE** (v0.26.1): Pre-Hardware Rust ABI Fixes. **Phase AG1 COMPLETE** (v0.26.0): Pre-Hardware Lean Code Fixes. Plan: [`docs/audits/AUDIT_H3_HARDWARE_BINDING_WORKSTREAM_PLAN.md`](audits/AUDIT_H3_HARDWARE_BINDING_WORKSTREAM_PLAN.md). **WS-AF PORTFOLIO COMPLETE** (v0.25.22–v0.25.27). **WS-AE PORTFOLIO COMPLETE** (v0.25.15–v0.25.21). **WS-AD PORTFOLIO COMPLETE** (v0.25.11–v0.25.14). **WS-AC PORTFOLIO COMPLETE** (v0.25.3–v0.25.10). **WS-AB PORTFOLIO COMPLETE** (v0.24.0–v0.25.5). **WS-AA COMPLETE** (v0.23.22–v0.23.23). **WS-Z PORTFOLIO COMPLETE** (v0.23.0–v0.23.21). All prior portfolios complete: WS-Y, WS-X, WS-W, WS-V, WS-U, WS-T, WS-S–WS-B (see `docs/WORKSTREAM_HISTORY.md`),
