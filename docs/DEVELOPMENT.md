...
- **Phase P3:** WS-B7, WS-B9, WS-B10, WS-B11 (assurance and operational maturity; WS-B7/WS-B9 completed)
...
1. Sync branch and choose one coherent WS-B slice (prefer next unfinished stream: WS-B10 onward).
