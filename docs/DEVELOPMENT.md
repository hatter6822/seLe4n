...
- **active workstream:** **WS-AF Phase AF5 COMPLETE** (v0.25.26): IPC, Capability, Lifecycle & Documentation — 10 sub-tasks (AF5-A through AF5-J). Fixed stale `pendingMessage = none` documentation (AF-12), timeout sentinel H3 migration (AF-04), `endpointQueueRemove` direct insert rationale (AF-06), Badge Nat round-trip safety (AF-15), `donationChainAcyclic` 2-cycle scope (AF-39), tuple projection burden (AF-26), CSpace resolution layers (AF-27), `suspendThread` re-lookup (AF-28), FrozenOps count 21→24 (AF-43), duplicate NI def removal (AF-48), high-heartbeat fragility (AF-31). **WS-AF Phase AF4 COMPLETE** (v0.25.25): Information Flow, Cross-Subsystem & SchedContext — all `native_decide` eliminated (AF-16/AF-17, TCB reduction), fuel-sufficiency documentation (AF-07), `serviceHasPathTo` fuel-exhaustion semantics (AF-18), `LabelingContextValid` deployment cross-reference (AF-33), CBS bandwidth precision documentation (AF-08), `schedContextYieldTo` kernel-internal design (AF-30/AF-47). **WS-AF Phase AF3 COMPLETE** (v0.25.24): Platform & DeviceTree Hardening — `parseFdtNodes` fuel-exhaustion fix (AF-05), full MMIO write byte-range validation (AF-09a), MMIO write-semantics documentation (AF-09b), `extractPeripherals` depth documentation (AF-32), `natKeysNoDup` opacity documentation (AF-19), DTB/boot stub annotations (AF-41/42/44/45). **WS-AF Phase AF2 COMPLETE** (v0.25.23): State & Model Hardening — machine-checked `storeObject` capacity safety (AF-03), `SchedContextId.ofObjIdChecked` sentinel guard (AF-22), builder-phase W^X proof obligation (AF-24), freeze/model/CDT documentation (AF-23/AF-25/AF-34). **WS-AF Phase AF1 COMPLETE** (v0.25.22): Scheduler Correctness & Proof Gaps — `blockingAcyclic` integrated into `crossSubsystemInvariant` (10th predicate), WCRT/PIP theorem renames, frame lemmas, documentation. **WS-AE PORTFOLIO COMPLETE** (v0.25.15–v0.25.21): Production Audit Remediation — 6 phases (AE1–AE6), 53 sub-tasks. Phase AE6 (v0.25.21): Testing, Documentation & Closure — PIP suite execution (U-25), `buildChecked` upgrade (T-07), test_rust.sh CI skip logging (T-F17), Rust ABI comment fix (R-F01), CLAUDE.md refresh, documentation sync. Phase AE5 (v0.25.20): Platform, Service & Cross-Subsystem. Phase AE4 (v0.25.19): Capability, IPC & Architecture Hardening. Phase AE3 (v0.25.18): Scheduler & SchedContext Correctness. Phase AE2 (v0.25.16): Data Structure Hardening. Phase AE1 (v0.25.15): API Dispatch & NI Composition. See `docs/dev_history/audits/AUDIT_v0.25.14_WORKSTREAM_PLAN.md`. **WS-AD PORTFOLIO COMPLETE** (v0.25.11–v0.25.14). **WS-AC PORTFOLIO COMPLETE** (v0.25.3–v0.25.10). **WS-AB PORTFOLIO COMPLETE** (v0.24.0–v0.25.5). **WS-AA COMPLETE** (v0.23.22–v0.23.23). **WS-Z PORTFOLIO COMPLETE** (v0.23.0–v0.23.21). All prior portfolios complete: WS-Y, WS-X, WS-W, WS-V, WS-U, WS-T, WS-S–WS-B (see `docs/WORKSTREAM_HISTORY.md`),
