...
- **next workstream:** WS-H12b–f, H13..H16 (remaining v0.12.15 audit remediation — dequeue-on-dispatch scheduler semantics, register context, message bounds, CSpace/service enrichment, type safety, platform hardening, testing/docs),
...
| **WS-H12b–f** | Scheduler/IPC semantic alignment (dequeue-on-dispatch, register context, message bounds) | Medium | Next |
