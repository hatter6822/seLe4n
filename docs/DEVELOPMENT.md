...
- **active workstream:** **WS-U Phase U1 COMPLETE** (Correctness Fixes) — 13 sub-tasks (U1-A through U1-M) addressing 7 audit findings (U-H01–U-H04, U-H13, U-H14, U-M39) from the v0.20.7 audit. Frozen queue link safety, retype page-alignment, lifecycle dispatch cleanup, authority right alignment, IPC CSpace root fallback, CDT deletion guard, domain switch context save. All prior portfolios complete: WS-T (v0.20.0–v0.20.7), WS-S (v0.19.0–v0.19.6), WS-R (v0.18.0–v0.18.7), WS-Q (v0.17.7–v0.17.14), WS-N (v0.17.0–v0.17.5), WS-M (v0.16.14–v0.17.0), WS-L (v0.16.9–v0.16.13), WS-K (v0.16.0–v0.16.8), WS-J1 (v0.15.4–v0.15.10), WS-F (F1..F8),
...
[`docs/audits/AUDIT_v0.20.7_WORKSTREAM_PLAN.md`](audits/AUDIT_v0.20.7_WORKSTREAM_PLAN.md) for WS-U (Phase U1 complete),
