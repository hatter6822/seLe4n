...
- **active workstream:** **WS-U Phase U2 COMPLETE** (Safety Boundary Hardening) — 14 sub-tasks (U2-A through U2-N) hardening input validation and type safety: VAddr canonical checks, parameterized PA width, ASID validation, AccessRightSet proof-carrying constructor, allTablesInvExt completeness witness, storeObject callsite audit, negative LawfulBEq instances. All prior portfolios complete: WS-U U1 (v0.21.0), WS-T (v0.20.0–v0.20.7), WS-S (v0.19.0–v0.19.6), WS-R (v0.18.0–v0.18.7), WS-Q (v0.17.7–v0.17.14), WS-N (v0.17.0–v0.17.5), WS-M (v0.16.14–v0.17.0), WS-L (v0.16.9–v0.16.13), WS-K (v0.16.0–v0.16.8), WS-J1 (v0.15.4–v0.15.10), WS-F (F1..F8),
