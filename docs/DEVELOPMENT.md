...
- **next workstream:** WS-H12d–f, H13..H16 (remaining v0.12.15 audit remediation — message bounds, cross-subsystem reconciliation, CSpace/service enrichment, type safety, platform hardening, testing/docs),
