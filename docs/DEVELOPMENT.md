...
- **WS-H6:** in progress (v0.12.20-dev). Scheduler proof-surface extension landed: `RunQueue.flat_wf_rev`, `membership_implies_flat`, `mem_toList_iff_mem`, `isBetterCandidate_transitive`, and `bucketFirst_fullScan_equivalence`.
