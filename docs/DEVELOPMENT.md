...
- **next workstream:** WS-H12f, H13..H16 (remaining v0.12.15 audit remediation — test harness/docs sync, CSpace/service enrichment, type safety, platform hardening, testing/docs),
...
| **WS-H12f** | Test harness update & documentation sync | Medium | Next |
