...
| Upstream seL4 microkernel reference | `docs/spec/SEL4_SPEC.md` | `02-microkernel-and-sel4-primer.md` | Reference document; chapter summarizes and links back. |
...
- Active planning baseline: `AUDIT_v0.9.32_WORKSTREAM_PLAN.md` (WS-C portfolio; WS-C3 completed, WS-C4/WS-C8 actively progressing).
