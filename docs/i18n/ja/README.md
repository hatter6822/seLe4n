...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.4-blue" alt="Version" />
...
| **本番 Lean コード行数** | 328 ファイルにわたる 369,809 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 75,158 行 |
| **証明済み宣言数** | 12,402 件の定理/補題宣言（sorry/axiom ゼロ） |
