...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.160-blue" alt="Version" />
...
| **本番 Lean コード行数** | 334 ファイルにわたる 397,589 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 81,318 行 |
| **証明済み宣言数** | 13,152 件の定理/補題宣言（sorry/axiom ゼロ） |
