...
| **本番 Lean コード行数** | 343 ファイルにわたる 420,295 行 |
| **テスト Lean コード行数** | 71 テストスイートにわたる 85,416 行 |
| **証明済み宣言数** | 13,916 件の定理/補題宣言（sorry/axiom ゼロ） |
