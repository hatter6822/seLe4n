...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.170-blue" alt="Version" />
...
| **本番 Lean コード行数** | 336 ファイルにわたる 404,629 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 82,811 行 |
| **証明済み宣言数** | 13,414 件の定理/補題宣言（sorry/axiom ゼロ） |
