...
| **最新監査** | [`AUDIT_COMPREHENSIVE_v0.23.21`](../../../docs/audits/AUDIT_COMPREHENSIVE_v0.23.21_LEAN_RUST_KERNEL.md) ―― カーネル全体 Lean + Rust 監査（0 CRIT、5 HIGH、8 MED、30 LOW） |
...
| ワークストリーム | 範囲 | バージョン |
|---------------|------|----------|
| **WS-AB** | 遅延操作と活性――suspend/resume、setPriority/setMCPriority、setIPCBuffer、優先度継承プロトコル、有界レイテンシ定理（6 フェーズ、90 タスク） | v0.24.0–v0.25.3 |
