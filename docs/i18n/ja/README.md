...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.172-blue" alt="Version" />
...
| **本番 Lean コード行数** | 336 ファイルにわたる 405,258 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 83,005 行 |
| **証明済み宣言数** | 13,430 件の定理/補題宣言（sorry/axiom ゼロ） |
