...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.117-blue" alt="Version" />
...
| **本番 Lean コード行数** | 328 ファイルにわたる 355,474 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 72,433 行 |
| **証明済み宣言数** | 11,887 件の定理/補題宣言（sorry/axiom ゼロ） |
