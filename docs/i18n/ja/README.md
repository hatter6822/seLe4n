...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.184-blue" alt="Version" />
...
| **本番 Lean コード行数** | 338 ファイルにわたる 409,214 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 83,492 行 |
| **証明済み宣言数** | 13,536 件の定理/補題宣言（sorry/axiom ゼロ） |
