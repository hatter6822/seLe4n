...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.35-blue" alt="Version" />
...
| **本番 Lean コード行数** | 330 ファイルにわたる 377,396 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 76,463 行 |
| **証明済み宣言数** | 12,626 件の定理/補題宣言（sorry/axiom ゼロ） |
