...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.9-blue" alt="Version" />
...
| **本番 Lean コード行数** | 329 ファイルにわたる 374,875 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 75,847 行 |
| **証明済み宣言数** | 12,593 件の定理/補題宣言（sorry/axiom ゼロ） |
