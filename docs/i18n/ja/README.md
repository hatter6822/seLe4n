...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.72-blue" alt="Version" />
...
| **本番 Lean コード行数** | 331 ファイルにわたる 386,458 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 78,776 行 |
| **証明済み宣言数** | 12,905 件の定理/補題宣言（sorry/axiom ゼロ） |
