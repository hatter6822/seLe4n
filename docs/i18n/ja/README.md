...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.50-blue" alt="Version" />
...
| **本番 Lean コード行数** | 330 ファイルにわたる 382,916 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 77,855 行 |
| **証明済み宣言数** | 12,754 件の定理/補題宣言（sorry/axiom ゼロ） |
