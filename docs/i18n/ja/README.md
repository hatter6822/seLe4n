...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.109-blue" alt="Version" />
...
| **本番 Lean コード行数** | 327 ファイルにわたる 353,568 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 71,487 行 |
| **証明済み宣言数** | 11,817 件の定理/補題宣言（sorry/axiom ゼロ） |
