...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.46-blue" alt="Version" />
...
| **本番 Lean コード行数** | 330 ファイルにわたる 381,844 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 77,346 行 |
| **証明済み宣言数** | 12,733 件の定理/補題宣言（sorry/axiom ゼロ） |
