...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.96-blue" alt="Version" />
...
| **本番 Lean コード行数** | 325 ファイルにわたる 347,188 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 71,244 行 |
| **証明済み宣言数** | 11,567 件の定理/補題宣言（sorry/axiom ゼロ） |
