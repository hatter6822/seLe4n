...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.105-blue" alt="Version" />
...
| **本番 Lean コード行数** | 327 ファイルにわたる 352,004 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 71,347 行 |
| **証明済み宣言数** | 11,754 件の定理/補題宣言（sorry/axiom ゼロ） |
