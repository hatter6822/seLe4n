...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.201-blue" alt="Version" />
...
| **本番 Lean コード行数** | 340 ファイルにわたる 417,407 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 84,545 行 |
| **証明済み宣言数** | 13,810 件の定理/補題宣言（sorry/axiom ゼロ） |
