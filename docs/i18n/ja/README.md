...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.2-blue" alt="Version" />
...
| **本番 Lean コード行数** | 328 ファイルにわたる 364,378 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 74,602 行 |
| **証明済み宣言数** | 12,164 件の定理/補題宣言（sorry/axiom ゼロ） |
