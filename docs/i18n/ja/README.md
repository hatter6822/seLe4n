...
| **標準監査** | [`AUDIT_v0.29.0_COMPREHENSIVE`](../../../docs/audits/AUDIT_v0.29.0_COMPREHENSIVE.md) ―― 1.0 前の包括的監査（202 件の指摘事項；WS-AK AK1–AK10 で修正済み） |
| **最新監査** | [`AUDIT_v0.30.6_COMPREHENSIVE`](../../../docs/audits/AUDIT_v0.30.6_COMPREHENSIVE.md) ―― 1.0 前の堅牢化監査（3 CRIT、24 HIGH、71 MED、58 LOW、40 INFO ―― §0.4 の初期スコアリング） |
