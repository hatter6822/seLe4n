...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.106-blue" alt="Version" />
...
| **本番 Lean コード行数** | 333 ファイルにわたる 393,612 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 79,985 行 |
| **証明済み宣言数** | 13,082 件の定理/補題宣言（sorry/axiom ゼロ） |
