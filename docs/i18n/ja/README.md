...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.136-blue" alt="Version" />
...
| **本番 Lean コード行数** | 334 ファイルにわたる 396,365 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 80,607 行 |
| **証明済み宣言数** | 13,128 件の定理/補題宣言（sorry/axiom ゼロ） |
