...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.10-blue" alt="Version" />
...
| **本番 Lean コード行数** | 329 ファイルにわたる 375,003 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 75,860 行 |
| **証明済み宣言数** | 12,599 件の定理/補題宣言（sorry/axiom ゼロ） |
