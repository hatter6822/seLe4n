...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.104-blue" alt="Version" />
...
| **本番 Lean コード行数** | 327 ファイルにわたる 351,182 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 71,319 行 |
| **証明済み宣言数** | 11,729 件の定理/補題宣言（sorry/axiom ゼロ） |
