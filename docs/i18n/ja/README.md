...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.89-blue" alt="Version" />
...
| **本番 Lean コード行数** | 321 ファイルにわたる 341,796 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 70,927 行 |
| **証明済み宣言数** | 11,393 件の定理/補題宣言（sorry/axiom ゼロ） |
