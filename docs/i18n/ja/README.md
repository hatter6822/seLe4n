...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.89-blue" alt="Version" />
...
| **本番 Lean コード行数** | 332 ファイルにわたる 389,122 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 79,009 行 |
| **証明済み宣言数** | 12,977 件の定理/補題宣言（sorry/axiom ゼロ） |
