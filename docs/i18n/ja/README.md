...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.134-blue" alt="Version" />
...
| **本番 Lean コード行数** | 334 ファイルにわたる 396,157 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 80,490 行 |
| **証明済み宣言数** | 13,126 件の定理/補題宣言（sorry/axiom ゼロ） |
