...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.179-blue" alt="Version" />
...
| **本番 Lean コード行数** | 338 ファイルにわたる 407,460 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 83,049 行 |
| **証明済み宣言数** | 13,481 件の定理/補題宣言（sorry/axiom ゼロ） |
