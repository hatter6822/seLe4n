...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.101-blue" alt="Version" />
...
| **本番 Lean コード行数** | 326 ファイルにわたる 348,316 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 71,289 行 |
| **証明済み宣言数** | 11,613 件の定理/補題宣言（sorry/axiom ゼロ） |
