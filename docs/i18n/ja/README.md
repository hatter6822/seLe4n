...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.140-blue" alt="Version" />
...
| **本番 Lean コード行数** | 328 ファイルにわたる 361,430 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 74,100 行 |
| **証明済み宣言数** | 12,090 件の定理/補題宣言（sorry/axiom ゼロ） |
