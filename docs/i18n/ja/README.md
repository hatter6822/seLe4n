...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.94-blue" alt="Version" />
...
| **本番 Lean コード行数** | 324 ファイルにわたる 344,934 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 71,128 行 |
| **証明済み宣言数** | 11,490 件の定理/補題宣言（sorry/axiom ゼロ） |
