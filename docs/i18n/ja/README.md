...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.88-blue" alt="Version" />
...
| **本番 Lean コード行数** | 317 ファイルにわたる 340,168 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 70,817 行 |
| **証明済み宣言数** | 11,316 件の定理/補題宣言（sorry/axiom ゼロ） |
