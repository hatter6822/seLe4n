...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.99-blue" alt="Version" />
...
| **本番 Lean コード行数** | 333 ファイルにわたる 391,919 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 79,621 行 |
| **証明済み宣言数** | 13,056 件の定理/補題宣言（sorry/axiom ゼロ） |
