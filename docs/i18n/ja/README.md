...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.108-blue" alt="Version" />
...
| **本番 Lean コード行数** | 333 ファイルにわたる 394,244 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 80,108 行 |
| **証明済み宣言数** | 13,097 件の定理/補題宣言（sorry/axiom ゼロ） |
