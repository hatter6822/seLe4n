...
| **現行正規監査** | [`AUDIT_v0.29.0_COMPREHENSIVE`](../../../docs/audits/AUDIT_v0.29.0_COMPREHENSIVE.md) ―― 終了済み監査（202 件の指摘、WS-AK フェーズ AK1–AK10 にて是正） |
| **最新監査** | [`AUDIT_v0.30.6_COMPREHENSIVE`](../../../docs/audits/AUDIT_v0.30.6_COMPREHENSIVE.md) ―― 1.0 前ハードニング監査（3 CRIT、24 HIGH、71 MED、58 LOW、40 INFO） |
