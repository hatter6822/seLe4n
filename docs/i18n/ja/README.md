...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.95-blue" alt="Version" />
...
| **本番 Lean コード行数** | 324 ファイルにわたる 346,230 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 71,194 行 |
| **証明済み宣言数** | 11,529 件の定理/補題宣言（sorry/axiom ゼロ） |
