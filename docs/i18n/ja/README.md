...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.163-blue" alt="Version" />
...
| **本番 Lean コード行数** | 334 ファイルにわたる 401,319 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 81,967 行 |
| **証明済み宣言数** | 13,282 件の定理/補題宣言（sorry/axiom ゼロ） |
