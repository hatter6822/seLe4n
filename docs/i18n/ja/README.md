...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.3-blue" alt="Version" />
...
| **本番 Lean コード行数** | 328 ファイルにわたる 364,812 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 74,909 行 |
| **証明済み宣言数** | 12,185 件の定理/補題宣言（sorry/axiom ゼロ） |
