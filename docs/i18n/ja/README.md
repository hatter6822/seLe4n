...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.80-blue" alt="Version" />
...
| **本番 Lean コード行数** | 331 ファイルにわたる 386,776 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 78,841 行 |
| **証明済み宣言数** | 12,902 件の定理/補題宣言（sorry/axiom ゼロ） |
