...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.181-blue" alt="Version" />
...
| **本番 Lean コード行数** | 338 ファイルにわたる 408,061 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 83,207 行 |
| **証明済み宣言数** | 13,504 件の定理/補題宣言（sorry/axiom ゼロ） |
