...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.85-blue" alt="Version" />
...
| **本番 Lean コード行数** | 332 ファイルにわたる 388,275 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 78,892 行 |
| **証明済み宣言数** | 12,931 件の定理/補題宣言（sorry/axiom ゼロ） |
