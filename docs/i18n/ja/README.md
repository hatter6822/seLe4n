...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.6-blue" alt="Version" />
...
| **本番 Lean コード行数** | 329 ファイルにわたる 374,568 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 75,813 行 |
| **証明済み宣言数** | 12,576 件の定理/補題宣言（sorry/axiom ゼロ） |
