...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.162-blue" alt="Version" />
...
| **本番 Lean コード行数** | 334 ファイルにわたる 399,995 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 81,812 行 |
| **証明済み宣言数** | 13,242 件の定理/補題宣言（sorry/axiom ゼロ） |
