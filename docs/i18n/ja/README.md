...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.112-blue" alt="Version" />
...
| **本番 Lean コード行数** | 328 ファイルにわたる 354,786 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 71,694 行 |
| **証明済み宣言数** | 11,875 件の定理/補題宣言（sorry/axiom ゼロ） |
