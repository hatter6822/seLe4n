...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.64-blue" alt="Version" />
...
| **本番 Lean コード行数** | 330 ファイルにわたる 385,804 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 78,722 行 |
| **証明済み宣言数** | 12,867 件の定理/補題宣言（sorry/axiom ゼロ） |
