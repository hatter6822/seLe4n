...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.188-blue" alt="Version" />
...
| **本番 Lean コード行数** | 338 ファイルにわたる 410,635 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 83,589 行 |
| **証明済み宣言数** | 13,584 件の定理/補題宣言（sorry/axiom ゼロ） |
