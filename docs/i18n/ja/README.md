...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.92-blue" alt="Version" />
...
| **本番 Lean コード行数** | 323 ファイルにわたる 343,521 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 71,084 行 |
| **証明済み宣言数** | 11,444 件の定理/補題宣言（sorry/axiom ゼロ） |
