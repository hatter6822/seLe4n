...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.133-blue" alt="Version" />
...
| **本番 Lean コード行数** | 334 ファイルにわたる 396,021 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 80,339 行 |
| **証明済み宣言数** | 13,127 件の定理/補題宣言（sorry/axiom ゼロ） |
