...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.44-blue" alt="Version" />
...
| **本番 Lean コード行数** | 330 ファイルにわたる 380,540 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 77,224 行 |
| **証明済み宣言数** | 12,706 件の定理/補題宣言（sorry/axiom ゼロ） |
