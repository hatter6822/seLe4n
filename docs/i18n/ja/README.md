...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.134-blue" alt="Version" />
...
| **本番 Lean コード行数** | 328 ファイルにわたる 360,710 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 73,857 行 |
| **証明済み宣言数** | 12,070 件の定理/補題宣言（sorry/axiom ゼロ） |
