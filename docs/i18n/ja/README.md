...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.90-blue" alt="Version" />
...
| **本番 Lean コード行数** | 323 ファイルにわたる 342,776 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 71,065 行 |
| **証明済み宣言数** | 11,427 件の定理/補題宣言（sorry/axiom ゼロ） |
