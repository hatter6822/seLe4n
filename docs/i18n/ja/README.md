...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.191-blue" alt="Version" />
...
| **本番 Lean コード行数** | 339 ファイルにわたる 412,643 行 |
| **テスト Lean コード行数** | 70 テストスイートにわたる 83,880 行 |
| **証明済み宣言数** | 13,638 件の定理/補題宣言（sorry/axiom ゼロ） |
