...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.83-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 387 521 строка в 331 файле |
| **Тестовый код (Lean LoC)** | 78 892 строки в 70 тест-сьютах |
| **Доказанные декларации** | 12 918 деклараций theorem/lemma (ноль sorry/axiom) |
