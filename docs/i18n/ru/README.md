...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.177-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 406 667 строк в 338 файлах |
| **Тестовый код (Lean LoC)** | 83 019 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 463 декларации theorem/lemma (ноль sorry/axiom) |
