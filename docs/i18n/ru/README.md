...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.99-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 391 919 строк в 333 файлах |
| **Тестовый код (Lean LoC)** | 79 621 строка в 70 тест-сьютах |
| **Доказанные декларации** | 13 056 деклараций theorem/lemma (ноль sorry/axiom) |
