...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.58-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 385 041 строка в 330 файлах |
| **Тестовый код (Lean LoC)** | 78 456 строк в 70 тест-сьютах |
| **Доказанные декларации** | 12 816 деклараций theorem/lemma (ноль sorry/axiom) |
