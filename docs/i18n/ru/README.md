...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.92-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 343 521 строка в 323 файлах |
| **Тестовый код (Lean LoC)** | 71 084 строки в 70 тест-сьютах |
| **Доказанные декларации** | 11 444 декларации theorem/lemma (ноль sorry/axiom) |
