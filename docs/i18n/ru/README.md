...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.173-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 405 604 строки в 337 файлах |
| **Тестовый код (Lean LoC)** | 83 005 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 430 деклараций theorem/lemma (ноль sorry/axiom) |
