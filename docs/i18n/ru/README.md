...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.95-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 391 269 строк в 333 файлах |
| **Тестовый код (Lean LoC)** | 79 176 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 043 декларации theorem/lemma (ноль sorry/axiom) |
