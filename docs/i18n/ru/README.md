...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.45-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 382 025 строк в 330 файлах |
| **Тестовый код (Lean LoC)** | 77 280 строк в 70 тест-сьютах |
| **Доказанные декларации** | 12 741 декларация theorem/lemma (ноль sorry/axiom) |
