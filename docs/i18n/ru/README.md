...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.89-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 341 796 строк в 321 файле |
| **Тестовый код (Lean LoC)** | 70 927 строк в 70 тест-сьютах |
| **Доказанные декларации** | 11 393 декларации theorem/lemma (ноль sorry/axiom) |
