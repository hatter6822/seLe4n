...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.165-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 402 324 строки в 334 файлах |
| **Тестовый код (Lean LoC)** | 82 280 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 333 декларации theorem/lemma (ноль sorry/axiom) |
