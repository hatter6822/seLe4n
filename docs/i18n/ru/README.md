...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.120-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 355 799 строк в 328 файлах |
| **Тестовый код (Lean LoC)** | 72 662 строки в 70 тест-сьютах |
| **Доказанные декларации** | 11 889 деклараций theorem/lemma (ноль sorry/axiom) |
