...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.87-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 339 955 строк в 317 файлах |
| **Тестовый код (Lean LoC)** | 70 722 строки в 70 тест-сьютах |
| **Доказанные декларации** | 11 305 деклараций theorem/lemma (ноль sorry/axiom) |
