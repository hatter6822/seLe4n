...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.200-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 417 397 строк в 340 файлах |
| **Тестовый код (Lean LoC)** | 84 404 строки в 70 тест-сьютах |
| **Доказанные декларации** | 13 805 деклараций theorem/lemma (ноль sorry/axiom) |
