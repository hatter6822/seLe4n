...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.85-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 388 275 строк в 332 файлах |
| **Тестовый код (Lean LoC)** | 78 892 строки в 70 тест-сьютах |
| **Доказанные декларации** | 12 931 декларация theorem/lemma (ноль sorry/axiom) |
