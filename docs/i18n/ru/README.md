...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.159-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 397 042 строки в 334 файлах |
| **Тестовый код (Lean LoC)** | 81 232 строки в 70 тест-сьютах |
