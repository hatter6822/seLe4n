...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.190-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 411 743 строки в 338 файлах |
| **Тестовый код (Lean LoC)** | 83 880 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 613 деклараций theorem/lemma (ноль sorry/axiom) |
