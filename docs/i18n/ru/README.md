...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.166-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 402 742 строки в 335 файлах |
| **Тестовый код (Lean LoC)** | 82 280 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 344 декларации theorem/lemma (ноль sorry/axiom) |
