...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.79-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 385 802 строки в 331 файле |
| **Тестовый код (Lean LoC)** | 78 841 строка в 70 тест-сьютах |
| **Доказанные декларации** | 12 865 деклараций theorem/lemma (ноль sorry/axiom) |
