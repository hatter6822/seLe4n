...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.95-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 346 230 строк в 324 файлах |
| **Тестовый код (Lean LoC)** | 71 194 строки в 70 тест-сьютах |
| **Доказанные декларации** | 11 529 деклараций theorem/lemma (ноль sorry/axiom) |
