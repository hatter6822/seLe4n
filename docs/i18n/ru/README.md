...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.37-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 378 887 строк в 330 файлах |
| **Тестовый код (Lean LoC)** | 76 620 строк в 70 тест-сьютах |
| **Доказанные декларации** | 12 676 деклараций theorem/lemma (ноль sorry/axiom) |
