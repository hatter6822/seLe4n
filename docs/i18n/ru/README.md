...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.196-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 413 957 строк в 339 файлах |
| **Тестовый код (Lean LoC)** | 84 404 строки в 70 тест-сьютах |
| **Доказанные декларации** | 13 674 декларации theorem/lemma (ноль sorry/axiom) |
