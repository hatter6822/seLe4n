...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.110-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 354 553 строки в 328 файлах |
| **Тестовый код (Lean LoC)** | 71 633 строки в 70 тест-сьютах |
| **Доказанные декларации** | 11 868 деклараций theorem/lemma (ноль sorry/axiom) |
