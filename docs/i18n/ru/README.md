...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.167-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 403 351 строка в 336 файлах |
| **Тестовый код (Lean LoC)** | 82 491 строка в 70 тест-сьютах |
| **Доказанные декларации** | 13 368 деклараций theorem/lemma (ноль sorry/axiom) |
