...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.102-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 349 349 строк в 326 файлах |
| **Тестовый код (Lean LoC)** | 71 289 строк в 70 тест-сьютах |
| **Доказанные декларации** | 11 667 деклараций theorem/lemma (ноль sorry/axiom) |
