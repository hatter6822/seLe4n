...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.84-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 387 893 строки в 331 файле |
| **Тестовый код (Lean LoC)** | 78 892 строки в 70 тест-сьютах |
| **Доказанные декларации** | 12 925 деклараций theorem/lemma (ноль sorry/axiom) |
