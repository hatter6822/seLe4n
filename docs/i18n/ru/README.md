...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.92-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 390 600 строк в 333 файлах |
| **Тестовый код (Lean LoC)** | 79 157 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 014 деклараций theorem/lemma (ноль sorry/axiom) |
