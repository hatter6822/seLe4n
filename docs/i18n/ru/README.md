...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.5-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 370 721 строка в 328 файлах |
| **Тестовый код (Lean LoC)** | 75 430 строк в 70 тест-сьютах |
| **Доказанные декларации** | 12 428 деклараций theorem/lemma (ноль sorry/axiom) |
