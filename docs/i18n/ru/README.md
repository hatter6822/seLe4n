...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.180-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 407 635 строк в 338 файлах |
| **Тестовый код (Lean LoC)** | 83 095 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 486 деклараций theorem/lemma (ноль sorry/axiom) |
