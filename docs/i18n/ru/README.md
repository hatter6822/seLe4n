...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.129-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 359 285 строк в 328 файлах |
| **Тестовый код (Lean LoC)** | 73 670 строк в 70 тест-сьютах |
| **Доказанные декларации** | 12 041 декларация theorem/lemma (ноль sorry/axiom) |
