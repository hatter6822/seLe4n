...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.89-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 389 122 строки в 332 файлах |
| **Тестовый код (Lean LoC)** | 79 009 строк в 70 тест-сьютах |
| **Доказанные декларации** | 12 977 деклараций theorem/lemma (ноль sorry/axiom) |
