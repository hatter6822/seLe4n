...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.54-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 383 951 строка в 330 файлах |
| **Тестовый код (Lean LoC)** | 78 257 строк в 70 тест-сьютах |
| **Доказанные декларации** | 12 771 декларация theorem/lemma (ноль sorry/axiom) |
