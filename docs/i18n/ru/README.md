...
| **Продуктовый код (Lean LoC)** | 60 116 строк в 100 файлах |
| **Тестовый код (Lean LoC)** | 7 561 строк в 10 тест-сьютах (test suites) |
| **Доказанные декларации** | 1 812 деклараций theorem/lemma (ноль sorry/axiom) |
