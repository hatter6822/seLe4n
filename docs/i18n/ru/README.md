...
| **Продуктовый код (Lean LoC)** | 378 753 строки в 330 файлах |
| **Тестовый код (Lean LoC)** | 76 540 строк в 70 тест-сьютах |
| **Доказанные декларации** | 12 671 декларация theorem/lemma (ноль sorry/axiom) |
