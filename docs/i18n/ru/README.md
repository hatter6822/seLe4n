...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.71-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 386 443 строки в 331 файле |
| **Тестовый код (Lean LoC)** | 78 776 строк в 70 тест-сьютах |
| **Доказанные декларации** | 12 905 деклараций theorem/lemma (ноль sorry/axiom) |
