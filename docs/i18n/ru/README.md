...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.51-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 383 641 строка в 330 файлах |
| **Тестовый код (Lean LoC)** | 77 948 строк в 70 тест-сьютах |
| **Доказанные декларации** | 12 767 деклараций theorem/lemma (ноль sorry/axiom) |
