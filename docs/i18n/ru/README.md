...
| **Продуктовый код (Lean LoC)** | 419 011 строк в 342 файлах |
| **Тестовый код (Lean LoC)** | 85 328 строк в 71 тест-сьюте |
| **Доказанные декларации** | 13 871 декларация theorem/lemma (ноль sorry/axiom) |
