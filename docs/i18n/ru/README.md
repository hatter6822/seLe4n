...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.183-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 409 202 строки в 338 файлах |
| **Тестовый код (Lean LoC)** | 83 391 строка в 70 тест-сьютах |
| **Доказанные декларации** | 13 536 деклараций theorem/lemma (ноль sorry/axiom) |
