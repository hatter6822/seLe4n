...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.96-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 347 188 строк в 325 файлах |
| **Тестовый код (Lean LoC)** | 71 244 строки в 70 тест-сьютах |
| **Доказанные декларации** | 11 567 деклараций theorem/lemma (ноль sorry/axiom) |
