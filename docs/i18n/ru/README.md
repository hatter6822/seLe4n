...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.125-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 356 971 строка в 328 файлах |
| **Тестовый код (Lean LoC)** | 73 043 строки в 70 тест-сьютах |
| **Доказанные декларации** | 11 935 деклараций theorem/lemma (ноль sorry/axiom) |
