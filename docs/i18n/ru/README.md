...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.103-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 349 806 строк в 327 файлах |
| **Тестовый код (Lean LoC)** | 71 289 строк в 70 тест-сьютах |
| **Доказанные декларации** | 11 680 деклараций theorem/lemma (ноль sorry/axiom) |
