...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.193-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 413 049 строк в 339 файлах |
| **Тестовый код (Lean LoC)** | 84 109 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 648 деклараций theorem/lemma (ноль sorry/axiom) |
