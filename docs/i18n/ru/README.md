...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.199-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 415 446 строк в 339 файлах |
| **Тестовый код (Lean LoC)** | 84 404 строки в 70 тест-сьютах |
| **Доказанные декларации** | 13 739 деклараций theorem/lemma (ноль sorry/axiom) |
