...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.108-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 352 854 строки в 327 файлах |
| **Тестовый код (Lean LoC)** | 71 412 строк в 70 тест-сьютах |
| **Доказанные декларации** | 11 788 деклараций theorem/lemma (ноль sorry/axiom) |
