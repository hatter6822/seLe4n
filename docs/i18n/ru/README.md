...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.192-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 412 636 строк в 339 файлах |
| **Тестовый код (Lean LoC)** | 83 961 строка в 70 тест-сьютах |
