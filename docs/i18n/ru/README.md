...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.195-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 413 406 строк в 339 файлах |
| **Тестовый код (Lean LoC)** | 84 248 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 654 декларации theorem/lemma (ноль sorry/axiom) |
