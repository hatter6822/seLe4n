...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.197-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 414 657 строк в 339 файлах |
| **Тестовый код (Lean LoC)** | 84 404 строки в 70 тест-сьютах |
| **Доказанные декларации** | 13 702 декларации theorem/lemma (ноль sorry/axiom) |
