...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.26-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 376 821 строка в 330 файлах |
| **Тестовый код (Lean LoC)** | 76 127 строк в 70 тест-сьютах |
