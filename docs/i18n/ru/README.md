...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.185-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 410 148 строк в 338 файлах |
| **Тестовый код (Lean LoC)** | 83 492 строки в 70 тест-сьютах |
| **Доказанные декларации** | 13 560 деклараций theorem/lemma (ноль sorry/axiom) |
