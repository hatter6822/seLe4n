...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.130-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 359 761 строка в 328 файлах |
| **Тестовый код (Lean LoC)** | 73 716 строк в 70 тест-сьютах |
| **Доказанные декларации** | 12 049 деклараций theorem/lemma (ноль sorry/axiom) |
