...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.175-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 406 166 строк в 338 файлах |
| **Тестовый код (Lean LoC)** | 83 005 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 448 деклараций theorem/lemma (ноль sorry/axiom) |
