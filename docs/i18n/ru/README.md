...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.122-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 355 873 строки в 328 файлах |
| **Тестовый код (Lean LoC)** | 72 799 строк в 70 тест-сьютах |
