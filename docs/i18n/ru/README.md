...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.36.5-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 423 001 строка в 343 файлах |
| **Тестовый код (Lean LoC)** | 86 115 строк в 71 тест-сьюте |
| **Доказанные декларации** | 14 028 деклараций theorem/lemma (ноль sorry/axiom) |
