...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.36.6-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 423 960 строк в 344 файлах |
| **Тестовый код (Lean LoC)** | 86 280 строк в 71 тест-сьюте |
| **Доказанные декларации** | 14 056 деклараций theorem/lemma (ноль sorry/axiom) |
