...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.6-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 374 568 строк в 329 файлах |
| **Тестовый код (Lean LoC)** | 75 813 строк в 70 тест-сьютах |
| **Доказанные декларации** | 12 576 деклараций theorem/lemma (ноль sorry/axiom) |
