...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.97-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 391 604 строки в 333 файлах |
| **Тестовый код (Lean LoC)** | 79 392 строки в 70 тест-сьютах |
| **Доказанные декларации** | 13 052 декларации theorem/lemma (ноль sorry/axiom) |
