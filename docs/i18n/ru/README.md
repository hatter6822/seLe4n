...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.125-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 395 341 строка в 334 файлах |
| **Тестовый код (Lean LoC)** | 80 213 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 117 деклараций theorem/lemma (ноль sorry/axiom) |
