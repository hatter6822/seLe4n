...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.168-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 403 754 строки в 336 файлах |
| **Тестовый код (Lean LoC)** | 82 595 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 385 деклараций theorem/lemma (ноль sorry/axiom) |
