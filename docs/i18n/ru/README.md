...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.98-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 391 805 строк в 333 файлах |
| **Тестовый код (Lean LoC)** | 79 486 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 054 декларации theorem/lemma (ноль sorry/axiom) |
