...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.109-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 353 568 строк в 327 файлах |
| **Тестовый код (Lean LoC)** | 71 487 строк в 70 тест-сьютах |
| **Доказанные декларации** | 11 817 деклараций theorem/lemma (ноль sorry/axiom) |
