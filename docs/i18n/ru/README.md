...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.86-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 389 153 строки в 332 файлах |
| **Тестовый код (Lean LoC)** | 79 007 строк в 70 тест-сьютах |
| **Доказанные декларации** | 12 967 деклараций theorem/lemma (ноль sorry/axiom) |
