...
| **Продуктовый код (Lean LoC)** | 57 506 строк в 100 файлах |
| **Тестовый код (Lean LoC)** | 7 559 строк в 10 тест-сьютах (test suites) |
| **Доказанные декларации** | 1 756 деклараций theorem/lemma (ноль sorry/axiom) |
| **Целевое оборудование** | Raspberry Pi 5 (BCM2712 / ARM Cortex-A76 / ARMv8-A) |
| **Последний аудит** | [`AUDIT_COMPREHENSIVE_v0.18.7_PRE_BENCHMARK.md`](../../../docs/audits/AUDIT_COMPREHENSIVE_v0.18.7_PRE_BENCHMARK.md) и [`AUDIT_COMPREHENSIVE_v0.18.7_KERNEL_RUST.md`](../../../docs/audits/AUDIT_COMPREHENSIVE_v0.18.7_KERNEL_RUST.md) — двойной всесторонний аудит (115+ находок, 0 критических) |
...
- **WS-S** — Предбенчмаркинговое укрепление (Pre-Benchmark Strengthening): 7 фаз, S1–S7, 83 подзадачи. **ЗАВЕРШЕНО** (v0.19.0–v0.19.6). Охватывает все результаты двойного всестороннего аудита v0.18.7 (115+ находок). План: [`AUDIT_v0.18.7_WORKSTREAM_PLAN.md`](../../../docs/audits/AUDIT_v0.18.7_WORKSTREAM_PLAN.md). Отчёт о завершении: [`WS_S_CLOSURE_REPORT.md`](../../../docs/audits/WS_S_CLOSURE_REPORT.md).
- **WS-R** — Комплексное устранение замечаний аудита (Comprehensive Audit Remediation): 8 фаз, R1–R8, 111 подзадач. **ЗАВЕРШЕНО** (v0.18.0–v0.18.7). План: [`AUDIT_v0.17.14_WORKSTREAM_PLAN.md`](../../../docs/dev_history/audits/AUDIT_v0.17.14_WORKSTREAM_PLAN.md).
- **Привязка к оборудованию Raspberry Pi 5** — обход таблицы страниц ARMv8, маршрутизация прерываний GIC-400, последовательность загрузки (следующий workstream).

Все предшествующие рабочие потоки (WS-B по WS-R) завершены. Предыдущие аудиты
