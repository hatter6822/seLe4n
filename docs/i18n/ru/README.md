...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.179-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 407 460 строк в 338 файлах |
| **Тестовый код (Lean LoC)** | 83 049 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 481 декларация theorem/lemma (ноль sorry/axiom) |
