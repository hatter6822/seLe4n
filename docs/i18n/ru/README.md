...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.78-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 385 487 строк в 331 файле |
| **Тестовый код (Lean LoC)** | 78 725 строк в 70 тест-сьютах |
| **Доказанные декларации** | 12 853 декларации theorem/lemma (ноль sorry/axiom) |
