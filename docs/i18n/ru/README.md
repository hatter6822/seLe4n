...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.94-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 390 824 строки в 333 файлах |
| **Тестовый код (Lean LoC)** | 79 176 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 029 деклараций theorem/lemma (ноль sorry/axiom) |
