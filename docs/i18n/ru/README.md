...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.170-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 404 629 строк в 336 файлах |
| **Тестовый код (Lean LoC)** | 82 811 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 414 деклараций theorem/lemma (ноль sorry/axiom) |
