...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.133-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 396 021 строка в 334 файлах |
| **Тестовый код (Lean LoC)** | 80 339 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 127 деклараций theorem/lemma (ноль sorry/axiom) |
