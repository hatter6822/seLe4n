...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.135-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 360 920 строк в 328 файлах |
| **Тестовый код (Lean LoC)** | 73 943 строки в 70 тест-сьютах |
| **Доказанные декларации** | 12 076 деклараций theorem/lemma (ноль sorry/axiom) |
