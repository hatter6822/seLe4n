...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.88-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 340 168 строк в 317 файлах |
| **Тестовый код (Lean LoC)** | 70 817 строк в 70 тест-сьютах |
| **Доказанные декларации** | 11 316 деклараций theorem/lemma (ноль sorry/axiom) |
