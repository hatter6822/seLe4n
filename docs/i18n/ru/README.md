...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.104-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 351 182 строки в 327 файлах |
| **Тестовый код (Lean LoC)** | 71 319 строк в 70 тест-сьютах |
| **Доказанные декларации** | 11 729 деклараций theorem/lemma (ноль sorry/axiom) |
