...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.191-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 412 643 строки в 339 файлах |
| **Тестовый код (Lean LoC)** | 83 880 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 638 деклараций theorem/lemma (ноль sorry/axiom) |
