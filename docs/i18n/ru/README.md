...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.109-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 394 244 строки в 333 файлах |
| **Тестовый код (Lean LoC)** | 80 133 строки в 70 тест-сьютах |
| **Доказанные декларации** | 13 097 деклараций theorem/lemma (ноль sorry/axiom) |
