...
| **Продуктовый код (Lean LoC)** | 55 499 строк в 98 файлах |
| **Тестовый код (Lean LoC)** | 7 309 строк в 10 тест-сьютах (test suites) |
| **Доказанные декларации** | 1 686 деклараций theorem/lemma (ноль sorry/axiom) |
| **Целевое оборудование** | Raspberry Pi 5 (BCM2712 / ARM Cortex-A76 / ARMv8-A) |
| **Последний аудит** | [`AUDIT_COMPREHENSIVE_v0.17.13_PRE_RELEASE.md`](../../../docs/audits/AUDIT_COMPREHENSIVE_v0.17.13_PRE_RELEASE.md) — полный аудит ядра и Rust-кодовой базы перед релизом |
...
- **WS-R** — Комплексное устранение замечаний аудита (Comprehensive Audit Remediation): 8 фаз, R1–R8, 111 подзадач. Охватывает все 82 замечания из [`AUDIT_COMPREHENSIVE_v0.17.13_PRE_RELEASE.md`](../../../docs/audits/AUDIT_COMPREHENSIVE_v0.17.13_PRE_RELEASE.md). R1–R7 завершены (v0.18.0–v0.18.6), R8 в ожидании.
