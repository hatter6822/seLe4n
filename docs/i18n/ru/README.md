...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.137-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 361 351 строка в 328 файлах |
| **Тестовый код (Lean LoC)** | 74 073 строки в 70 тест-сьютах |
| **Доказанные декларации** | 12 089 деклараций theorem/lemma (ноль sorry/axiom) |
