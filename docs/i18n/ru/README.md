...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.164-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 401 833 строки в 334 файлах |
| **Тестовый код (Lean LoC)** | 82 175 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 302 декларации theorem/lemma (ноль sorry/axiom) |
