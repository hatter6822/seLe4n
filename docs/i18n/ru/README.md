...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.15-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 375 663 строки в 329 файлах |
| **Тестовый код (Lean LoC)** | 75 996 строк в 70 тест-сьютах |
