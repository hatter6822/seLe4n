...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.182-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 408 352 строки в 338 файлах |
| **Тестовый код (Lean LoC)** | 83 391 строка в 70 тест-сьютах |
| **Доказанные декларации** | 13 510 деклараций theorem/lemma (ноль sorry/axiom) |
