...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.171-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 404 987 строк в 336 файлах |
| **Тестовый код (Lean LoC)** | 82 900 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 424 декларации theorem/lemma (ноль sorry/axiom) |
