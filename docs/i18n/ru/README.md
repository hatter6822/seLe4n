...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.90-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 342 776 строк в 323 файлах |
| **Тестовый код (Lean LoC)** | 71 065 строк в 70 тест-сьютах |
| **Доказанные декларации** | 11 427 деклараций theorem/lemma (ноль sorry/axiom) |
