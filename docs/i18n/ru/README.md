...
| **Продуктовый код (Lean LoC)** | 420 033 строки в 342 файлах |
| **Тестовый код (Lean LoC)** | 85 359 строк в 71 тест-сьюте |
| **Доказанные декларации** | 13 905 деклараций theorem/lemma (ноль sorry/axiom) |
