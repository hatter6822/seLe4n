...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.105-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 392 459 строк в 333 файлах |
| **Тестовый код (Lean LoC)** | 79 904 строки в 70 тест-сьютах |
