...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.113-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 394 808 строк в 333 файлах |
| **Тестовый код (Lean LoC)** | 80 213 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 115 деклараций theorem/lemma (ноль sorry/axiom) |
