...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.91-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 389 944 строки в 333 файлах |
| **Тестовый код (Lean LoC)** | 79 141 строка в 70 тест-сьютах |
| **Доказанные декларации** | 12 989 деклараций theorem/lemma (ноль sorry/axiom) |
