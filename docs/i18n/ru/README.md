...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.189-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 410 884 строки в 338 файлах |
| **Тестовый код (Lean LoC)** | 83 710 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 591 декларация theorem/lemma (ноль sorry/axiom) |
