...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.169-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 404 112 строк в 336 файлах |
| **Тестовый код (Lean LoC)** | 82 662 строки в 70 тест-сьютах |
| **Доказанные декларации** | 13 396 деклараций theorem/lemma (ноль sorry/axiom) |
