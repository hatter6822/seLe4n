...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.176-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 406 451 строка в 338 файлах |
| **Тестовый код (Lean LoC)** | 83 005 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 455 деклараций theorem/lemma (ноль sorry/axiom) |
