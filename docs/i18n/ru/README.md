...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.112-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 354 786 строк в 328 файлах |
| **Тестовый код (Lean LoC)** | 71 694 строки в 70 тест-сьютах |
| **Доказанные декларации** | 11 875 деклараций theorem/lemma (ноль sorry/axiom) |
