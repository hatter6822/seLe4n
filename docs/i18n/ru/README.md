...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.36.3-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 421 705 строк в 343 файлах |
| **Тестовый код (Lean LoC)** | 85 663 строки в 71 тест-сьюте |
| **Доказанные декларации** | 13 993 декларации theorem/lemma (ноль sorry/axiom) |
