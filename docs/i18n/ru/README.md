...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.85-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 339 431 строка в 317 файлах |
| **Тестовый код (Lean LoC)** | 70 566 строк в 70 тест-сьютах |
| **Доказанные декларации** | 11 287 деклараций theorem/lemma (ноль sorry/axiom) |
