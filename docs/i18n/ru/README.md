...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.126-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 357 374 строки в 328 файлах |
| **Тестовый код (Lean LoC)** | 73 216 строк в 70 тест-сьютах |
| **Доказанные декларации** | 11 989 деклараций theorem/lemma (ноль sorry/axiom) |
