...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.115-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 355 237 строк в 328 файлах |
| **Тестовый код (Lean LoC)** | 72 114 строк в 70 тест-сьютах |
| **Доказанные декларации** | 11 886 деклараций theorem/lemma (ноль sorry/axiom) |
