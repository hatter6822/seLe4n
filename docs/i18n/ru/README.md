...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.11-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 375 100 строк в 329 файлах |
| **Тестовый код (Lean LoC)** | 75 860 строк в 70 тест-сьютах |
| **Доказанные декларации** | 12 605 деклараций theorem/lemma (ноль sorry/axiom) |
