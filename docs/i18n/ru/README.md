...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.145-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 362 103 строки в 328 файлах |
| **Тестовый код (Lean LoC)** | 74 275 строк в 70 тест-сьютах |
| **Доказанные декларации** | 12 106 деклараций theorem/lemma (ноль sorry/axiom) |
