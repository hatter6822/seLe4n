...
| **Продуктовый код (Lean LoC)** | 420 374 строки в 343 файлах |
| **Тестовый код (Lean LoC)** | 85 416 строк в 71 тест-сьюте |
| **Доказанные декларации** | 13 916 деклараций theorem/lemma (ноль sorry/axiom) |
