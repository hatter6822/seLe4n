...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.106-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 393 612 строк в 333 файлах |
| **Тестовый код (Lean LoC)** | 79 985 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 082 декларации theorem/lemma (ноль sorry/axiom) |
