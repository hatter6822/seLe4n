...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.174-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 405 953 строки в 338 файлах |
| **Тестовый код (Lean LoC)** | 83 005 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 442 декларации theorem/lemma (ноль sorry/axiom) |
