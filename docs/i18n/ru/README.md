...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.57-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 384 812 строк в 330 файлах |
| **Тестовый код (Lean LoC)** | 78 352 строки в 70 тест-сьютах |
| **Доказанные декларации** | 12 802 декларации theorem/lemma (ноль sorry/axiom) |
