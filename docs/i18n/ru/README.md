...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.202-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 417 409 строк в 340 файлах |
| **Тестовый код (Lean LoC)** | 84 545 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 810 деклараций theorem/lemma (ноль sorry/axiom) |
