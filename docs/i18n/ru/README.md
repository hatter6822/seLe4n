...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.142-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 396 419 строк в 334 файлах |
| **Тестовый код (Lean LoC)** | 80 680 строк в 70 тест-сьютах |
