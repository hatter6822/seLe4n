...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.46-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 381 844 строки в 330 файлах |
| **Тестовый код (Lean LoC)** | 77 346 строк в 70 тест-сьютах |
| **Доказанные декларации** | 12 733 декларации theorem/lemma (ноль sorry/axiom) |
