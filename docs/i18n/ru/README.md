...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.104-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 392 382 строки в 333 файлах |
| **Тестовый код (Lean LoC)** | 79 773 строки в 70 тест-сьютах |
| **Доказанные декларации** | 13 063 декларации theorem/lemma (ноль sorry/axiom) |
