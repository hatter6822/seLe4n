...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.36.2-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 420 258 строк в 343 файлах |
| **Тестовый код (Lean LoC)** | 85 402 строки в 71 тест-сьюте |
| **Доказанные декларации** | 13 914 деклараций theorem/lemma (ноль sorry/axiom) |
