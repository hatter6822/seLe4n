...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.178-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 407 096 строк в 338 файлах |
| **Тестовый код (Lean LoC)** | 83 035 строк в 70 тест-сьютах |
| **Доказанные декларации** | 13 473 декларации theorem/lemma (ноль sorry/axiom) |
