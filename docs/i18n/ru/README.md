...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.36.4-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 422 300 строк в 343 файлах |
| **Тестовый код (Lean LoC)** | 85 915 строк в 71 тест-сьюте |
| **Доказанные декларации** | 14 011 деклараций theorem/lemma (ноль sorry/axiom) |
