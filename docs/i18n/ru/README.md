...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.9-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 374 875 строк в 329 файлах |
| **Тестовый код (Lean LoC)** | 75 847 строк в 70 тест-сьютах |
