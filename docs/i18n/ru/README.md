...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.39-blue" alt="Версия" />
...
| **Продуктовый код (Lean LoC)** | 380 359 строк в 330 файлах |
| **Тестовый код (Lean LoC)** | 77 138 строк в 70 тест-сьютах |
