...
| **LoC Lean de production** | 384 812 réparties sur 330 fichiers |
| **LoC Lean de test** | 78 352 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 802 déclarations theorem/lemma (zéro sorry/axiom) |
