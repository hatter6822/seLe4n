...
| **LoC Lean de production** | 413 406 réparties sur 339 fichiers |
| **LoC Lean de test** | 84 248 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 654 déclarations theorem/lemma (zéro sorry/axiom) |
