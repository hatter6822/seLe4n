...
| **LoC Lean de production** | 361 406 réparties sur 328 fichiers |
| **LoC Lean de test** | 74 100 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 090 déclarations theorem/lemma (zéro sorry/axiom) |
