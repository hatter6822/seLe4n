...
| **LoC Lean de production** | 364 378 réparties sur 328 fichiers |
| **LoC Lean de test** | 74 602 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 164 déclarations theorem/lemma (zéro sorry/axiom) |
