...
| **LoC Lean de production** | 397 042 réparties sur 334 fichiers |
| **LoC Lean de test** | 81 232 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 131 déclarations theorem/lemma (zéro sorry/axiom) |
