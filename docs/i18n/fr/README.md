...
| **LoC Lean de production** | 389 153 réparties sur 332 fichiers |
| **LoC Lean de test** | 79 007 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 967 déclarations theorem/lemma (zéro sorry/axiom) |
