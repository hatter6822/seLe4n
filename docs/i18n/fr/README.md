...
| **LoC Lean de production** | 341 796 réparties sur 321 fichiers |
| **LoC Lean de test** | 70 927 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 393 déclarations theorem/lemma (zéro sorry/axiom) |
