...
| **LoC Lean de production** | 387 402 réparties sur 331 fichiers |
| **LoC Lean de test** | 78 892 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 917 déclarations theorem/lemma (zéro sorry/axiom) |
