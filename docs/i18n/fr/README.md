...
| **LoC Lean de production** | 357 374 réparties sur 328 fichiers |
| **LoC Lean de test** | 73 216 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 989 déclarations theorem/lemma (zéro sorry/axiom) |
