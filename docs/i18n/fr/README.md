...
| **LoC Lean de production** | 376 395 réparties sur 330 fichiers |
| **LoC Lean de test** | 76 029 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 607 déclarations theorem/lemma (zéro sorry/axiom) |
