...
| **LoC Lean de production** | 354 786 réparties sur 328 fichiers |
| **LoC Lean de test** | 71 694 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 875 déclarations theorem/lemma (zéro sorry/axiom) |
