...
| **LoC Lean de production** | 380 420 réparties sur 330 fichiers |
| **LoC Lean de test** | 77 140 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 704 déclarations theorem/lemma (zéro sorry/axiom) |
