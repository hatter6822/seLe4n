...
| **LoC Lean de production** | 396 888 réparties sur 334 fichiers |
| **LoC Lean de test** | 81 087 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 137 déclarations theorem/lemma (zéro sorry/axiom) |
