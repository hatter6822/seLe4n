...
| **LoC Lean de production** | 355 159 réparties sur 328 fichiers |
| **LoC Lean de test** | 71 970 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 886 déclarations theorem/lemma (zéro sorry/axiom) |
