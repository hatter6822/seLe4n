...
| **LoC Lean de production** | 344 934 réparties sur 324 fichiers |
| **LoC Lean de test** | 71 128 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 490 déclarations theorem/lemma (zéro sorry/axiom) |
