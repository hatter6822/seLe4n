...
| **LoC Lean de production** | 355 474 réparties sur 328 fichiers |
| **LoC Lean de test** | 72 433 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 887 déclarations theorem/lemma (zéro sorry/axiom) |
