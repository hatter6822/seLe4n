...
| **LoC Lean de production** | 390 600 réparties sur 333 fichiers |
| **LoC Lean de test** | 79 157 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 014 déclarations theorem/lemma (zéro sorry/axiom) |
