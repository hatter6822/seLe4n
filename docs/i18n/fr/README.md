...
| **LoC Lean de production** | 378 887 réparties sur 330 fichiers |
| **LoC Lean de test** | 76 620 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 676 déclarations theorem/lemma (zéro sorry/axiom) |
