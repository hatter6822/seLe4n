...
| **LoC Lean de production** | 382 025 réparties sur 330 fichiers |
| **LoC Lean de test** | 77 280 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 741 déclarations theorem/lemma (zéro sorry/axiom) |
