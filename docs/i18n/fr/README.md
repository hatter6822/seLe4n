...
| **LoC Lean de production** | 339 431 réparties sur 317 fichiers |
| **LoC Lean de test** | 70 566 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 287 déclarations theorem/lemma (zéro sorry/axiom) |
