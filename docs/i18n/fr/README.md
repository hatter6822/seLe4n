...
| **LoC Lean de production** | 381 844 réparties sur 330 fichiers |
| **LoC Lean de test** | 77 346 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 733 déclarations theorem/lemma (zéro sorry/axiom) |
