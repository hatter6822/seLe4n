...
| **LoC Lean de production** | 420 101 réparties sur 343 fichiers |
| **LoC Lean de test** | 85 359 réparties sur 71 suites de tests |
| **Déclarations prouvées** | 13 906 déclarations theorem/lemma (zéro sorry/axiom) |
