...
| **LoC Lean de production** | 410 383 réparties sur 338 fichiers |
| **LoC Lean de test** | 83 589 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 573 déclarations theorem/lemma (zéro sorry/axiom) |
