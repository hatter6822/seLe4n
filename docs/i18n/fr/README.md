...
| **LoC Lean de production** | 393 612 réparties sur 333 fichiers |
| **LoC Lean de test** | 79 985 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 082 déclarations theorem/lemma (zéro sorry/axiom) |
