...
| **LoC Lean de production** | 383 733 réparties sur 330 fichiers |
| **LoC Lean de test** | 78 086 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 769 déclarations theorem/lemma (zéro sorry/axiom) |
