...
| **LoC Lean de production** | 420 527 réparties sur 343 fichiers |
| **LoC Lean de test** | 85 428 réparties sur 71 suites de tests |
| **Déclarations prouvées** | 13 922 déclarations theorem/lemma (zéro sorry/axiom) |
