...
| **LoC Lean de production** | 369 809 réparties sur 328 fichiers |
| **LoC Lean de test** | 75 158 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 402 déclarations theorem/lemma (zéro sorry/axiom) |
