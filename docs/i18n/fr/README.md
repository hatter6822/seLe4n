...
| **LoC Lean de production** | 385 041 réparties sur 330 fichiers |
| **LoC Lean de test** | 78 456 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 816 déclarations theorem/lemma (zéro sorry/axiom) |
