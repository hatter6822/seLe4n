...
| **LoC Lean de production** | 394 995 réparties sur 334 fichiers |
| **LoC Lean de test** | 80 213 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 116 déclarations theorem/lemma (zéro sorry/axiom) |
