...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.31.169-blue" alt="Version" />
...
| **Audit canonique** | [`AUDIT_v0.29.0_COMPREHENSIVE`](../../../docs/dev_history/audits/AUDIT_v0.29.0_COMPREHENSIVE.md) — audit complet pré-1.0 (202 résultats ; corrigés par WS-AK AK1–AK10) |
| **Dernier audit** | [`AUDIT_v0.30.6_COMPREHENSIVE`](../../../docs/dev_history/audits/AUDIT_v0.30.6_COMPREHENSIVE.md) — audit de durcissement pré-1.0 (3 CRIT, 24 HIGH, 71 MED, 58 LOW, 40 INFO — notation initiale selon §0.4) |
