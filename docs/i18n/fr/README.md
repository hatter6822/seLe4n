...
| **LoC Lean de production** | 392 173 réparties sur 333 fichiers |
| **LoC Lean de test** | 79 773 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 058 déclarations theorem/lemma (zéro sorry/axiom) |
