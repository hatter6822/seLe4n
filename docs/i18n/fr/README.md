...
| **LoC Lean de production** | 391 805 réparties sur 333 fichiers |
| **LoC Lean de test** | 79 486 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 054 déclarations theorem/lemma (zéro sorry/axiom) |
