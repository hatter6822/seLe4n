...
| **LoC Lean de production** | 339 955 réparties sur 317 fichiers |
| **LoC Lean de test** | 70 722 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 305 déclarations theorem/lemma (zéro sorry/axiom) |
