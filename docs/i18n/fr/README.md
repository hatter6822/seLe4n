...
| **LoC Lean de production** | 352 854 réparties sur 327 fichiers |
| **LoC Lean de test** | 71 412 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 788 déclarations theorem/lemma (zéro sorry/axiom) |
