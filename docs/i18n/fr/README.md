...
| **LoC Lean de production** | 397 589 réparties sur 334 fichiers |
| **LoC Lean de test** | 81 318 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 152 déclarations theorem/lemma (zéro sorry/axiom) |
