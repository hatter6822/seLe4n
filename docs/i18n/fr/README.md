...
| **LoC Lean de production** | 351 182 réparties sur 327 fichiers |
| **LoC Lean de test** | 71 319 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 729 déclarations theorem/lemma (zéro sorry/axiom) |
