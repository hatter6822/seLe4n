...
| **LoC Lean de production** | 404 629 réparties sur 336 fichiers |
| **LoC Lean de test** | 82 811 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 414 déclarations theorem/lemma (zéro sorry/axiom) |
