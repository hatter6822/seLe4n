...
| **LoC Lean de production** | 404 987 réparties sur 336 fichiers |
| **LoC Lean de test** | 82 900 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 424 déclarations theorem/lemma (zéro sorry/axiom) |
