...
| **LoC Lean de production** | 385 300 réparties sur 330 fichiers |
| **LoC Lean de test** | 78 723 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 804 déclarations theorem/lemma (zéro sorry/axiom) |
