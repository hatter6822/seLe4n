...
| **LoC Lean de production** | 377 396 réparties sur 330 fichiers |
| **LoC Lean de test** | 76 463 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 626 déclarations theorem/lemma (zéro sorry/axiom) |
