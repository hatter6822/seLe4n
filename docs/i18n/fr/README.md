...
| **LoC Lean de production** | 353 568 réparties sur 327 fichiers |
| **LoC Lean de test** | 71 487 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 817 déclarations theorem/lemma (zéro sorry/axiom) |
