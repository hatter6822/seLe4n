...
| **LoC Lean de production** | 357 749 réparties sur 328 fichiers |
| **LoC Lean de test** | 73 315 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 997 déclarations theorem/lemma (zéro sorry/axiom) |
