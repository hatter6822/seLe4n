...
| **LoC Lean de production** | 417 407 réparties sur 340 fichiers |
| **LoC Lean de test** | 84 545 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 810 déclarations theorem/lemma (zéro sorry/axiom) |
