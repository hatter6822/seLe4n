...
| **LoC Lean de production** | 394 244 réparties sur 333 fichiers |
| **LoC Lean de test** | 80 133 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 097 déclarations theorem/lemma (zéro sorry/axiom) |
