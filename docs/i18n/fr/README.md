...
| **LoC Lean de production** | 386 776 réparties sur 331 fichiers |
| **LoC Lean de test** | 78 841 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 902 déclarations theorem/lemma (zéro sorry/axiom) |
