...
| **LoC Lean de production** | 422 300 réparties sur 343 fichiers |
| **LoC Lean de test** | 85 915 réparties sur 71 suites de tests |
| **Déclarations prouvées** | 14 011 déclarations theorem/lemma (zéro sorry/axiom) |
