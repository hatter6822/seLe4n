...
| **LoC Lean de production** | 361 146 réparties sur 328 fichiers |
| **LoC Lean de test** | 74 027 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 084 déclarations theorem/lemma (zéro sorry/axiom) |
