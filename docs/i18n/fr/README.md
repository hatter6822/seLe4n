...
| **LoC Lean de production** | 377 186 réparties sur 330 fichiers |
| **LoC Lean de test** | 76 360 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 621 déclarations theorem/lemma (zéro sorry/axiom) |
