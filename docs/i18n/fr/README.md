...
| **LoC Lean de production** | 423 001 réparties sur 343 fichiers |
| **LoC Lean de test** | 86 115 réparties sur 71 suites de tests |
| **Déclarations prouvées** | 14 028 déclarations theorem/lemma (zéro sorry/axiom) |
