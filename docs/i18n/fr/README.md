...
| **LoC Lean de production** | 343 521 réparties sur 323 fichiers |
| **LoC Lean de test** | 71 084 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 444 déclarations theorem/lemma (zéro sorry/axiom) |
