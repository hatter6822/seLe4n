...
| **LoC Lean de production** | 352 080 réparties sur 327 fichiers |
| **LoC Lean de test** | 71 347 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 754 déclarations theorem/lemma (zéro sorry/axiom) |
