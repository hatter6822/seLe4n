...
| **LoC Lean de production** | 391 919 réparties sur 333 fichiers |
| **LoC Lean de test** | 79 621 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 056 déclarations theorem/lemma (zéro sorry/axiom) |
