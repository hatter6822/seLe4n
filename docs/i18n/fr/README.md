...
| **LoC Lean de production** | 347 188 réparties sur 325 fichiers |
| **LoC Lean de test** | 71 244 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 567 déclarations theorem/lemma (zéro sorry/axiom) |
