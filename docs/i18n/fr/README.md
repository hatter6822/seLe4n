...
| **LoC Lean de production** | 385 804 réparties sur 330 fichiers |
| **LoC Lean de test** | 78 722 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 867 déclarations theorem/lemma (zéro sorry/axiom) |
