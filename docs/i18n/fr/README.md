...
| **LoC Lean de production** | 360 710 réparties sur 328 fichiers |
| **LoC Lean de test** | 73 857 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 070 déclarations theorem/lemma (zéro sorry/axiom) |
