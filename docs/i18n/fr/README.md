...
| **LoC Lean de production** | 382 430 réparties sur 330 fichiers |
| **LoC Lean de test** | 77 749 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 742 déclarations theorem/lemma (zéro sorry/axiom) |
