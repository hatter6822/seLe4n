...
| **LoC Lean de production** | 389 944 réparties sur 333 fichiers |
| **LoC Lean de test** | 79 141 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 989 déclarations theorem/lemma (zéro sorry/axiom) |
