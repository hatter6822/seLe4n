...
| **LoC Lean de production** | 362 001 réparties sur 328 fichiers |
| **LoC Lean de test** | 74 275 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 106 déclarations theorem/lemma (zéro sorry/axiom) |
