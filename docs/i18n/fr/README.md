...
| **LoC Lean de production** | 417 612 réparties sur 340 fichiers |
| **LoC Lean de test** | 84 644 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 813 déclarations theorem/lemma (zéro sorry/axiom) |
