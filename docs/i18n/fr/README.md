...
| **LoC Lean de production** | 407 635 réparties sur 338 fichiers |
| **LoC Lean de test** | 83 095 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 486 déclarations theorem/lemma (zéro sorry/axiom) |
