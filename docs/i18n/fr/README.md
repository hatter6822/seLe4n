...
| **LoC Lean de production** | 383 641 réparties sur 330 fichiers |
| **LoC Lean de test** | 77 948 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 767 déclarations theorem/lemma (zéro sorry/axiom) |
