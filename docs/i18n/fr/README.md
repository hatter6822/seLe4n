...
| **LoC Lean de production** | 378 753 réparties sur 330 fichiers |
| **LoC Lean de test** | 76 540 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 671 déclarations theorem/lemma (zéro sorry/axiom) |
