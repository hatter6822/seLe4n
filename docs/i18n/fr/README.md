...
| **LoC Lean de production** | 349 806 réparties sur 327 fichiers |
| **LoC Lean de test** | 71 289 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 680 déclarations theorem/lemma (zéro sorry/axiom) |
