...
| **LoC Lean de production** | 385 487 réparties sur 331 fichiers |
| **LoC Lean de test** | 78 725 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 853 déclarations theorem/lemma (zéro sorry/axiom) |
