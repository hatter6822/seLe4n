...
| **LoC Lean de production** | 356 971 réparties sur 328 fichiers |
| **LoC Lean de test** | 73 043 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 935 déclarations theorem/lemma (zéro sorry/axiom) |
