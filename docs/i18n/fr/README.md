...
| **LoC Lean de production** | 410 884 réparties sur 338 fichiers |
| **LoC Lean de test** | 83 710 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 591 déclarations theorem/lemma (zéro sorry/axiom) |
