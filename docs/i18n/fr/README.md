...
| **LoC Lean de production** | 375 663 réparties sur 329 fichiers |
| **LoC Lean de test** | 75 996 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 606 déclarations theorem/lemma (zéro sorry/axiom) |
