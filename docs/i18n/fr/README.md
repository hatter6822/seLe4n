...
| **LoC Lean de production** | 403 754 réparties sur 336 fichiers |
| **LoC Lean de test** | 82 595 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 385 déclarations theorem/lemma (zéro sorry/axiom) |
