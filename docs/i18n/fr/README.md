...
| **LoC Lean de production** | 404 112 réparties sur 336 fichiers |
| **LoC Lean de test** | 82 662 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 396 déclarations theorem/lemma (zéro sorry/axiom) |
