...
| **LoC Lean de production** | 396 365 réparties sur 334 fichiers |
| **LoC Lean de test** | 80 607 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 128 déclarations theorem/lemma (zéro sorry/axiom) |
