...
| **LoC Lean de production** | 343 801 réparties sur 323 fichiers |
| **LoC Lean de test** | 71 095 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 449 déclarations theorem/lemma (zéro sorry/axiom) |
