...
| **LoC Lean de production** | 346 230 réparties sur 324 fichiers |
| **LoC Lean de test** | 71 194 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 529 déclarations theorem/lemma (zéro sorry/axiom) |
