...
| **LoC Lean de production** | 375 100 réparties sur 329 fichiers |
| **LoC Lean de test** | 75 860 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 605 déclarations theorem/lemma (zéro sorry/axiom) |
