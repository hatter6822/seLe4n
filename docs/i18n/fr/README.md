...
| **LoC Lean de production** | 399 995 réparties sur 334 fichiers |
| **LoC Lean de test** | 81 812 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 242 déclarations theorem/lemma (zéro sorry/axiom) |
