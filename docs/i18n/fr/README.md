...
| **LoC Lean de production** | 412 643 réparties sur 339 fichiers |
| **LoC Lean de test** | 83 880 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 638 déclarations theorem/lemma (zéro sorry/axiom) |
