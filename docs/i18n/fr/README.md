...
| **LoC Lean de production** | 359 936 réparties sur 328 fichiers |
| **LoC Lean de test** | 73 737 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 054 déclarations theorem/lemma (zéro sorry/axiom) |
