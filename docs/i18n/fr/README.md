...
| **LoC Lean de production** | 364 812 réparties sur 328 fichiers |
| **LoC Lean de test** | 74 909 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 185 déclarations theorem/lemma (zéro sorry/axiom) |
