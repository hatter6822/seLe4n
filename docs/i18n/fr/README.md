...
| **LoC Lean de production** | 380 540 réparties sur 330 fichiers |
| **LoC Lean de test** | 77 224 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 706 déclarations theorem/lemma (zéro sorry/axiom) |
