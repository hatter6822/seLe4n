...
| **LoC Lean de production** | 360 920 réparties sur 328 fichiers |
| **LoC Lean de test** | 73 943 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 076 déclarations theorem/lemma (zéro sorry/axiom) |
