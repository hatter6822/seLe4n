...
| **LoC Lean de production** | 408 061 réparties sur 338 fichiers |
| **LoC Lean de test** | 83 207 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 504 déclarations theorem/lemma (zéro sorry/axiom) |
