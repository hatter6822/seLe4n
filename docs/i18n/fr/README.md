...
| **LoC Lean de production** | 406 667 réparties sur 338 fichiers |
| **LoC Lean de test** | 83 019 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 463 déclarations theorem/lemma (zéro sorry/axiom) |
