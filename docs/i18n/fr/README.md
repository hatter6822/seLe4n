...
| **LoC Lean de production** | 423 960 réparties sur 344 fichiers |
| **LoC Lean de test** | 86 280 réparties sur 71 suites de tests |
| **Déclarations prouvées** | 14 056 déclarations theorem/lemma (zéro sorry/axiom) |
