...
| **LoC Lean de production** | 376 503 réparties sur 330 fichiers |
| **LoC Lean de test** | 76 048 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 610 déclarations theorem/lemma (zéro sorry/axiom) |
