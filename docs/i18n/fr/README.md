...
| **LoC Lean de production** | 421 705 réparties sur 343 fichiers |
| **LoC Lean de test** | 85 663 réparties sur 71 suites de tests |
| **Déclarations prouvées** | 13 993 déclarations theorem/lemma (zéro sorry/axiom) |
