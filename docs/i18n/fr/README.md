...
| **LoC Lean de production** | 354 553 réparties sur 328 fichiers |
| **LoC Lean de test** | 71 633 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 868 déclarations theorem/lemma (zéro sorry/axiom) |
