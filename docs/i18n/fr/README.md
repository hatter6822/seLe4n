...
| **LoC Lean de production** | 407 460 réparties sur 338 fichiers |
| **LoC Lean de test** | 83 049 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 481 déclarations theorem/lemma (zéro sorry/axiom) |
