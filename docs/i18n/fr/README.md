...
| **LoC Lean de production** | 361 351 réparties sur 328 fichiers |
| **LoC Lean de test** | 74 073 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 089 déclarations theorem/lemma (zéro sorry/axiom) |
