...
| **LoC Lean de production** | 391 466 réparties sur 333 fichiers |
| **LoC Lean de test** | 79 392 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 046 déclarations theorem/lemma (zéro sorry/axiom) |
