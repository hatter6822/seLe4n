...
| **LoC Lean de production** | 360 465 réparties sur 328 fichiers |
| **LoC Lean de test** | 73 833 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 064 déclarations theorem/lemma (zéro sorry/axiom) |
