...
| **LoC Lean de production** | 419 011 réparties sur 342 fichiers |
| **LoC Lean de test** | 85 328 réparties sur 71 suites de tests |
| **Déclarations prouvées** | 13 871 déclarations theorem/lemma (zéro sorry/axiom) |
