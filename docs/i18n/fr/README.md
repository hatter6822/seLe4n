...
| **LoC Lean de production** | 396 021 réparties sur 334 fichiers |
| **LoC Lean de test** | 80 339 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 127 déclarations theorem/lemma (zéro sorry/axiom) |
