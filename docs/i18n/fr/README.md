...
| **LoC Lean de production** | 396 157 réparties sur 334 fichiers |
| **LoC Lean de test** | 80 490 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 126 déclarations theorem/lemma (zéro sorry/axiom) |
