...
| **LoC Lean de production** | 382 916 réparties sur 330 fichiers |
| **LoC Lean de test** | 77 855 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 754 déclarations theorem/lemma (zéro sorry/axiom) |
