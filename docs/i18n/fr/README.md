...
| **LoC Lean de production** | 406 451 réparties sur 338 fichiers |
| **LoC Lean de test** | 83 005 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 455 déclarations theorem/lemma (zéro sorry/axiom) |
