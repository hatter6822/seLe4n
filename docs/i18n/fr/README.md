...
| **LoC Lean de production** | 401 319 réparties sur 334 fichiers |
| **LoC Lean de test** | 81 967 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 282 déclarations theorem/lemma (zéro sorry/axiom) |
