...
| **LoC Lean de production** | 385 223 réparties sur 330 fichiers |
| **LoC Lean de test** | 78 645 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 821 déclarations theorem/lemma (zéro sorry/axiom) |
