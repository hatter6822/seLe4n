...
| **LoC Lean de production** | 340 168 réparties sur 317 fichiers |
| **LoC Lean de test** | 70 817 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 316 déclarations theorem/lemma (zéro sorry/axiom) |
