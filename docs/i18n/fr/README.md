...
| **LoC Lean de production** | 414 657 réparties sur 339 fichiers |
| **LoC Lean de test** | 84 404 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 702 déclarations theorem/lemma (zéro sorry/axiom) |
