...
| **LoC Lean de production** | 402 324 réparties sur 334 fichiers |
| **LoC Lean de test** | 82 280 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 333 déclarations theorem/lemma (zéro sorry/axiom) |
