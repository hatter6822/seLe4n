...
| **LoC Lean de production** | 355 606 réparties sur 328 fichiers |
| **LoC Lean de test** | 72 488 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 889 déclarations theorem/lemma (zéro sorry/axiom) |
