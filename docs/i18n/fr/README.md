...
| **LoC Lean de production** | 342 776 réparties sur 323 fichiers |
| **LoC Lean de test** | 71 065 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 11 427 déclarations theorem/lemma (zéro sorry/axiom) |
