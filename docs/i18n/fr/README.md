...
| **LoC Lean de production** | 403 351 réparties sur 336 fichiers |
| **LoC Lean de test** | 82 491 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 368 déclarations theorem/lemma (zéro sorry/axiom) |
