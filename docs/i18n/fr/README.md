...
| **LoC Lean de production** | 370 721 réparties sur 328 fichiers |
| **LoC Lean de test** | 75 430 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 428 déclarations theorem/lemma (zéro sorry/axiom) |
