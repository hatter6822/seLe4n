...
| **LoC Lean de production** | 413 049 réparties sur 339 fichiers |
| **LoC Lean de test** | 84 109 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 648 déclarations theorem/lemma (zéro sorry/axiom) |
