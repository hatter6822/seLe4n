...
| **LoC Lean de production** | 401 833 réparties sur 334 fichiers |
| **LoC Lean de test** | 82 175 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 302 déclarations theorem/lemma (zéro sorry/axiom) |
