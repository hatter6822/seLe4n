...
| **LoC Lean de production** | 407 096 réparties sur 338 fichiers |
| **LoC Lean de test** | 83 035 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 473 déclarations theorem/lemma (zéro sorry/axiom) |
