...
| **LoC Lean de production** | 385 998 réparties sur 330 fichiers |
| **LoC Lean de test** | 78 763 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 876 déclarations theorem/lemma (zéro sorry/axiom) |
