...
| **LoC Lean de production** | 379 856 réparties sur 330 fichiers |
| **LoC Lean de test** | 76 925 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 693 déclarations theorem/lemma (zéro sorry/axiom) |
