...
| **LoC Lean de production** | 391 269 réparties sur 333 fichiers |
| **LoC Lean de test** | 79 176 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 043 déclarations theorem/lemma (zéro sorry/axiom) |
