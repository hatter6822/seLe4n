...
| **LoC Lean de production** | 383 951 réparties sur 330 fichiers |
| **LoC Lean de test** | 78 257 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 771 déclarations theorem/lemma (zéro sorry/axiom) |
