...
| **LoC Lean de production** | 381 980 réparties sur 330 fichiers |
| **LoC Lean de test** | 77 688 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 734 déclarations theorem/lemma (zéro sorry/axiom) |
