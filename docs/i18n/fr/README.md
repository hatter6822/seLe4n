...
| **LoC Lean de production** | 410 148 réparties sur 338 fichiers |
| **LoC Lean de test** | 83 492 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 560 déclarations theorem/lemma (zéro sorry/axiom) |
