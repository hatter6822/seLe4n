...
| **LoC Lean de production** | 389 122 réparties sur 332 fichiers |
| **LoC Lean de test** | 79 009 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 12 977 déclarations theorem/lemma (zéro sorry/axiom) |
