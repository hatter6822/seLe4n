...
| **LoC Lean de production** | 399 198 réparties sur 334 fichiers |
| **LoC Lean de test** | 81 487 réparties sur 70 suites de tests |
| **Déclarations prouvées** | 13 210 déclarations theorem/lemma (zéro sorry/axiom) |
