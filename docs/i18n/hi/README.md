...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.36.2-blue" alt="संस्करण" />
...
🌐 [English](../../../README.md) | [简体中文](../zh-CN/README.md) | [Español](../es/README.md) | [日本語](../ja/README.md) | [한국어](../ko/README.md) | [العربية](../ar/README.md) | [Français](../fr/README.md) | [Português](../pt-BR/README.md) | [Русский](../ru/README.md) | [Deutsch](../de/README.md) | **हिन्दी** | [Українська](../uk/README.md)
...
- **प्राथमिकता वंशानुक्रम प्रोटोकॉल (Priority Inheritance Protocol)** — मशीन-जाँचित गतिरोध स्वतंत्रता (`blockingAcyclic`) और सीमित श्रृंखला गहराई के साथ सकर्मक प्राथमिकता प्रसारण। असीमित प्राथमिकता व्युत्क्रम को रोकता है
- **परिबद्ध विलंबता प्रमेय (Bounded latency theorem)** — मशीन-जाँचित WCRT सीमा: `WCRT = D × L_max + N × (B + P)`, बजट एकदिशता, पुनःपूर्ति समय, यील्ड शब्दार्थ, बैंड थकावट, और डोमेन चक्रण को कवर करने वाले 8 सजीवता मॉड्यूल में प्रमाणित
...
| **संस्करण** | `0.36.2` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 343 फ़ाइलों में 420,527 |
| **परीक्षण Lean LoC** | 71 परीक्षण सुइट्स में 85,428 |
| **प्रमाणित घोषणाएँ** | 13,922 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
