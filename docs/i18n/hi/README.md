...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.109-blue" alt="संस्करण" />
...
| **संस्करण** | `0.34.109` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 327 फ़ाइलों में 353,568 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 71,487 |
| **प्रमाणित घोषणाएँ** | 11,817 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
