...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.48-blue" alt="संस्करण" />
...
| **संस्करण** | `0.35.48` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 330 फ़ाइलों में 381,980 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 77,688 |
