...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.36.3-blue" alt="संस्करण" />
...
| **संस्करण** | `0.36.3` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 343 फ़ाइलों में 421,705 |
| **परीक्षण Lean LoC** | 71 परीक्षण सुइट्स में 85,663 |
| **प्रमाणित घोषणाएँ** | 13,993 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
