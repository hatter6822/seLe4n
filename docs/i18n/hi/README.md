...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.96-blue" alt="संस्करण" />
...
| **संस्करण** | `0.34.96` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 325 फ़ाइलों में 347,188 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 71,244 |
| **प्रमाणित घोषणाएँ** | 11,567 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
