...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.176-blue" alt="संस्करण" />
...
| **संस्करण** | `0.35.176` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 338 फ़ाइलों में 406,451 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 83,005 |
| **प्रमाणित घोषणाएँ** | 13,455 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
