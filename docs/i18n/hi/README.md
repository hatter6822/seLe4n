...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.122-blue" alt="संस्करण" />
...
| **संस्करण** | `0.34.122` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 328 फ़ाइलों में 355,873 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 72,799 |
