...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.49-blue" alt="संस्करण" />
...
| **संस्करण** | `0.35.49` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 330 फ़ाइलों में 382,430 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 77,749 |
| **प्रमाणित घोषणाएँ** | 12,742 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
