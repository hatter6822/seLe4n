...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.19.6-blue" alt="संस्करण" />
...
| विशेषता | मान |
|----------|------|
| **संस्करण (Version)** | `0.19.6` |
| **Lean टूलचेन (Toolchain)** | `v4.28.0` |
| **उत्पादन Lean LoC** | 100 फ़ाइलों में 57,506 |
| **परीक्षण Lean LoC** | 10 परीक्षण सुइट्स में 7,559 |
| **प्रमाणित घोषणाएँ (Proved declarations)** | 1,756 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
| **लक्ष्य हार्डवेयर (Target hardware)** | Raspberry Pi 5 (BCM2712 / ARM Cortex-A76 / ARMv8-A) |
| **नवीनतम लेखापरीक्षा (Latest audit)** | [`AUDIT_COMPREHENSIVE_v0.18.7_PRE_BENCHMARK.md`](../../../docs/audits/AUDIT_COMPREHENSIVE_v0.18.7_PRE_BENCHMARK.md) एवं [`AUDIT_COMPREHENSIVE_v0.18.7_KERNEL_RUST.md`](../../../docs/audits/AUDIT_COMPREHENSIVE_v0.18.7_KERNEL_RUST.md) — दोहरी व्यापक लेखापरीक्षा (115+ निष्कर्ष, 0 गंभीर) |
...
- **WS-S** — प्री-बेंचमार्क सुदृढ़ीकरण (Pre-Benchmark Strengthening) (7 चरण, S1–S7, 83 उप-कार्य) **पूर्ण** (v0.19.0–v0.19.6)। v0.18.7 दोहरी व्यापक लेखापरीक्षा (115+ निष्कर्ष) के सभी परिणामों को संबोधित करता है। योजना: [`AUDIT_v0.18.7_WORKSTREAM_PLAN.md`](../../../docs/audits/AUDIT_v0.18.7_WORKSTREAM_PLAN.md)। समापन रिपोर्ट: [`WS_S_CLOSURE_REPORT.md`](../../../docs/audits/WS_S_CLOSURE_REPORT.md)।
- **WS-R** — व्यापक लेखापरीक्षा उपचार (Comprehensive Audit Remediation) (8 चरण, R1–R8, 111 उप-कार्य) **पूर्ण** (v0.18.0–v0.18.7)। योजना: [`AUDIT_v0.17.14_WORKSTREAM_PLAN.md`](../../../docs/dev_history/audits/AUDIT_v0.17.14_WORKSTREAM_PLAN.md)।
- **Raspberry Pi 5 हार्डवेयर बाइंडिंग** — ARMv8 पेज टेबल वॉक, GIC-400 इंटरप्ट रूटिंग, बूट अनुक्रम (boot sequence) (अगली कार्यधारा)

पूर्व पोर्टफ़ोलियो (WS-B से WS-R) सभी पूर्ण हैं। पूर्व लेखापरीक्षाएँ (v0.8.0–v0.9.32),
