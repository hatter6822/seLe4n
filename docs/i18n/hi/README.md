...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.105-blue" alt="संस्करण" />
...
| **संस्करण** | `0.35.105` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 333 फ़ाइलों में 392,459 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 79,904 |
