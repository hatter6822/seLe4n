...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.36-blue" alt="संस्करण" />
...
| **संस्करण** | `0.35.36` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 330 फ़ाइलों में 377,396 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 76,463 |
| **प्रमाणित घोषणाएँ** | 12,626 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
