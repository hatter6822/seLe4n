...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.21.4-blue" alt="संस्करण" />
...
| विशेषता | मान |
|----------|------|
| **संस्करण (Version)** | `0.21.4` |
| **Lean टूलचेन (Toolchain)** | `v4.28.0` |
| **उत्पादन Lean LoC** | 101 फ़ाइलों में 64,039 |
| **परीक्षण Lean LoC** | 10 परीक्षण सुइट्स में 8,318 |
| **प्रमाणित घोषणाएँ (Proved declarations)** | 1,901 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
