...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.186-blue" alt="संस्करण" />
...
| **संस्करण** | `0.35.186` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 338 फ़ाइलों में 410,148 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 83,492 |
| **प्रमाणित घोषणाएँ** | 13,560 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
