...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.7-blue" alt="संस्करण" />
...
| **संस्करण** | `0.35.7` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 329 फ़ाइलों में 374,685 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 75,813 |
| **प्रमाणित घोषणाएँ** | 12,593 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
