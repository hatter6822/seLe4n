...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.199-blue" alt="संस्करण" />
...
| **संस्करण** | `0.35.199` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 339 फ़ाइलों में 415,446 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 84,404 |
| **प्रमाणित घोषणाएँ** | 13,739 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
