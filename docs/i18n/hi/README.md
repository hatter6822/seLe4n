...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.169-blue" alt="संस्करण" />
...
| **संस्करण** | `0.35.169` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 336 फ़ाइलों में 404,112 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 82,662 |
| **प्रमाणित घोषणाएँ** | 13,396 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
