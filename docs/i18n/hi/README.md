...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.94-blue" alt="संस्करण" />
...
| **संस्करण** | `0.34.94` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 324 फ़ाइलों में 344,934 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 71,128 |
| **प्रमाणित घोषणाएँ** | 11,490 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
