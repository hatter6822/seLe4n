...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.135-blue" alt="संस्करण" />
...
| **संस्करण** | `0.34.135` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 328 फ़ाइलों में 360,920 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 73,943 |
| **प्रमाणित घोषणाएँ** | 12,076 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
