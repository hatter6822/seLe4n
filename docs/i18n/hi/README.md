...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.80-blue" alt="संस्करण" />
...
| **संस्करण** | `0.35.80` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 331 फ़ाइलों में 386,776 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 78,841 |
| **प्रमाणित घोषणाएँ** | 12,902 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
