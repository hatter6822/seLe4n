...
| **वर्तमान कैनोनिकल लेखापरीक्षा** | [`AUDIT_v0.29.0_COMPREHENSIVE`](../../../docs/audits/AUDIT_v0.29.0_COMPREHENSIVE.md) — बंद लेखापरीक्षा (202 निष्कर्ष, WS-AK चरण AK1–AK10 द्वारा सुधारे गए) |
| **नवीनतम लेखापरीक्षा** | [`AUDIT_v0.30.6_COMPREHENSIVE`](../../../docs/audits/AUDIT_v0.30.6_COMPREHENSIVE.md) — 1.0-पूर्व सख्तीकरण लेखापरीक्षा (3 CRIT, 24 HIGH, 71 MED, 58 LOW, 40 INFO) |
