...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.44-blue" alt="संस्करण" />
...
| **संस्करण** | `0.35.44` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 330 फ़ाइलों में 380,540 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 77,224 |
| **प्रमाणित घोषणाएँ** | 12,706 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
