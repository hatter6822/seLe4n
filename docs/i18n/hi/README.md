...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.98-blue" alt="संस्करण" />
...
| **संस्करण** | `0.35.98` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 333 फ़ाइलों में 391,805 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 79,486 |
| **प्रमाणित घोषणाएँ** | 13,054 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
