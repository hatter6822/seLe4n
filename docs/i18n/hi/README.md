...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.100-blue" alt="संस्करण" />
...
| **संस्करण** | `0.35.100` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 333 फ़ाइलों में 391,981 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 79,626 |
