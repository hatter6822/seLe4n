...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.160-blue" alt="संस्करण" />
...
| **संस्करण** | `0.35.160` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 334 फ़ाइलों में 397,589 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 81,318 |
| **प्रमाणित घोषणाएँ** | 13,152 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
