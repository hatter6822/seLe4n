...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.89-blue" alt="संस्करण" />
...
| **संस्करण** | `0.34.89` |
| **Lean टूलचेन** | `v4.28.0` |
| **उत्पादन Lean LoC** | 321 फ़ाइलों में 341,796 |
| **परीक्षण Lean LoC** | 70 परीक्षण सुइट्स में 70,927 |
| **प्रमाणित घोषणाएँ** | 11,393 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
