...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.20.7-blue" alt="संस्करण" />
...
| विशेषता | मान |
|----------|------|
| **संस्करण (Version)** | `0.20.7` |
| **Lean टूलचेन (Toolchain)** | `v4.28.0` |
| **उत्पादन Lean LoC** | 100 फ़ाइलों में 61,538 |
| **परीक्षण Lean LoC** | 10 परीक्षण सुइट्स में 8,256 |
| **प्रमाणित घोषणाएँ (Proved declarations)** | 1,846 प्रमेय/लेम्मा घोषणाएँ (शून्य sorry/axiom) |
