...
| **版本** | `0.36.2` |
| **Lean 工具链** | `v4.28.0` |
| **生产代码行数** | 420,295 行，分布于 343 个文件 |
| **测试代码行数** | 85,416 行，分布于 71 个测试套件 |
| **已证明的声明** | 13,916 个定理/引理声明（零 sorry/axiom） |
