...
| **规范审计** | [`AUDIT_v0.29.0_COMPREHENSIVE`](../../../docs/audits/AUDIT_v0.29.0_COMPREHENSIVE.md) —— 1.0 前综合审计（202 项发现；已由 WS-AK AK1–AK10 修复） |
| **最新审计** | [`AUDIT_v0.30.6_COMPREHENSIVE`](../../../docs/audits/AUDIT_v0.30.6_COMPREHENSIVE.md) —— 1.0 前加固审计（3 CRIT、24 HIGH、71 MED、58 LOW、40 INFO —— 按 §0.4 初始评分） |
