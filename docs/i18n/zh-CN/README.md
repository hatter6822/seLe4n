...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.36.6-blue" alt="Version" />
...
| **版本** | `0.36.6` |
| **Lean 工具链** | `v4.28.0` |
| **生产代码行数** | 423,960 行，分布于 344 个文件 |
| **测试代码行数** | 86,280 行，分布于 71 个测试套件 |
| **已证明的声明** | 14,056 个定理/引理声明（零 sorry/axiom） |
