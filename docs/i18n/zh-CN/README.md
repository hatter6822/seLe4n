...
| **最新审计** | [`AUDIT_COMPREHENSIVE_v0.23.21`](../../../docs/audits/AUDIT_COMPREHENSIVE_v0.23.21_LEAN_RUST_KERNEL.md) —— 完整的内核 Lean + Rust 审计（0 CRIT、5 HIGH、8 MED、30 LOW） |
...
| 工作流 | 范围 | 版本 |
|--------|------|------|
| **WS-AB** | 延迟操作与活性——suspend/resume、setPriority/setMCPriority、setIPCBuffer、优先级继承协议、有界延迟定理（6 阶段，90 个任务） | v0.24.0–v0.25.3 |
...
详细计划：[WS-AB](../../../docs/planning/WS_AB_DEFERRED_OPERATIONS_WORKSTREAM_PLAN.md) | [WS-Z](../../../docs/planning/WS_Z_COMPOSABLE_PERFORMANCE_OBJECTS.md)
