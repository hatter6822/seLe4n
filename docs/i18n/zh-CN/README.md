...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.204-blue" alt="Version" />
...
| **版本** | `0.35.204` |
| **Lean 工具链** | `v4.28.0` |
| **生产代码行数** | 417,612 行，分布于 340 个文件 |
| **测试代码行数** | 84,644 行，分布于 70 个测试套件 |
| **已证明的声明** | 13,813 个定理/引理声明（零 sorry/axiom） |
