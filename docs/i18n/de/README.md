...
| **Produktions-LoC (Lean)** | 64.229 über 100 Dateien |
| **Test-LoC (Lean)** | 8.316 über 10 Testsuiten |
| **Bewiesene Deklarationen** | 1.878 Theorem-/Lemma-Deklarationen (null sorry/axiom) |
