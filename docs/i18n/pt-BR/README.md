...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.5-blue" alt="Versão" />
...
| **LoC Lean de produção** | 370.721 em 328 arquivos |
| **LoC Lean de testes** | 75.430 em 70 suítes de testes |
| **Declarações provadas** | 12.428 declarações de teorema/lema (zero sorry/axiom) |
