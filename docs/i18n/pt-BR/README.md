...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.183-blue" alt="Versão" />
...
| **LoC Lean de produção** | 409.202 em 338 arquivos |
| **LoC Lean de testes** | 83.391 em 70 suítes de testes |
| **Declarações provadas** | 13.536 declarações de teorema/lema (zero sorry/axiom) |
