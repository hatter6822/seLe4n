...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.96-blue" alt="Versão" />
...
| **LoC Lean de produção** | 347.188 em 325 arquivos |
| **LoC Lean de testes** | 71.244 em 70 suítes de testes |
| **Declarações provadas** | 11.567 declarações de teorema/lema (zero sorry/axiom) |
