...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.22-blue" alt="Versão" />
...
| **LoC Lean de produção** | 376.395 em 330 arquivos |
| **LoC Lean de testes** | 76.029 em 70 suítes de testes |
| **Declarações provadas** | 12.607 declarações de teorema/lema (zero sorry/axiom) |
