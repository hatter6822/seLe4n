...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.105-blue" alt="Versão" />
...
| **LoC Lean de produção** | 352.004 em 327 arquivos |
| **LoC Lean de testes** | 71.347 em 70 suítes de testes |
| **Declarações provadas** | 11.754 declarações de teorema/lema (zero sorry/axiom) |
