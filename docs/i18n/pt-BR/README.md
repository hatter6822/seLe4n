...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.101-blue" alt="Versão" />
...
| **LoC Lean de produção** | 348.316 em 326 arquivos |
| **LoC Lean de testes** | 71.289 em 70 suítes de testes |
| **Declarações provadas** | 11.613 declarações de teorema/lema (zero sorry/axiom) |
