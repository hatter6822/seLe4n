...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.140-blue" alt="Versão" />
...
| **LoC Lean de produção** | 361.430 em 328 arquivos |
| **LoC Lean de testes** | 74.100 em 70 suítes de testes |
| **Declarações provadas** | 12.090 declarações de teorema/lema (zero sorry/axiom) |
