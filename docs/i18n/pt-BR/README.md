...
| **LoC Lean de produção** | 420.101 em 343 arquivos |
| **LoC Lean de testes** | 85.359 em 71 suítes de testes |
| **Declarações provadas** | 13.906 declarações de teorema/lema (zero sorry/axiom) |
