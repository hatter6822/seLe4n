...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.133-blue" alt="Versão" />
...
| **LoC Lean de produção** | 396.021 em 334 arquivos |
| **LoC Lean de testes** | 80.339 em 70 suítes de testes |
| **Declarações provadas** | 13.127 declarações de teorema/lema (zero sorry/axiom) |
