...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.130-blue" alt="Versão" />
...
| **LoC Lean de produção** | 359.761 em 328 arquivos |
| **LoC Lean de testes** | 73.716 em 70 suítes de testes |
| **Declarações provadas** | 12.049 declarações de teorema/lema (zero sorry/axiom) |
