...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.104-blue" alt="Versão" />
...
| **LoC Lean de produção** | 351.182 em 327 arquivos |
| **LoC Lean de testes** | 71.319 em 70 suítes de testes |
| **Declarações provadas** | 11.729 declarações de teorema/lema (zero sorry/axiom) |
