...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.92-blue" alt="Versão" />
...
| **LoC Lean de produção** | 343.521 em 323 arquivos |
| **LoC Lean de testes** | 71.084 em 70 suítes de testes |
| **Declarações provadas** | 11.444 declarações de teorema/lema (zero sorry/axiom) |
