...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.197-blue" alt="Versão" />
...
| **LoC Lean de produção** | 414.657 em 339 arquivos |
| **LoC Lean de testes** | 84.404 em 70 suítes de testes |
| **Declarações provadas** | 13.702 declarações de teorema/lema (zero sorry/axiom) |
