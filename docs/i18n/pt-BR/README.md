...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.201-blue" alt="Versão" />
...
| **LoC Lean de produção** | 417.407 em 340 arquivos |
| **LoC Lean de testes** | 84.545 em 70 suítes de testes |
| **Declarações provadas** | 13.810 declarações de teorema/lema (zero sorry/axiom) |
