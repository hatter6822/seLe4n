...
| **LoC Lean de produção** | 420.258 em 343 arquivos |
| **LoC Lean de testes** | 85.402 em 71 suítes de testes |
| **Declarações provadas** | 13.914 declarações de teorema/lema (zero sorry/axiom) |
