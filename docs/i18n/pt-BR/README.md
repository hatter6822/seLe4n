...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.102-blue" alt="Versão" />
...
| **LoC Lean de produção** | 349.349 em 326 arquivos |
| **LoC Lean de testes** | 71.289 em 70 suítes de testes |
| **Declarações provadas** | 11.667 declarações de teorema/lema (zero sorry/axiom) |
