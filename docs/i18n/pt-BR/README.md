...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.106-blue" alt="Versão" />
...
| **LoC Lean de produção** | 393.612 em 333 arquivos |
| **LoC Lean de testes** | 79.985 em 70 suítes de testes |
| **Declarações provadas** | 13.082 declarações de teorema/lema (zero sorry/axiom) |
