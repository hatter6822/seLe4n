...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.163-blue" alt="Versão" />
...
| **LoC Lean de produção** | 401.319 em 334 arquivos |
| **LoC Lean de testes** | 81.967 em 70 suítes de testes |
| **Declarações provadas** | 13.282 declarações de teorema/lema (zero sorry/axiom) |
