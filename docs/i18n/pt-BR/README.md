...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.89-blue" alt="Versão" />
...
| **LoC Lean de produção** | 341.796 em 321 arquivos |
| **LoC Lean de testes** | 70.927 em 70 suítes de testes |
| **Declarações provadas** | 11.393 declarações de teorema/lema (zero sorry/axiom) |
