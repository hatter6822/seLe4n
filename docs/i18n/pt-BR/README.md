...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.52-blue" alt="Versão" />
...
| **LoC Lean de produção** | 383.733 em 330 arquivos |
| **LoC Lean de testes** | 78.086 em 70 suítes de testes |
| **Declarações provadas** | 12.769 declarações de teorema/lema (zero sorry/axiom) |
