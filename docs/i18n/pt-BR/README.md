...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.182-blue" alt="Versão" />
...
| **LoC Lean de produção** | 408.352 em 338 arquivos |
| **LoC Lean de testes** | 83.391 em 70 suítes de testes |
| **Declarações provadas** | 13.510 declarações de teorema/lema (zero sorry/axiom) |
