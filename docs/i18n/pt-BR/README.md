...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.36.4-blue" alt="Versão" />
...
| **LoC Lean de produção** | 422.300 em 343 arquivos |
| **LoC Lean de testes** | 85.915 em 71 suítes de testes |
| **Declarações provadas** | 14.011 declarações de teorema/lema (zero sorry/axiom) |
