...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.134-blue" alt="Versão" />
...
| **LoC Lean de produção** | 360.710 em 328 arquivos |
| **LoC Lean de testes** | 73.857 em 70 suítes de testes |
| **Declarações provadas** | 12.070 declarações de teorema/lema (zero sorry/axiom) |
