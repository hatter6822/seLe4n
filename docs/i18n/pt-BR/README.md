...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.36.6-blue" alt="Versão" />
...
| **LoC Lean de produção** | 423.960 em 344 arquivos |
| **LoC Lean de testes** | 86.280 em 71 suítes de testes |
| **Declarações provadas** | 14.056 declarações de teorema/lema (zero sorry/axiom) |
