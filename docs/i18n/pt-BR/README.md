...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.87-blue" alt="Versão" />
...
| **LoC Lean de produção** | 339.955 em 317 arquivos |
| **LoC Lean de testes** | 70.722 em 70 suítes de testes |
| **Declarações provadas** | 11.305 declarações de teorema/lema (zero sorry/axiom) |
