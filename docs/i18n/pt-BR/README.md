...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.171-blue" alt="Versão" />
...
| **LoC Lean de produção** | 404.987 em 336 arquivos |
| **LoC Lean de testes** | 82.900 em 70 suítes de testes |
| **Declarações provadas** | 13.424 declarações de teorema/lema (zero sorry/axiom) |
