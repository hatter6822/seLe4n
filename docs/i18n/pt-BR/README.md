...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.46-blue" alt="Versão" />
...
| **LoC Lean de produção** | 381.844 em 330 arquivos |
| **LoC Lean de testes** | 77.346 em 70 suítes de testes |
| **Declarações provadas** | 12.733 declarações de teorema/lema (zero sorry/axiom) |
