...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.67-blue" alt="Versão" />
...
| **LoC Lean de produção** | 385.998 em 330 arquivos |
| **LoC Lean de testes** | 78.763 em 70 suítes de testes |
| **Declarações provadas** | 12.876 declarações de teorema/lema (zero sorry/axiom) |
