...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.178-blue" alt="Versão" />
...
| **LoC Lean de produção** | 407.096 em 338 arquivos |
| **LoC Lean de testes** | 83.035 em 70 suítes de testes |
| **Declarações provadas** | 13.473 declarações de teorema/lema (zero sorry/axiom) |
