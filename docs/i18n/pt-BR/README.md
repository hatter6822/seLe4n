...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.181-blue" alt="Versão" />
...
| **LoC Lean de produção** | 408.061 em 338 arquivos |
| **LoC Lean de testes** | 83.207 em 70 suítes de testes |
| **Declarações provadas** | 13.504 declarações de teorema/lema (zero sorry/axiom) |
