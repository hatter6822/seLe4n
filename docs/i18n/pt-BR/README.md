...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.125-blue" alt="Versão" />
...
| **LoC Lean de produção** | 356.971 em 328 arquivos |
| **LoC Lean de testes** | 73.043 em 70 suítes de testes |
| **Declarações provadas** | 11.935 declarações de teorema/lema (zero sorry/axiom) |
