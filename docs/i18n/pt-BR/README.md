...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.168-blue" alt="Versão" />
...
| **LoC Lean de produção** | 403.754 em 336 arquivos |
| **LoC Lean de testes** | 82.595 em 70 suítes de testes |
| **Declarações provadas** | 13.385 declarações de teorema/lema (zero sorry/axiom) |
