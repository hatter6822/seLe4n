...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.164-blue" alt="Versão" />
...
| **LoC Lean de produção** | 401.833 em 334 arquivos |
| **LoC Lean de testes** | 82.175 em 70 suítes de testes |
| **Declarações provadas** | 13.302 declarações de teorema/lema (zero sorry/axiom) |
