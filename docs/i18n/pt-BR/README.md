...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.172-blue" alt="Versão" />
...
| **LoC Lean de produção** | 405.258 em 336 arquivos |
| **LoC Lean de testes** | 83.005 em 70 suítes de testes |
| **Declarações provadas** | 13.430 declarações de teorema/lema (zero sorry/axiom) |
