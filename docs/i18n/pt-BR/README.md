...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.2-blue" alt="Versão" />
...
| **LoC Lean de produção** | 364.378 em 328 arquivos |
| **LoC Lean de testes** | 74.602 em 70 suítes de testes |
| **Declarações provadas** | 12.164 declarações de teorema/lema (zero sorry/axiom) |
