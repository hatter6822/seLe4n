...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.104-blue" alt="Versão" />
...
| **LoC Lean de produção** | 392.382 em 333 arquivos |
| **LoC Lean de testes** | 79.773 em 70 suítes de testes |
| **Declarações provadas** | 13.063 declarações de teorema/lema (zero sorry/axiom) |
