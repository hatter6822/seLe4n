...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.82-blue" alt="Versão" />
...
| **LoC Lean de produção** | 387.402 em 331 arquivos |
| **LoC Lean de testes** | 78.892 em 70 suítes de testes |
| **Declarações provadas** | 12.917 declarações de teorema/lema (zero sorry/axiom) |
