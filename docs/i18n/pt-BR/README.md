...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.96-blue" alt="Versão" />
...
| **LoC Lean de produção** | 391.466 em 333 arquivos |
| **LoC Lean de testes** | 79.392 em 70 suítes de testes |
| **Declarações provadas** | 13.046 declarações de teorema/lema (zero sorry/axiom) |
