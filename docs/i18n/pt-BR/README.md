...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.57-blue" alt="Versão" />
...
| **LoC Lean de produção** | 384.812 em 330 arquivos |
| **LoC Lean de testes** | 78.352 em 70 suítes de testes |
| **Declarações provadas** | 12.802 declarações de teorema/lema (zero sorry/axiom) |
