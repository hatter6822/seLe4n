...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.55-blue" alt="Versão" />
...
| **LoC Lean de produção** | 383.951 em 330 arquivos |
| **LoC Lean de testes** | 78.257 em 70 suítes de testes |
| **Declarações provadas** | 12.771 declarações de teorema/lema (zero sorry/axiom) |
