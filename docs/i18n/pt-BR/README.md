...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.37-blue" alt="Versão" />
...
| **LoC Lean de produção** | 378.887 em 330 arquivos |
| **LoC Lean de testes** | 76.620 em 70 suítes de testes |
| **Declarações provadas** | 12.676 declarações de teorema/lema (zero sorry/axiom) |
