...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.10-blue" alt="Versão" />
...
| **LoC Lean de produção** | 375.003 em 329 arquivos |
| **LoC Lean de testes** | 75.860 em 70 suítes de testes |
| **Declarações provadas** | 12.599 declarações de teorema/lema (zero sorry/axiom) |
