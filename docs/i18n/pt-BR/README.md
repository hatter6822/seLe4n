...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.90-blue" alt="Versão" />
...
| **LoC Lean de produção** | 389.382 em 332 arquivos |
| **LoC Lean de testes** | 79.141 em 70 suítes de testes |
| **Declarações provadas** | 12.989 declarações de teorema/lema (zero sorry/axiom) |
