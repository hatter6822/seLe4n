...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.62-blue" alt="Versão" />
...
| **LoC Lean de produção** | 385.405 em 330 arquivos |
| **LoC Lean de testes** | 78.723 em 70 suítes de testes |
| **Declarações provadas** | 12.823 declarações de teorema/lema (zero sorry/axiom) |
