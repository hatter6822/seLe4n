...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.180-blue" alt="Versão" />
...
| **LoC Lean de produção** | 407.635 em 338 arquivos |
| **LoC Lean de testes** | 83.095 em 70 suítes de testes |
| **Declarações provadas** | 13.486 declarações de teorema/lema (zero sorry/axiom) |
