...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.95-blue" alt="Versão" />
...
| **LoC Lean de produção** | 346.230 em 324 arquivos |
| **LoC Lean de testes** | 71.194 em 70 suítes de testes |
| **Declarações provadas** | 11.529 declarações de teorema/lema (zero sorry/axiom) |
