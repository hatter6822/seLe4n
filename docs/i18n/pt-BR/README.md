...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.112-blue" alt="Versão" />
...
| **LoC Lean de produção** | 394.808 em 333 arquivos |
| **LoC Lean de testes** | 80.213 em 70 suítes de testes |
| **Declarações provadas** | 13.115 declarações de teorema/lema (zero sorry/axiom) |
