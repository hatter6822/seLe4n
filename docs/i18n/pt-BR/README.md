...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.109-blue" alt="Versão" />
...
| **LoC Lean de produção** | 353.568 em 327 arquivos |
| **LoC Lean de testes** | 71.487 em 70 suítes de testes |
| **Declarações provadas** | 11.817 declarações de teorema/lema (zero sorry/axiom) |
