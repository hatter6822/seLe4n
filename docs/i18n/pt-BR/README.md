...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.135-blue" alt="Versão" />
...
| **LoC Lean de produção** | 360.920 em 328 arquivos |
| **LoC Lean de testes** | 73.943 em 70 suítes de testes |
| **Declarações provadas** | 12.076 declarações de teorema/lema (zero sorry/axiom) |
