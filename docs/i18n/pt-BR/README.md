...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.51-blue" alt="Versão" />
...
| **LoC Lean de produção** | 383.641 em 330 arquivos |
| **LoC Lean de testes** | 77.948 em 70 suítes de testes |
| **Declarações provadas** | 12.767 declarações de teorema/lema (zero sorry/axiom) |
