...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.88-blue" alt="Versão" />
...
| **LoC Lean de produção** | 340.168 em 317 arquivos |
| **LoC Lean de testes** | 70.817 em 70 suítes de testes |
| **Declarações provadas** | 11.316 declarações de teorema/lema (zero sorry/axiom) |
