...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.94-blue" alt="Versão" />
...
| **LoC Lean de produção** | 390.824 em 333 arquivos |
| **LoC Lean de testes** | 79.176 em 70 suítes de testes |
| **Declarações provadas** | 13.029 declarações de teorema/lema (zero sorry/axiom) |
