...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.36.5-blue" alt="Versão" />
...
| **LoC Lean de produção** | 423.001 em 343 arquivos |
| **LoC Lean de testes** | 86.115 em 71 suítes de testes |
| **Declarações provadas** | 14.028 declarações de teorema/lema (zero sorry/axiom) |
