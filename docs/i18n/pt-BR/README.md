...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.190-blue" alt="Versão" />
...
| **LoC Lean de produção** | 411.743 em 338 arquivos |
| **LoC Lean de testes** | 83.880 em 70 suítes de testes |
| **Declarações provadas** | 13.613 declarações de teorema/lema (zero sorry/axiom) |
