...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.26-blue" alt="Versão" />
...
| **LoC Lean de produção** | 376.821 em 330 arquivos |
| **LoC Lean de testes** | 76.127 em 70 suítes de testes |
| **Declarações provadas** | 12.613 declarações de teorema/lema (zero sorry/axiom) |
