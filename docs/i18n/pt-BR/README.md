...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.126-blue" alt="Versão" />
...
| **LoC Lean de produção** | 357.374 em 328 arquivos |
| **LoC Lean de testes** | 73.216 em 70 suítes de testes |
| **Declarações provadas** | 11.989 declarações de teorema/lema (zero sorry/axiom) |
