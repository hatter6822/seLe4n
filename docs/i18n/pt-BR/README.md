...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.160-blue" alt="Versão" />
...
| **LoC Lean de produção** | 397.589 em 334 arquivos |
| **LoC Lean de testes** | 81.318 em 70 suítes de testes |
| **Declarações provadas** | 13.152 declarações de teorema/lema (zero sorry/axiom) |
