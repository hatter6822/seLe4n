...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.103-blue" alt="Versão" />
...
| **LoC Lean de produção** | 349.806 em 327 arquivos |
| **LoC Lean de testes** | 71.289 em 70 suítes de testes |
| **Declarações provadas** | 11.680 declarações de teorema/lema (zero sorry/axiom) |
