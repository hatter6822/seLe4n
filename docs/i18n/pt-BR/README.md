...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.83-blue" alt="Versão" />
...
| **LoC Lean de produção** | 387.521 em 331 arquivos |
| **LoC Lean de testes** | 78.892 em 70 suítes de testes |
| **Declarações provadas** | 12.918 declarações de teorema/lema (zero sorry/axiom) |
