...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.196-blue" alt="Versão" />
...
| **LoC Lean de produção** | 413.957 em 339 arquivos |
| **LoC Lean de testes** | 84.404 em 70 suítes de testes |
| **Declarações provadas** | 13.674 declarações de teorema/lema (zero sorry/axiom) |
