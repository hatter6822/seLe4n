...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.170-blue" alt="Versão" />
...
| **LoC Lean de produção** | 404.629 em 336 arquivos |
| **LoC Lean de testes** | 82.811 em 70 suítes de testes |
| **Declarações provadas** | 13.414 declarações de teorema/lema (zero sorry/axiom) |
