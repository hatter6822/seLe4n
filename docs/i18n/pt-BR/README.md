...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.134-blue" alt="Versão" />
...
| **LoC Lean de produção** | 396.157 em 334 arquivos |
| **LoC Lean de testes** | 80.490 em 70 suítes de testes |
| **Declarações provadas** | 13.126 declarações de teorema/lema (zero sorry/axiom) |
