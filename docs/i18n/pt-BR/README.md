...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.165-blue" alt="Versão" />
...
| **LoC Lean de produção** | 402.324 em 334 arquivos |
| **LoC Lean de testes** | 82.280 em 70 suítes de testes |
| **Declarações provadas** | 13.333 declarações de teorema/lema (zero sorry/axiom) |
