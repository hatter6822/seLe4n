...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.91-blue" alt="Versão" />
...
| **LoC Lean de produção** | 342.838 em 323 arquivos |
| **LoC Lean de testes** | 71.065 em 70 suítes de testes |
| **Declarações provadas** | 11.429 declarações de teorema/lema (zero sorry/axiom) |
