...
| **LoC Lean de produção** | 378.753 em 330 arquivos |
| **LoC Lean de testes** | 76.540 em 70 suítes de testes |
| **Declarações provadas** | 12.671 declarações de teorema/lema (zero sorry/axiom) |
