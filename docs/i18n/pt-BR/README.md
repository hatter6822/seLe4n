...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.95-blue" alt="Versão" />
...
| **LoC Lean de produção** | 391.269 em 333 arquivos |
| **LoC Lean de testes** | 79.176 em 70 suítes de testes |
| **Declarações provadas** | 13.043 declarações de teorema/lema (zero sorry/axiom) |
