...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.81-blue" alt="Versão" />
...
| **LoC Lean de produção** | 386.776 em 331 arquivos |
| **LoC Lean de testes** | 78.841 em 70 suítes de testes |
| **Declarações provadas** | 12.902 declarações de teorema/lema (zero sorry/axiom) |
