...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.169-blue" alt="Versão" />
...
| **LoC Lean de produção** | 404.112 em 336 arquivos |
| **LoC Lean de testes** | 82.662 em 70 suítes de testes |
| **Declarações provadas** | 13.396 declarações de teorema/lema (zero sorry/axiom) |
