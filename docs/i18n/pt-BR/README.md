...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.131-blue" alt="Versão" />
...
| **LoC Lean de produção** | 359.936 em 328 arquivos |
| **LoC Lean de testes** | 73.737 em 70 suítes de testes |
| **Declarações provadas** | 12.054 declarações de teorema/lema (zero sorry/axiom) |
