...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.204-blue" alt="Versão" />
...
| **LoC Lean de produção** | 417.612 em 340 arquivos |
| **LoC Lean de testes** | 84.644 em 70 suítes de testes |
| **Declarações provadas** | 13.813 declarações de teorema/lema (zero sorry/axiom) |
