...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.85-blue" alt="Versão" />
...
| **LoC Lean de produção** | 388.275 em 332 arquivos |
| **LoC Lean de testes** | 78.892 em 70 suítes de testes |
| **Declarações provadas** | 12.931 declarações de teorema/lema (zero sorry/axiom) |
