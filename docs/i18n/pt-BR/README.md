...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.79-blue" alt="Versão" />
...
| **LoC Lean de produção** | 385.802 em 331 arquivos |
| **LoC Lean de testes** | 78.841 em 70 suítes de testes |
| **Declarações provadas** | 12.865 declarações de teorema/lema (zero sorry/axiom) |
