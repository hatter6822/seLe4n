...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.100-blue" alt="Versão" />
...
| **LoC Lean de produção** | 348.145 em 326 arquivos |
| **LoC Lean de testes** | 71.289 em 70 suítes de testes |
| **Declarações provadas** | 11.607 declarações de teorema/lema (zero sorry/axiom) |
