...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.30-blue" alt="Versão" />
...
| **LoC Lean de produção** | 377.186 em 330 arquivos |
| **LoC Lean de testes** | 76.360 em 70 suítes de testes |
| **Declarações provadas** | 12.621 declarações de teorema/lema (zero sorry/axiom) |
