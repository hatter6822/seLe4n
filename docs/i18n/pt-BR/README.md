...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.50-blue" alt="Versão" />
...
| **LoC Lean de produção** | 382.916 em 330 arquivos |
| **LoC Lean de testes** | 77.855 em 70 suítes de testes |
| **Declarações provadas** | 12.754 declarações de teorema/lema (zero sorry/axiom) |
