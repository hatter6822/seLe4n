...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.108-blue" alt="Versão" />
...
| **LoC Lean de produção** | 352.854 em 327 arquivos |
| **LoC Lean de testes** | 71.412 em 70 suítes de testes |
| **Declarações provadas** | 11.788 declarações de teorema/lema (zero sorry/axiom) |
