...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.157-blue" alt="Versão" />
...
| **LoC Lean de produção** | 396.888 em 334 arquivos |
| **LoC Lean de testes** | 81.087 em 70 suítes de testes |
| **Declarações provadas** | 13.137 declarações de teorema/lema (zero sorry/axiom) |
