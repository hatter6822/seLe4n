...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.195-blue" alt="Versão" />
...
| **LoC Lean de produção** | 413.406 em 339 arquivos |
| **LoC Lean de testes** | 84.248 em 70 suítes de testes |
| **Declarações provadas** | 13.654 declarações de teorema/lema (zero sorry/axiom) |
