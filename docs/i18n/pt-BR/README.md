...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.142-blue" alt="Versão" />
...
| **LoC Lean de produção** | 361.981 em 328 arquivos |
| **LoC Lean de testes** | 74.275 em 70 suítes de testes |
| **Declarações provadas** | 12.106 declarações de teorema/lema (zero sorry/axiom) |
