...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.136-blue" alt="Versão" />
...
| **LoC Lean de produção** | 361.146 em 328 arquivos |
| **LoC Lean de testes** | 74.027 em 70 suítes de testes |
| **Declarações provadas** | 12.084 declarações de teorema/lema (zero sorry/axiom) |
