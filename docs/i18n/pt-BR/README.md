...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.44-blue" alt="Versão" />
...
| **LoC Lean de produção** | 380.540 em 330 arquivos |
| **LoC Lean de testes** | 77.224 em 70 suítes de testes |
| **Declarações provadas** | 12.706 declarações de teorema/lema (zero sorry/axiom) |
