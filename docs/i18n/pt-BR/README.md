...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.179-blue" alt="Versão" />
...
| **LoC Lean de produção** | 407.460 em 338 arquivos |
| **LoC Lean de testes** | 83.049 em 70 suítes de testes |
| **Declarações provadas** | 13.481 declarações de teorema/lema (zero sorry/axiom) |
