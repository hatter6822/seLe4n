...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.7-blue" alt="Versão" />
...
| **LoC Lean de produção** | 374.685 em 329 arquivos |
| **LoC Lean de testes** | 75.813 em 70 suítes de testes |
| **Declarações provadas** | 12.593 declarações de teorema/lema (zero sorry/axiom) |
