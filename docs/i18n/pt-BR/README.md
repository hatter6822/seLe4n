...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.124-blue" alt="Versão" />
...
| **LoC Lean de produção** | 395.008 em 334 arquivos |
| **LoC Lean de testes** | 80.213 em 70 suítes de testes |
| **Declarações provadas** | 13.116 declarações de teorema/lema (zero sorry/axiom) |
