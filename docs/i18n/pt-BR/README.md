...
| **LoC Lean de produção** | 419.011 em 342 arquivos |
| **LoC Lean de testes** | 85.328 em 71 suítes de testes |
| **Declarações provadas** | 13.871 declarações de teorema/lema (zero sorry/axiom) |
