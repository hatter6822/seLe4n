...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.123-blue" alt="Versão" />
...
| **LoC Lean de produção** | 355.916 em 328 arquivos |
| **LoC Lean de testes** | 72.875 em 70 suítes de testes |
| **Declarações provadas** | 11.889 declarações de teorema/lema (zero sorry/axiom) |
