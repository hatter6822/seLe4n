...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.192-blue" alt="Versão" />
...
| **LoC Lean de produção** | 412.636 em 339 arquivos |
| **LoC Lean de testes** | 83.961 em 70 suítes de testes |
| **Declarações provadas** | 13.638 declarações de teorema/lema (zero sorry/axiom) |
