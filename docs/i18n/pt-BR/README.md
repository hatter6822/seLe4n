...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.110-blue" alt="Versão" />
...
| **LoC Lean de produção** | 394.244 em 333 arquivos |
| **LoC Lean de testes** | 80.133 em 70 suítes de testes |
| **Declarações provadas** | 13.097 declarações de teorema/lema (zero sorry/axiom) |
