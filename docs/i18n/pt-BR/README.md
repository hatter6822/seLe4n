...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.161-blue" alt="Versão" />
...
| **LoC Lean de produção** | 399.198 em 334 arquivos |
| **LoC Lean de testes** | 81.487 em 70 suítes de testes |
| **Declarações provadas** | 13.210 declarações de teorema/lema (zero sorry/axiom) |
