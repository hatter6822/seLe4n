...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.99-blue" alt="Versão" />
...
| **LoC Lean de produção** | 391.919 em 333 arquivos |
| **LoC Lean de testes** | 79.621 em 70 suítes de testes |
| **Declarações provadas** | 13.056 declarações de teorema/lema (zero sorry/axiom) |
