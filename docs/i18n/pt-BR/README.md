...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.69-blue" alt="Versão" />
...
| **LoC Lean de produção** | 386.157 em 331 arquivos |
| **LoC Lean de testes** | 78.776 em 70 suítes de testes |
| **Declarações provadas** | 12.887 declarações de teorema/lema (zero sorry/axiom) |
