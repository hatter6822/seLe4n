...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.64-blue" alt="Versão" />
...
| **LoC Lean de produção** | 385.804 em 330 arquivos |
| **LoC Lean de testes** | 78.722 em 70 suítes de testes |
| **Declarações provadas** | 12.867 declarações de teorema/lema (zero sorry/axiom) |
