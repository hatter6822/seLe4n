...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.58-blue" alt="Versão" />
...
| **LoC Lean de produção** | 385.041 em 330 arquivos |
| **LoC Lean de testes** | 78.456 em 70 suítes de testes |
| **Declarações provadas** | 12.816 declarações de teorema/lema (zero sorry/axiom) |
