...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.93-blue" alt="Versão" />
...
| **LoC Lean de produção** | 343.801 em 323 arquivos |
| **LoC Lean de testes** | 71.095 em 70 suítes de testes |
| **Declarações provadas** | 11.449 declarações de teorema/lema (zero sorry/axiom) |
