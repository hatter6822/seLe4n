...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.176-blue" alt="Versão" />
...
| **LoC Lean de produção** | 406.451 em 338 arquivos |
| **LoC Lean de testes** | 83.005 em 70 suítes de testes |
| **Declarações provadas** | 13.455 declarações de teorema/lema (zero sorry/axiom) |
