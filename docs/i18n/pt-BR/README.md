...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.72-blue" alt="Versão" />
...
| **LoC Lean de produção** | 386.458 em 331 arquivos |
| **LoC Lean de testes** | 78.776 em 70 suítes de testes |
| **Declarações provadas** | 12.905 declarações de teorema/lema (zero sorry/axiom) |
