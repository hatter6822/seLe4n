...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.142-blue" alt="Versão" />
...
| **LoC Lean de produção** | 396.419 em 334 arquivos |
| **LoC Lean de testes** | 80.680 em 70 suítes de testes |
| **Declarações provadas** | 13.128 declarações de teorema/lema (zero sorry/axiom) |
