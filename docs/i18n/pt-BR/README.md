...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.125-blue" alt="Versão" />
...
| **LoC Lean de produção** | 395.341 em 334 arquivos |
| **LoC Lean de testes** | 80.213 em 70 suítes de testes |
| **Declarações provadas** | 13.117 declarações de teorema/lema (zero sorry/axiom) |
