...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.45-blue" alt="Versão" />
...
| **LoC Lean de produção** | 382.025 em 330 arquivos |
| **LoC Lean de testes** | 77.280 em 70 suítes de testes |
| **Declarações provadas** | 12.741 declarações de teorema/lema (zero sorry/axiom) |
