...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.174-blue" alt="Versão" />
...
| **LoC Lean de produção** | 405.953 em 338 arquivos |
| **LoC Lean de testes** | 83.005 em 70 suítes de testes |
| **Declarações provadas** | 13.442 declarações de teorema/lema (zero sorry/axiom) |
