...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.89-blue" alt="Versão" />
...
| **LoC Lean de produção** | 389.122 em 332 arquivos |
| **LoC Lean de testes** | 79.009 em 70 suítes de testes |
| **Declarações provadas** | 12.977 declarações de teorema/lema (zero sorry/axiom) |
