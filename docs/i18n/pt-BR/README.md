...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.187-blue" alt="Versão" />
...
| **LoC Lean de produção** | 410.383 em 338 arquivos |
| **LoC Lean de testes** | 83.589 em 70 suítes de testes |
| **Declarações provadas** | 13.573 declarações de teorema/lema (zero sorry/axiom) |
