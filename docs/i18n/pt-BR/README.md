...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.48-blue" alt="Versão" />
...
| **LoC Lean de produção** | 381.980 em 330 arquivos |
| **LoC Lean de testes** | 77.688 em 70 suítes de testes |
| **Declarações provadas** | 12.734 declarações de teorema/lema (zero sorry/axiom) |
