...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.38-blue" alt="Versão" />
...
| **LoC Lean de produção** | 379.856 em 330 arquivos |
| **LoC Lean de testes** | 76.925 em 70 suítes de testes |
| **Declarações provadas** | 12.693 declarações de teorema/lema (zero sorry/axiom) |
