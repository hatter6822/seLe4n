...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.177-blue" alt="Versão" />
...
| **LoC Lean de produção** | 406.667 em 338 arquivos |
| **LoC Lean de testes** | 83.019 em 70 suítes de testes |
| **Declarações provadas** | 13.463 declarações de teorema/lema (zero sorry/axiom) |
