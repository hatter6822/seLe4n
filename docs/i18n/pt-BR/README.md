...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.78-blue" alt="Versão" />
...
| **LoC Lean de produção** | 385.487 em 331 arquivos |
| **LoC Lean de testes** | 78.725 em 70 suítes de testes |
| **Declarações provadas** | 12.853 declarações de teorema/lema (zero sorry/axiom) |
