...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.49-blue" alt="Versão" />
...
| **LoC Lean de produção** | 382.430 em 330 arquivos |
| **LoC Lean de testes** | 77.749 em 70 suítes de testes |
| **Declarações provadas** | 12.742 declarações de teorema/lema (zero sorry/axiom) |
