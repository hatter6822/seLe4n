...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.127-blue" alt="Versão" />
...
| **LoC Lean de produção** | 357.749 em 328 arquivos |
| **LoC Lean de testes** | 73.315 em 70 suítes de testes |
| **Declarações provadas** | 11.997 declarações de teorema/lema (zero sorry/axiom) |
