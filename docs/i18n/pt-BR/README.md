...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.36.3-blue" alt="Versão" />
...
| **LoC Lean de produção** | 421.705 em 343 arquivos |
| **LoC Lean de testes** | 85.663 em 71 suítes de testes |
| **Declarações provadas** | 13.993 declarações de teorema/lema (zero sorry/axiom) |
