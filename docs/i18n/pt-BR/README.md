...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.36.2-blue" alt="Versão" />
...
| **LoC Lean de produção** | 420.759 em 343 arquivos |
| **LoC Lean de testes** | 85.605 em 71 suítes de testes |
| **Declarações provadas** | 13.928 declarações de teorema/lema (zero sorry/axiom) |
