...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.199-blue" alt="Versão" />
...
| **LoC Lean de produção** | 415.446 em 339 arquivos |
| **LoC Lean de testes** | 84.404 em 70 suítes de testes |
| **Declarações provadas** | 13.739 declarações de teorema/lema (zero sorry/axiom) |
