...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.166-blue" alt="Versão" />
...
| **LoC Lean de produção** | 402.742 em 335 arquivos |
| **LoC Lean de testes** | 82.280 em 70 suítes de testes |
| **Declarações provadas** | 13.344 declarações de teorema/lema (zero sorry/axiom) |
