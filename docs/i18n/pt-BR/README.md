...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.84-blue" alt="Versão" />
...
| **LoC Lean de produção** | 387.893 em 331 arquivos |
| **LoC Lean de testes** | 78.892 em 70 suítes de testes |
| **Declarações provadas** | 12.925 declarações de teorema/lema (zero sorry/axiom) |
