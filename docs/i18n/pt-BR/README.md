...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.94-blue" alt="Versão" />
...
| **LoC Lean de produção** | 344.934 em 324 arquivos |
| **LoC Lean de testes** | 71.128 em 70 suítes de testes |
| **Declarações provadas** | 11.490 declarações de teorema/lema (zero sorry/axiom) |
