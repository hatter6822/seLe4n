...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.129-blue" alt="Versão" />
...
| **LoC Lean de produção** | 359.285 em 328 arquivos |
| **LoC Lean de testes** | 73.670 em 70 suítes de testes |
| **Declarações provadas** | 12.041 declarações de teorema/lema (zero sorry/axiom) |
