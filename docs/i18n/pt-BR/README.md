...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.3-blue" alt="Versão" />
...
| **LoC Lean de produção** | 364.812 em 328 arquivos |
| **LoC Lean de testes** | 74.909 em 70 suítes de testes |
| **Declarações provadas** | 12.185 declarações de teorema/lema (zero sorry/axiom) |
