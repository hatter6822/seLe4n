...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.97-blue" alt="Versão" />
...
| **LoC Lean de produção** | 391.604 em 333 arquivos |
| **LoC Lean de testes** | 79.392 em 70 suítes de testes |
| **Declarações provadas** | 13.052 declarações de teorema/lema (zero sorry/axiom) |
