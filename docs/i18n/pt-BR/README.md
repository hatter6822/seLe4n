...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.90-blue" alt="Versão" />
...
| **LoC Lean de produção** | 342.776 em 323 arquivos |
| **LoC Lean de testes** | 71.065 em 70 suítes de testes |
| **Declarações provadas** | 11.427 declarações de teorema/lema (zero sorry/axiom) |
