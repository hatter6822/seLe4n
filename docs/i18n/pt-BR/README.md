...
| **LoC Lean de produção** | 420.527 em 343 arquivos |
| **LoC Lean de testes** | 85.428 em 71 suítes de testes |
| **Declarações provadas** | 13.922 declarações de teorema/lema (zero sorry/axiom) |
