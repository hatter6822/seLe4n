...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.76-blue" alt="Versão" />
...
| **LoC Lean de produção** | 386.656 em 331 arquivos |
| **LoC Lean de testes** | 78.776 em 70 suítes de testes |
| **Declarações provadas** | 12.913 declarações de teorema/lema (zero sorry/axiom) |
