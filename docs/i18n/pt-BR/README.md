...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.86-blue" alt="Versão" />
...
| **LoC Lean de produção** | 389.153 em 332 arquivos |
| **LoC Lean de testes** | 79.007 em 70 suítes de testes |
| **Declarações provadas** | 12.967 declarações de teorema/lema (zero sorry/axiom) |
