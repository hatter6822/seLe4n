...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.98-blue" alt="Versão" />
...
| **LoC Lean de produção** | 391.805 em 333 arquivos |
| **LoC Lean de testes** | 79.486 em 70 suítes de testes |
| **Declarações provadas** | 13.054 declarações de teorema/lema (zero sorry/axiom) |
