...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.103-blue" alt="Versão" />
...
| **LoC Lean de produção** | 392.173 em 333 arquivos |
| **LoC Lean de testes** | 79.773 em 70 suítes de testes |
| **Declarações provadas** | 13.058 declarações de teorema/lema (zero sorry/axiom) |
