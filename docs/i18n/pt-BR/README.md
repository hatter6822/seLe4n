...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.189-blue" alt="Versão" />
...
| **LoC Lean de produção** | 410.884 em 338 arquivos |
| **LoC Lean de testes** | 83.710 em 70 suítes de testes |
| **Declarações provadas** | 13.591 declarações de teorema/lema (zero sorry/axiom) |
