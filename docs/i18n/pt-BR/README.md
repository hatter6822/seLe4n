...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.194-blue" alt="Versão" />
...
| **LoC Lean de produção** | 413.049 em 339 arquivos |
| **LoC Lean de testes** | 84.109 em 70 suítes de testes |
| **Declarações provadas** | 13.648 declarações de teorema/lema (zero sorry/axiom) |
