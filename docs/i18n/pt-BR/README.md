...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.35-blue" alt="Versão" />
...
| **LoC Lean de produção** | 377.396 em 330 arquivos |
| **LoC Lean de testes** | 76.463 em 70 suítes de testes |
| **Declarações provadas** | 12.626 declarações de teorema/lema (zero sorry/axiom) |
