...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.112-blue" alt="Versão" />
...
| **LoC Lean de produção** | 354.786 em 328 arquivos |
| **LoC Lean de testes** | 71.694 em 70 suítes de testes |
| **Declarações provadas** | 11.875 declarações de teorema/lema (zero sorry/axiom) |
