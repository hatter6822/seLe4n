...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.169-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 404 112 рядків у 336 файлах |
| **Тестовий код (Lean LoC)** | 82 662 рядки у 70 тест-сьютах |
| **Доведені декларації** | 13 396 декларацій theorem/lemma (нуль sorry/axiom) |
