...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.167-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 403 351 рядок у 336 файлах |
| **Тестовий код (Lean LoC)** | 82 491 рядок у 70 тест-сьютах |
| **Доведені декларації** | 13 368 декларацій theorem/lemma (нуль sorry/axiom) |
