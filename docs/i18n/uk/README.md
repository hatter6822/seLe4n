...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.117-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 355 474 рядки у 328 файлах |
| **Тестовий код (Lean LoC)** | 72 433 рядки у 70 тест-сьютах |
