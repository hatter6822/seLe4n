...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.6-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 374 568 рядків у 329 файлах |
| **Тестовий код (Lean LoC)** | 75 813 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 576 декларацій theorem/lemma (нуль sorry/axiom) |
