...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.72-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 386 458 рядків у 331 файлі |
| **Тестовий код (Lean LoC)** | 78 776 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 905 декларацій theorem/lemma (нуль sorry/axiom) |
