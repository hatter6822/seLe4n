...
| **Продуктовий код (Lean LoC)** | 420 527 рядків у 343 файлах |
| **Тестовий код (Lean LoC)** | 85 428 рядків у 71 тест-сьюті |
| **Доведені декларації** | 13 922 декларації theorem/lemma (нуль sorry/axiom) |
