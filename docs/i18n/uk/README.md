...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.81-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 386 776 рядків у 331 файлі |
| **Тестовий код (Lean LoC)** | 78 841 рядок у 70 тест-сьютах |
| **Доведені декларації** | 12 902 декларації theorem/lemma (нуль sorry/axiom) |
