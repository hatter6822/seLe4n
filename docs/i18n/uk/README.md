...
| **Продуктовий код (Lean LoC)** | 378 753 рядки у 330 файлах |
| **Тестовий код (Lean LoC)** | 76 540 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 671 декларація theorem/lemma (нуль sorry/axiom) |
