...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.23-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 376 503 рядки у 330 файлах |
| **Тестовий код (Lean LoC)** | 76 048 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 610 декларацій theorem/lemma (нуль sorry/axiom) |
