...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.36.4-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 422 300 рядків у 343 файлах |
| **Тестовий код (Lean LoC)** | 85 915 рядків у 71 тест-сьюті |
| **Доведені декларації** | 14 011 декларацій theorem/lemma (нуль sorry/axiom) |
