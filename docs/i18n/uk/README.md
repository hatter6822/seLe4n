...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.189-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 410 884 рядки у 338 файлах |
| **Тестовий код (Lean LoC)** | 83 710 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 591 декларація theorem/lemma (нуль sorry/axiom) |
