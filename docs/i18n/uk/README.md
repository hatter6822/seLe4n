...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.52-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 383 733 рядки у 330 файлах |
| **Тестовий код (Lean LoC)** | 78 086 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 769 декларацій theorem/lemma (нуль sorry/axiom) |
