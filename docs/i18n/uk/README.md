...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.140-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 396 365 рядків у 334 файлах |
| **Тестовий код (Lean LoC)** | 80 607 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 128 декларацій theorem/lemma (нуль sorry/axiom) |
