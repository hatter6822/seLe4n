...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.9-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 374 875 рядків у 329 файлах |
| **Тестовий код (Lean LoC)** | 75 847 рядків у 70 тест-сьютах |
