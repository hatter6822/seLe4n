...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.87-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 389 122 рядки у 332 файлах |
| **Тестовий код (Lean LoC)** | 79 009 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 977 декларацій theorem/lemma (нуль sorry/axiom) |
