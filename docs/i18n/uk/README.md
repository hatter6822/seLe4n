...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.36.5-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 423 001 рядок у 343 файлах |
| **Тестовий код (Lean LoC)** | 86 115 рядків у 71 тест-сьюті |
| **Доведені декларації** | 14 028 декларацій theorem/lemma (нуль sorry/axiom) |
