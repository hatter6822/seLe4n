...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.99-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 391 919 рядків у 333 файлах |
| **Тестовий код (Lean LoC)** | 79 621 рядок у 70 тест-сьютах |
| **Доведені декларації** | 13 056 декларацій theorem/lemma (нуль sorry/axiom) |
