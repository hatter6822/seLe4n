...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.92-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 343 521 рядок у 323 файлах |
| **Тестовий код (Lean LoC)** | 71 084 рядки у 70 тест-сьютах |
| **Доведені декларації** | 11 444 декларації theorem/lemma (нуль sorry/axiom) |
