...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.5-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 370 721 рядок у 328 файлах |
| **Тестовий код (Lean LoC)** | 75 430 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 428 декларацій theorem/lemma (нуль sorry/axiom) |
