...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.109-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 353 568 рядків у 327 файлах |
| **Тестовий код (Lean LoC)** | 71 487 рядків у 70 тест-сьютах |
| **Доведені декларації** | 11 817 декларацій theorem/lemma (нуль sorry/axiom) |
