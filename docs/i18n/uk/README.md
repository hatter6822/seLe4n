...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.36.6-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 423 960 рядків у 344 файлах |
| **Тестовий код (Lean LoC)** | 86 280 рядків у 71 тест-сьюті |
| **Доведені декларації** | 14 056 декларацій theorem/lemma (нуль sorry/axiom) |
