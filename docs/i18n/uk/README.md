...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.51-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 383 641 рядок у 330 файлах |
| **Тестовий код (Lean LoC)** | 77 948 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 767 декларацій theorem/lemma (нуль sorry/axiom) |
