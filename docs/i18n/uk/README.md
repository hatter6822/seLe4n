...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.127-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 357 749 рядків у 328 файлах |
| **Тестовий код (Lean LoC)** | 73 315 рядків у 70 тест-сьютах |
| **Доведені декларації** | 11 997 декларацій theorem/lemma (нуль sorry/axiom) |
