...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.111-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 354 553 рядки у 328 файлах |
| **Тестовий код (Lean LoC)** | 71 633 рядки у 70 тест-сьютах |
| **Доведені декларації** | 11 868 декларацій theorem/lemma (нуль sorry/axiom) |
