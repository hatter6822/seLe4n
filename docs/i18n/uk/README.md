...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.190-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 411 743 рядки у 338 файлах |
| **Тестовий код (Lean LoC)** | 83 880 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 613 декларацій theorem/lemma (нуль sorry/axiom) |
