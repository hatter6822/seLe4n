...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.93-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 343 801 рядок у 323 файлах |
| **Тестовий код (Lean LoC)** | 71 095 рядків у 70 тест-сьютах |
| **Доведені декларації** | 11 449 декларацій theorem/lemma (нуль sorry/axiom) |
