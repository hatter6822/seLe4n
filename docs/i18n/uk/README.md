...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.135-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 360 920 рядків у 328 файлах |
| **Тестовий код (Lean LoC)** | 73 943 рядки у 70 тест-сьютах |
| **Доведені декларації** | 12 076 декларацій theorem/lemma (нуль sorry/axiom) |
