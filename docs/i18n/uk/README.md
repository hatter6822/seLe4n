...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.199-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 415 446 рядків у 339 файлах |
| **Тестовий код (Lean LoC)** | 84 404 рядки у 70 тест-сьютах |
| **Доведені декларації** | 13 739 декларацій theorem/lemma (нуль sorry/axiom) |
