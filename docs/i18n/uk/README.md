...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.130-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 359 761 рядок у 328 файлах |
| **Тестовий код (Lean LoC)** | 73 716 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 049 декларацій theorem/lemma (нуль sorry/axiom) |
