...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.46-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 381 844 рядки у 330 файлах |
| **Тестовий код (Lean LoC)** | 77 346 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 733 декларації theorem/lemma (нуль sorry/axiom) |
