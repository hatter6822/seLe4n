...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.78-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 385 487 рядків у 331 файлі |
| **Тестовий код (Lean LoC)** | 78 725 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 853 декларації theorem/lemma (нуль sorry/axiom) |
