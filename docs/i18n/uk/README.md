...
| **Продуктовий код (Lean LoC)** | 420 295 рядків у 343 файлах |
| **Тестовий код (Lean LoC)** | 85 416 рядків у 71 тест-сьюті |
| **Доведені декларації** | 13 916 декларацій theorem/lemma (нуль sorry/axiom) |
