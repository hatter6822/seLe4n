...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.83-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 387 521 рядок у 331 файлі |
| **Тестовий код (Lean LoC)** | 78 892 рядки у 70 тест-сьютах |
| **Доведені декларації** | 12 918 декларацій theorem/lemma (нуль sorry/axiom) |
