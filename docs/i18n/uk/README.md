...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.97-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 391 604 рядки у 333 файлах |
| **Тестовий код (Lean LoC)** | 79 392 рядки у 70 тест-сьютах |
| **Доведені декларації** | 13 052 декларації theorem/lemma (нуль sorry/axiom) |
