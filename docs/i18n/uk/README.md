...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.164-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 401 833 рядки у 334 файлах |
| **Тестовий код (Lean LoC)** | 82 175 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 302 декларації theorem/lemma (нуль sorry/axiom) |
