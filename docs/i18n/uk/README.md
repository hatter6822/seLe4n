...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.174-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 405 953 рядки у 338 файлах |
| **Тестовий код (Lean LoC)** | 83 005 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 442 декларації theorem/lemma (нуль sorry/axiom) |
