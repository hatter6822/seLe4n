...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.136-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 361 146 рядків у 328 файлах |
| **Тестовий код (Lean LoC)** | 74 027 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 084 декларації theorem/lemma (нуль sorry/axiom) |
