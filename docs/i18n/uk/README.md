...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.112-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 354 786 рядків у 328 файлах |
| **Тестовий код (Lean LoC)** | 71 694 рядки у 70 тест-сьютах |
| **Доведені декларації** | 11 875 декларацій theorem/lemma (нуль sorry/axiom) |
