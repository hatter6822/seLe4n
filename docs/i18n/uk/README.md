...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.176-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 406 451 рядок у 338 файлах |
| **Тестовий код (Lean LoC)** | 83 005 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 455 декларацій theorem/lemma (нуль sorry/axiom) |
