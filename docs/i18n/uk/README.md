...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.125-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 356 971 рядок у 328 файлах |
| **Тестовий код (Lean LoC)** | 73 043 рядки у 70 тест-сьютах |
| **Доведені декларації** | 11 935 декларацій theorem/lemma (нуль sorry/axiom) |
