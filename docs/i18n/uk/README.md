...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.168-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 403 754 рядки у 336 файлах |
| **Тестовий код (Lean LoC)** | 82 595 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 385 декларацій theorem/lemma (нуль sorry/axiom) |
