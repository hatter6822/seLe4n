...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.179-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 407 460 рядків у 338 файлах |
| **Тестовий код (Lean LoC)** | 83 049 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 481 декларація theorem/lemma (нуль sorry/axiom) |
