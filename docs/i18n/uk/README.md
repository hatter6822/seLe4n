...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.89-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 341 796 рядків у 321 файлі |
| **Тестовий код (Lean LoC)** | 70 927 рядків у 70 тест-сьютах |
| **Доведені декларації** | 11 393 декларації theorem/lemma (нуль sorry/axiom) |
