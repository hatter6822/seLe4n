...
| **Продуктовий код (Lean LoC)** | 420 258 рядків у 343 файлах |
| **Тестовий код (Lean LoC)** | 85 402 рядки у 71 тест-сьюті |
| **Доведені декларації** | 13 914 декларацій theorem/lemma (нуль sorry/axiom) |
