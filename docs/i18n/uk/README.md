...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.1-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 362 103 рядки у 328 файлах |
| **Тестовий код (Lean LoC)** | 74 287 рядків у 70 тест-сьютах |
