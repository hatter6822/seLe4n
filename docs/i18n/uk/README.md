...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.4-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 369 809 рядків у 328 файлах |
| **Тестовий код (Lean LoC)** | 75 158 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 402 декларації theorem/lemma (нуль sorry/axiom) |
