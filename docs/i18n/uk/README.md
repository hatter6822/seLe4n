...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.85-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 388 275 рядків у 332 файлах |
| **Тестовий код (Lean LoC)** | 78 892 рядки у 70 тест-сьютах |
| **Доведені декларації** | 12 931 декларація theorem/lemma (нуль sorry/axiom) |
