...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.197-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 414 657 рядків у 339 файлах |
| **Тестовий код (Lean LoC)** | 84 404 рядки у 70 тест-сьютах |
| **Доведені декларації** | 13 702 декларації theorem/lemma (нуль sorry/axiom) |
