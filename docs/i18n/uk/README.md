...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.64-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 385 804 рядки у 330 файлах |
| **Тестовий код (Lean LoC)** | 78 722 рядки у 70 тест-сьютах |
| **Доведені декларації** | 12 867 декларацій theorem/lemma (нуль sorry/axiom) |
