...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.166-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 402 742 рядки у 335 файлах |
| **Тестовий код (Lean LoC)** | 82 280 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 344 декларації theorem/lemma (нуль sorry/axiom) |
