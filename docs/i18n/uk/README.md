...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.126-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 357 374 рядки у 328 файлах |
| **Тестовий код (Lean LoC)** | 73 216 рядків у 70 тест-сьютах |
| **Доведені декларації** | 11 989 декларацій theorem/lemma (нуль sorry/axiom) |
