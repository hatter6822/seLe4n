...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.76-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 386 656 рядків у 331 файлі |
| **Тестовий код (Lean LoC)** | 78 776 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 913 декларацій theorem/lemma (нуль sorry/axiom) |
