...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.108-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 394 244 рядки у 333 файлах |
| **Тестовий код (Lean LoC)** | 80 108 рядків у 70 тест-сьютах |
