...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.194-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 413 049 рядків у 339 файлах |
| **Тестовий код (Lean LoC)** | 84 109 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 648 декларацій theorem/lemma (нуль sorry/axiom) |
