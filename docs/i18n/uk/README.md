...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.192-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 412 636 рядків у 339 файлах |
| **Тестовий код (Lean LoC)** | 83 961 рядок у 70 тест-сьютах |
