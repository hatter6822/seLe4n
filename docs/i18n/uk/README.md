...
| **Продуктовий код (Lean LoC)** | 419 011 рядків у 342 файлах |
| **Тестовий код (Lean LoC)** | 85 328 рядків у 71 тест-сьюті |
| **Доведені декларації** | 13 871 декларація theorem/lemma (нуль sorry/axiom) |
