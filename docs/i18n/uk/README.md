...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.158-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 397 042 рядки у 334 файлах |
| **Тестовий код (Lean LoC)** | 81 232 рядки у 70 тест-сьютах |
