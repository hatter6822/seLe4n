...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.180-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 407 635 рядків у 338 файлах |
| **Тестовий код (Lean LoC)** | 83 095 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 486 декларацій theorem/lemma (нуль sorry/axiom) |
