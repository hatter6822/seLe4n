...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.94-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 344 934 рядки у 324 файлах |
| **Тестовий код (Lean LoC)** | 71 128 рядків у 70 тест-сьютах |
| **Доведені декларації** | 11 490 декларацій theorem/lemma (нуль sorry/axiom) |
