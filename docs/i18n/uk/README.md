...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.170-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 404 629 рядків у 336 файлах |
| **Тестовий код (Lean LoC)** | 82 811 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 414 декларацій theorem/lemma (нуль sorry/axiom) |
