...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.178-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 407 096 рядків у 338 файлах |
| **Тестовий код (Lean LoC)** | 83 035 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 473 декларації theorem/lemma (нуль sorry/axiom) |
