...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.122-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 355 873 рядки у 328 файлах |
| **Тестовий код (Lean LoC)** | 72 799 рядків у 70 тест-сьютах |
