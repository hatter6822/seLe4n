...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.100-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 348 145 рядків у 326 файлах |
| **Тестовий код (Lean LoC)** | 71 289 рядків у 70 тест-сьютах |
| **Доведені декларації** | 11 607 декларацій theorem/lemma (нуль sorry/axiom) |
