...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.92-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 390 600 рядків у 333 файлах |
| **Тестовий код (Lean LoC)** | 79 157 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 014 декларацій theorem/lemma (нуль sorry/axiom) |
