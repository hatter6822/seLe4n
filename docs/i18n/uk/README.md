...
| **Продуктовий код (Lean LoC)** | 420 101 рядок у 343 файлах |
| **Тестовий код (Lean LoC)** | 85 359 рядків у 71 тест-сьюті |
| **Доведені декларації** | 13 906 декларацій theorem/lemma (нуль sorry/axiom) |
