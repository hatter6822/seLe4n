...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.137-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 361 351 рядок у 328 файлах |
| **Тестовий код (Lean LoC)** | 74 073 рядки у 70 тест-сьютах |
| **Доведені декларації** | 12 089 декларацій theorem/lemma (нуль sorry/axiom) |
