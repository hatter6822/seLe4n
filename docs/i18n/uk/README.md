...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.95-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 391 269 рядків у 333 файлах |
| **Тестовий код (Lean LoC)** | 79 176 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 043 декларації theorem/lemma (нуль sorry/axiom) |
