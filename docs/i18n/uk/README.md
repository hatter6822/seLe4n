...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.37-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 378 887 рядків у 330 файлах |
| **Тестовий код (Lean LoC)** | 76 620 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 676 декларацій theorem/lemma (нуль sorry/axiom) |
