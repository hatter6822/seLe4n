...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.134-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 360 710 рядків у 328 файлах |
| **Тестовий код (Lean LoC)** | 73 857 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 070 декларацій theorem/lemma (нуль sorry/axiom) |
