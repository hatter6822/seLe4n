...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.107-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 394 194 рядки у 333 файлах |
| **Тестовий код (Lean LoC)** | 79 985 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 097 декларацій theorem/lemma (нуль sorry/axiom) |
