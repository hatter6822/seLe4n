...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.172-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 405 258 рядків у 336 файлах |
| **Тестовий код (Lean LoC)** | 83 005 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 430 декларацій theorem/lemma (нуль sorry/axiom) |
