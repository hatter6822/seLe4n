...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.104-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 351 182 рядки у 327 файлах |
| **Тестовий код (Lean LoC)** | 71 319 рядків у 70 тест-сьютах |
| **Доведені декларації** | 11 729 декларацій theorem/lemma (нуль sorry/axiom) |
