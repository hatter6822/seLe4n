...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.186-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 410 148 рядків у 338 файлах |
| **Тестовий код (Lean LoC)** | 83 492 рядки у 70 тест-сьютах |
| **Доведені декларації** | 13 560 декларацій theorem/lemma (нуль sorry/axiom) |
