...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.94-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 390 824 рядки у 333 файлах |
| **Тестовий код (Lean LoC)** | 79 176 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 029 декларацій theorem/lemma (нуль sorry/axiom) |
