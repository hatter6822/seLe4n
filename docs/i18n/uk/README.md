...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.79-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 385 802 рядки у 331 файлі |
| **Тестовий код (Lean LoC)** | 78 841 рядок у 70 тест-сьютах |
| **Доведені декларації** | 12 865 декларацій theorem/lemma (нуль sorry/axiom) |
