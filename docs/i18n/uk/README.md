...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.195-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 413 406 рядків у 339 файлах |
| **Тестовий код (Lean LoC)** | 84 248 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 654 декларації theorem/lemma (нуль sorry/axiom) |
