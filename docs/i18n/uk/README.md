...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.58-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 385 041 рядок у 330 файлах |
| **Тестовий код (Lean LoC)** | 78 456 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 816 декларацій theorem/lemma (нуль sorry/axiom) |
