...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.184-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 409 214 рядків у 338 файлах |
| **Тестовий код (Lean LoC)** | 83 492 рядки у 70 тест-сьютах |
| **Доведені декларації** | 13 536 декларацій theorem/lemma (нуль sorry/axiom) |
