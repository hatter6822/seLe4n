...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.27-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 376 844 рядки у 330 файлах |
| **Тестовий код (Lean LoC)** | 76 173 рядки у 70 тест-сьютах |
