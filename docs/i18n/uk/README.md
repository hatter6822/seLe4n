...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.133-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 396 021 рядок у 334 файлах |
| **Тестовий код (Lean LoC)** | 80 339 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 127 декларацій theorem/lemma (нуль sorry/axiom) |
