...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.191-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 412 643 рядки у 339 файлах |
| **Тестовий код (Lean LoC)** | 83 880 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 638 декларацій theorem/lemma (нуль sorry/axiom) |
