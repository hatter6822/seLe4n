...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.129-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 359 285 рядків у 328 файлах |
| **Тестовий код (Lean LoC)** | 73 670 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 041 декларація theorem/lemma (нуль sorry/axiom) |
