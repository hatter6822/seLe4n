...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.125-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 395 341 рядок у 334 файлах |
| **Тестовий код (Lean LoC)** | 80 213 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 117 декларацій theorem/lemma (нуль sorry/axiom) |
