...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.95-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 346 230 рядків у 324 файлах |
| **Тестовий код (Lean LoC)** | 71 194 рядки у 70 тест-сьютах |
| **Доведені декларації** | 11 529 декларацій theorem/lemma (нуль sorry/axiom) |
