...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.177-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 406 667 рядків у 338 файлах |
| **Тестовий код (Lean LoC)** | 83 019 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 463 декларації theorem/lemma (нуль sorry/axiom) |
