...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.45-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 382 025 рядків у 330 файлах |
| **Тестовий код (Lean LoC)** | 77 280 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 741 декларація theorem/lemma (нуль sorry/axiom) |
