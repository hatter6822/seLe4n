...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.171-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 404 987 рядків у 336 файлах |
| **Тестовий код (Lean LoC)** | 82 900 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 424 декларації theorem/lemma (нуль sorry/axiom) |
