...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.100-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 391 981 рядок у 333 файлах |
| **Тестовий код (Lean LoC)** | 79 626 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 058 декларацій theorem/lemma (нуль sorry/axiom) |
