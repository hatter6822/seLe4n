...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.165-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 402 324 рядки у 334 файлах |
| **Тестовий код (Lean LoC)** | 82 280 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 333 декларації theorem/lemma (нуль sorry/axiom) |
