...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.65-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 385 852 рядки у 330 файлах |
| **Тестовий код (Lean LoC)** | 78 722 рядки у 70 тест-сьютах |
| **Доведені декларації** | 12 873 декларації theorem/lemma (нуль sorry/axiom) |
