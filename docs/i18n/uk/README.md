...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.53-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 383 950 рядків у 330 файлах |
| **Тестовий код (Lean LoC)** | 78 257 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 771 декларація theorem/lemma (нуль sorry/axiom) |
