...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.112-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 394 808 рядків у 333 файлах |
| **Тестовий код (Lean LoC)** | 80 213 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 115 декларацій theorem/lemma (нуль sorry/axiom) |
