...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.108-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 352 854 рядки у 327 файлах |
| **Тестовий код (Lean LoC)** | 71 412 рядків у 70 тест-сьютах |
| **Доведені декларації** | 11 788 декларацій theorem/lemma (нуль sorry/axiom) |
