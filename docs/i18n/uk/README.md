...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.116-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 355 345 рядків у 328 файлах |
| **Тестовий код (Lean LoC)** | 72 242 рядки у 70 тест-сьютах |
| **Доведені декларації** | 11 887 декларацій theorem/lemma (нуль sorry/axiom) |
