...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.10-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 375 003 рядки у 329 файлах |
| **Тестовий код (Lean LoC)** | 75 860 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 599 декларацій theorem/lemma (нуль sorry/axiom) |
