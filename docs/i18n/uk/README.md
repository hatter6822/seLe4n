...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.96-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 391 466 рядків у 333 файлах |
| **Тестовий код (Lean LoC)** | 79 392 рядки у 70 тест-сьютах |
| **Доведені декларації** | 13 046 декларацій theorem/lemma (нуль sorry/axiom) |
