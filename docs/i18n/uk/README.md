...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.36.3-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 421 705 рядків у 343 файлах |
| **Тестовий код (Lean LoC)** | 85 663 рядки у 71 тест-сьюті |
| **Доведені декларації** | 13 993 декларації theorem/lemma (нуль sorry/axiom) |
