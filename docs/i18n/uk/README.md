...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.90-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 342 776 рядків у 323 файлах |
| **Тестовий код (Lean LoC)** | 71 065 рядків у 70 тест-сьютах |
| **Доведені декларації** | 11 427 декларацій theorem/lemma (нуль sorry/axiom) |
