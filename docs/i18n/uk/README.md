...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.85-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 339 431 рядок у 317 файлах |
| **Тестовий код (Lean LoC)** | 70 566 рядків у 70 тест-сьютах |
| **Доведені декларації** | 11 287 декларацій theorem/lemma (нуль sorry/axiom) |
