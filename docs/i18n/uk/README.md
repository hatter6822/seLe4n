...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.105-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 392 459 рядків у 333 файлах |
| **Тестовий код (Lean LoC)** | 79 904 рядки у 70 тест-сьютах |
| **Доведені декларації** | 13 063 декларації theorem/lemma (нуль sorry/axiom) |
