...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.196-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 413 957 рядків у 339 файлах |
| **Тестовий код (Lean LoC)** | 84 404 рядки у 70 тест-сьютах |
| **Доведені декларації** | 13 674 декларації theorem/lemma (нуль sorry/axiom) |
