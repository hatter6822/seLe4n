...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.175-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 406 166 рядків у 338 файлах |
| **Тестовий код (Lean LoC)** | 83 005 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 448 декларацій theorem/lemma (нуль sorry/axiom) |
