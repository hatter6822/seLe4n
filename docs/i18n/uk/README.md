...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.203-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 417 409 рядків у 340 файлах |
| **Тестовий код (Lean LoC)** | 84 545 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 810 декларацій theorem/lemma (нуль sorry/axiom) |
