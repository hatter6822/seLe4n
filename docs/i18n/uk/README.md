...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.138-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 361 390 рядків у 328 файлах |
| **Тестовий код (Lean LoC)** | 74 100 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 090 декларацій theorem/lemma (нуль sorry/axiom) |
