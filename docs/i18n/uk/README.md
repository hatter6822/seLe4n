...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.106-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 393 612 рядків у 333 файлах |
| **Тестовий код (Lean LoC)** | 79 985 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 082 декларації theorem/lemma (нуль sorry/axiom) |
