...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.124-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 395 008 рядків у 334 файлах |
| **Тестовий код (Lean LoC)** | 80 213 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 116 декларацій theorem/lemma (нуль sorry/axiom) |
