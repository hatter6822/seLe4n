...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.82-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 387 402 рядки у 331 файлі |
| **Тестовий код (Lean LoC)** | 78 892 рядки у 70 тест-сьютах |
| **Доведені декларації** | 12 917 декларацій theorem/lemma (нуль sorry/axiom) |
