...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.62-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 385 405 рядків у 330 файлах |
| **Тестовий код (Lean LoC)** | 78 723 рядки у 70 тест-сьютах |
| **Доведені декларації** | 12 823 декларації theorem/lemma (нуль sorry/axiom) |
