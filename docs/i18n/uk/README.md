...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.119-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 355 799 рядків у 328 файлах |
| **Тестовий код (Lean LoC)** | 72 662 рядки у 70 тест-сьютах |
