...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.182-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 408 352 рядки у 338 файлах |
| **Тестовий код (Lean LoC)** | 83 391 рядок у 70 тест-сьютах |
| **Доведені декларації** | 13 510 декларацій theorem/lemma (нуль sorry/axiom) |
