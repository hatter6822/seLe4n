...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.146-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 396 557 рядків у 334 файлах |
| **Тестовий код (Lean LoC)** | 80 877 рядків у 70 тест-сьютах |
