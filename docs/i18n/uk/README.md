...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.48-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 381 980 рядків у 330 файлах |
| **Тестовий код (Lean LoC)** | 77 688 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 734 декларації theorem/lemma (нуль sorry/axiom) |
