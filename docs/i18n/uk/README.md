...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.11-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 375 100 рядків у 329 файлах |
| **Тестовий код (Lean LoC)** | 75 860 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 605 декларацій theorem/lemma (нуль sorry/axiom) |
