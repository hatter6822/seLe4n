...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.90-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 389 382 рядки у 332 файлах |
| **Тестовий код (Lean LoC)** | 79 141 рядок у 70 тест-сьютах |
| **Доведені декларації** | 12 989 декларацій theorem/lemma (нуль sorry/axiom) |
