...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.7-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 374 685 рядків у 329 файлах |
| **Тестовий код (Lean LoC)** | 75 813 рядків у 70 тест-сьютах |
| **Доведені декларації** | 12 593 декларації theorem/lemma (нуль sorry/axiom) |
