...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.88-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 340 168 рядків у 317 файлах |
| **Тестовий код (Lean LoC)** | 70 817 рядків у 70 тест-сьютах |
| **Доведені декларації** | 11 316 декларацій theorem/lemma (нуль sorry/axiom) |
