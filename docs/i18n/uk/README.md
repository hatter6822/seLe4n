...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.86-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 339 955 рядків у 317 файлах |
| **Тестовий код (Lean LoC)** | 70 646 рядків у 70 тест-сьютах |
| **Доведені декларації** | 11 305 декларацій theorem/lemma (нуль sorry/axiom) |
