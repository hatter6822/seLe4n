...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.35.188-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 410 635 рядків у 338 файлах |
| **Тестовий код (Lean LoC)** | 83 589 рядків у 70 тест-сьютах |
| **Доведені декларації** | 13 584 декларації theorem/lemma (нуль sorry/axiom) |
