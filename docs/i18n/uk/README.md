...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.34.103-blue" alt="Версія" />
...
| **Продуктовий код (Lean LoC)** | 349 806 рядків у 327 файлах |
| **Тестовий код (Lean LoC)** | 71 289 рядків у 70 тест-сьютах |
| **Доведені декларації** | 11 680 декларацій theorem/lemma (нуль sorry/axiom) |
