...
| **أسطر Lean الإنتاجية** | 376,395 عبر 330 ملفًا |
| **أسطر Lean للاختبارات** | 76,029 عبر 70 مجموعة اختبار |
| **الإعلانات المُبرهَنة** | 12,607 إعلانات theorem/lemma (صفر sorry/axiom) |
