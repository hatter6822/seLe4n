...
| **أسطر Lean الإنتاجية** | 57,506 عبر 100 ملف |
| **أسطر Lean الاختبارية** | 7,559 عبر 10 حزم اختبار |
| **التصريحات المُبرهَنة** | 1,756 تصريح theorem/lemma (بدون أي sorry/axiom) |
| **العتاد المستهدف** | Raspberry Pi 5 (BCM2712 / ARM Cortex-A76 / ARMv8-A) |
| **أحدث تدقيق** | [`AUDIT_COMPREHENSIVE_v0.18.7_PRE_BENCHMARK.md`](../../../docs/audits/AUDIT_COMPREHENSIVE_v0.18.7_PRE_BENCHMARK.md) و [`AUDIT_COMPREHENSIVE_v0.18.7_KERNEL_RUST.md`](../../../docs/audits/AUDIT_COMPREHENSIVE_v0.18.7_KERNEL_RUST.md) — تدقيق مزدوج شامل (أكثر من 115 نتيجة، 0 حرجة) |
...
- **WS-S** — تعزيز ما قبل المقارنة المعيارية (Pre-Benchmark Strengthening) — 7 مراحل (S1–S7، 83 مهمة فرعية) **مكتمل** (v0.19.0–v0.19.6). يعالج جميع نتائج التدقيق المزدوج الشامل v0.18.7 (أكثر من 115 نتيجة). الخطة: [`AUDIT_v0.18.7_WORKSTREAM_PLAN.md`](../../../docs/audits/AUDIT_v0.18.7_WORKSTREAM_PLAN.md). تقرير الإغلاق: [`WS_S_CLOSURE_REPORT.md`](../../../docs/audits/WS_S_CLOSURE_REPORT.md).
- **WS-R** — معالجة شاملة لنتائج التدقيق (Comprehensive Audit Remediation) — 8 مراحل (R1–R8، 111 مهمة فرعية) **مكتمل** (v0.18.0–v0.18.7). الخطة: [`AUDIT_v0.17.14_WORKSTREAM_PLAN.md`](../../../docs/dev_history/audits/AUDIT_v0.17.14_WORKSTREAM_PLAN.md).
- **ربط عتاد Raspberry Pi 5** — تجول جداول صفحات ARMv8 (page table walk)، وتوجيه مقاطعات GIC-400 (interrupt routing)، وتسلسل الإقلاع (boot sequence) — (تيار العمل التالي)

<div dir="rtl">

جميع الحافظات السابقة (WS-B حتى WS-R) مكتملة. التدقيقات السابقة (v0.8.0–v0.9.32)، وإغلاقات المعالم، وفصول GitBook القديمة مؤرشفة في
