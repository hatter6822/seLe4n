...
| **أسطر Lean الإنتاجية** | 64,229 عبر 100 ملفًا |
| **أسطر Lean الاختبارية** | 8,316 عبر 10 حزم اختبار |
| **التصريحات المُبرهَنة** | 1,878 تصريح theorem/lemma (بدون أي sorry/axiom) |
