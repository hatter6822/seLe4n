...
| **أسطر Lean الإنتاجية** | 60,116 عبر 100 ملفًا |
| **أسطر Lean الاختبارية** | 7,561 عبر 10 حزم اختبار |
| **التصريحات المُبرهَنة** | 1,812 تصريح theorem/lemma (بدون أي sorry/axiom) |
