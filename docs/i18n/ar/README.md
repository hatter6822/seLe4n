...
| **أسطر Lean الإنتاجية** | 417,397 عبر 340 ملفًا |
| **أسطر Lean للاختبارات** | 84,404 عبر 70 مجموعة اختبار |
| **الإعلانات المُبرهَنة** | 13,805 إعلانات theorem/lemma (صفر sorry/axiom) |
