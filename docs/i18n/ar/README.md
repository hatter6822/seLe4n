...
| **أسطر Lean الإنتاجية** | 361,976 عبر 328 ملفًا |
| **أسطر Lean للاختبارات** | 74,275 عبر 70 مجموعة اختبار |
| **الإعلانات المُبرهَنة** | 12,106 إعلانات theorem/lemma (صفر sorry/axiom) |
