...
| **أسطر Lean الإنتاجية** | 72,569 عبر 103 ملفًا |
| **أسطر Lean الاختبارية** | 8,437 عبر 10 حزم اختبار |
| **التصريحات المُبرهَنة** | 2,138 تصريح theorem/lemma (بدون أي sorry/axiom) |
