...
| **أسطر Lean الإنتاجية** | 386,493 عبر 331 ملفًا |
| **أسطر Lean للاختبارات** | 78,776 عبر 70 مجموعة اختبار |
| **الإعلانات المُبرهَنة** | 12,909 إعلانات theorem/lemma (صفر sorry/axiom) |
