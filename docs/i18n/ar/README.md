...
| **أسطر Lean الإنتاجية** | 339,955 عبر 317 ملفًا |
| **أسطر Lean للاختبارات** | 70,722 عبر 70 مجموعة اختبار |
| **الإعلانات المُبرهَنة** | 11,305 إعلانات theorem/lemma (صفر sorry/axiom) |
