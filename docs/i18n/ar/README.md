...
| **أسطر Lean الإنتاجية** | 380,540 عبر 330 ملفًا |
| **أسطر Lean للاختبارات** | 77,224 عبر 70 مجموعة اختبار |
| **الإعلانات المُبرهَنة** | 12,706 إعلانات theorem/lemma (صفر sorry/axiom) |
