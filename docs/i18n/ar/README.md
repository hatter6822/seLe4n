...
| **أسطر Lean الإنتاجية** | 408,061 عبر 338 ملفًا |
| **أسطر Lean للاختبارات** | 83,207 عبر 70 مجموعة اختبار |
| **الإعلانات المُبرهَنة** | 13,504 إعلانات theorem/lemma (صفر sorry/axiom) |
