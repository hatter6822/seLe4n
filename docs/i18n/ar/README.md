...
| **أسطر Lean الإنتاجية** | 408,352 عبر 338 ملفًا |
| **أسطر Lean للاختبارات** | 83,391 عبر 70 مجموعة اختبار |
| **الإعلانات المُبرهَنة** | 13,510 إعلانات theorem/lemma (صفر sorry/axiom) |
