...
| **التدقيق القياسي** | [`AUDIT_v0.29.0_COMPREHENSIVE`](../../../docs/audits/AUDIT_v0.29.0_COMPREHENSIVE.md) — تدقيق شامل ما قبل الإصدار 1.0 (202 نتيجة؛ تمت المعالجة بواسطة WS-AK AK1–AK10) |
| **آخر تدقيق** | [`AUDIT_v0.30.6_COMPREHENSIVE`](../../../docs/audits/AUDIT_v0.30.6_COMPREHENSIVE.md) — تدقيق التصلّب ما قبل الإصدار 1.0 (3 CRIT، 24 HIGH، 71 MED، 58 LOW، 40 INFO — التقييم الأولي وفق §0.4) |
