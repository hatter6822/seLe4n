...
| **أسطر Lean الإنتاجية** | 376,503 عبر 330 ملفًا |
| **أسطر Lean للاختبارات** | 76,048 عبر 70 مجموعة اختبار |
| **الإعلانات المُبرهَنة** | 12,610 إعلانات theorem/lemma (صفر sorry/axiom) |
