...
| **أسطر Lean الإنتاجية** | 380,449 عبر 330 ملفًا |
| **أسطر Lean للاختبارات** | 77,140 عبر 70 مجموعة اختبار |
| **الإعلانات المُبرهَنة** | 12,704 إعلانات theorem/lemma (صفر sorry/axiom) |
