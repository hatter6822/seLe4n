...
| **أسطر Lean الإنتاجية** | 64,824 عبر 101 ملفًا |
| **أسطر Lean الاختبارية** | 8,322 عبر 10 حزم اختبار |
| **التصريحات المُبرهَنة** | 1,922 تصريح theorem/lemma (بدون أي sorry/axiom) |
