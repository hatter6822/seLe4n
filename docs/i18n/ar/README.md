...
| **أسطر Lean الاختبارية** | 10,564 عبر 15 حزمة اختبار |
| **التصريحات المُبرهَنة** | 2,447 تصريح theorem/lemma (بدون أي sorry/axiom) |
| **العتاد المستهدف** | Raspberry Pi 5 (BCM2712 / ARM Cortex-A76 / ARMv8-A) |
| **أحدث تدقيق** | [`AUDIT_COMPREHENSIVE_v0.23.21`](../../../docs/audits/AUDIT_COMPREHENSIVE_v0.23.21_LEAN_RUST_KERNEL.md) — تدقيق شامل للنواة Lean + Rust (0 CRIT، 5 HIGH، 8 MED، 30 LOW) |
