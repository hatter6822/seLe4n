...
| **أسطر Lean الإنتاجية** | 61,538 عبر 101 ملفًا |
| **أسطر Lean الاختبارية** | 8,256 عبر 10 حزم اختبار |
| **التصريحات المُبرهَنة** | 1,846 تصريح theorem/lemma (بدون أي sorry/axiom) |
