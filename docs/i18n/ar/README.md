...
| **أسطر Lean الإنتاجية** | 64,039 عبر 101 ملفًا |
| **أسطر Lean الاختبارية** | 8,318 عبر 10 حزم اختبار |
| **التصريحات المُبرهَنة** | 1,901 تصريح theorem/lemma (بدون أي sorry/axiom) |
