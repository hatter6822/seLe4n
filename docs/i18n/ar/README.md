...
| **أسطر Lean الإنتاجية** | 399,198 عبر 334 ملفًا |
| **أسطر Lean للاختبارات** | 81,487 عبر 70 مجموعة اختبار |
| **الإعلانات المُبرهَنة** | 13,210 إعلانات theorem/lemma (صفر sorry/axiom) |
