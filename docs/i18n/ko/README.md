...
| **정식 감사** | [`AUDIT_v0.29.0_COMPREHENSIVE`](../../../docs/audits/AUDIT_v0.29.0_COMPREHENSIVE.md) — 1.0 이전 종합 감사 (202건 발견; WS-AK AK1–AK10 으로 해결됨) |
| **최신 감사** | [`AUDIT_v0.30.6_COMPREHENSIVE`](../../../docs/audits/AUDIT_v0.30.6_COMPREHENSIVE.md) — 1.0 이전 하드닝 감사 (3 CRIT, 24 HIGH, 71 MED, 58 LOW, 40 INFO — §0.4 의 초기 채점) |
