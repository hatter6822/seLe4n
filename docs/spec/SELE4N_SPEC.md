...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.21.0` (`lakefile.toml`) |
...
| **Active workstream** | **WS-U Phase U1 COMPLETE** — Correctness Fixes (13 sub-tasks, U1-A–U1-M, v0.21.0). Addresses 7 findings (U-H01–U-H04, U-H13, U-H14, U-M39). Plan: [`AUDIT_v0.20.7_WORKSTREAM_PLAN.md`](../audits/AUDIT_v0.20.7_WORKSTREAM_PLAN.md). Prior portfolios: WS-T (v0.20.0–v0.20.7), WS-S–WS-B — all COMPLETE. |
