...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.51` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 159,556 across 224 Lean files |
| **Test LoC** | 35,298 across 54 Lean test suites |
| **Proved declarations** | 5,189 theorem/lemma declarations (zero sorry/axiom) |
