...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.12` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 263,572 across 278 Lean files |
| **Test LoC** | 55,087 across 68 Lean test suites |
| **Proved declarations** | 8,827 theorem/lemma declarations (zero sorry/axiom) |
