...
2. machine-checked invariant preservation (1,198 theorem/lemma declarations),
...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.16.11` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 37,866 across 69 Lean files |
| **Test LoC** | 4,098 across 4 Lean test suites |
| **Proved declarations** | 1,216 theorem/lemma declarations (zero sorry/axiom) |
