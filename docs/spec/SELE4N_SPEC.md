...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.88` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 285,378 across 285 Lean files |
| **Test LoC** | 62,995 across 69 Lean test suites |
| **Proved declarations** | 9,573 theorem/lemma declarations (zero sorry/axiom) |
