...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.69` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 177,230 across 243 Lean files |
| **Test LoC** | 38,305 across 60 Lean test suites |
| **Proved declarations** | 5,927 theorem/lemma declarations (zero sorry/axiom) |
