...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.160` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 187,211 across 251 Lean files |
| **Test LoC** | 39,822 across 61 Lean test suites |
| **Proved declarations** | 6,171 theorem/lemma declarations (zero sorry/axiom) |
