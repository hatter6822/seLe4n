...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.35.28` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 377,183 across 330 Lean files |
| **Test LoC** | 76,360 across 70 Lean test suites |
| **Proved declarations** | 12,621 theorem/lemma declarations (zero sorry/axiom) |
