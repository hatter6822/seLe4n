...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.21` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 143,114 across 202 Lean files |
| **Test LoC** | 30,970 across 46 Lean test suites |
| **Proved declarations** | 4,409 theorem/lemma declarations (zero sorry/axiom) |
