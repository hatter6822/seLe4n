...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.187` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 196,188 across 251 Lean files |
| **Test LoC** | 39,824 across 61 Lean test suites |
| **Proved declarations** | 6,387 theorem/lemma declarations (zero sorry/axiom) |
