...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.180` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 194,602 across 251 Lean files |
| **Test LoC** | 39,824 across 61 Lean test suites |
| **Proved declarations** | 6,349 theorem/lemma declarations (zero sorry/axiom) |
