...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.67` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 221,821 across 256 Lean files |
| **Test LoC** | 42,771 across 64 Lean test suites |
