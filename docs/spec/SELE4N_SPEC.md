...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.35.86` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 389,153 across 332 Lean files |
| **Test LoC** | 79,007 across 70 Lean test suites |
| **Proved declarations** | 12,967 theorem/lemma declarations (zero sorry/axiom) |
