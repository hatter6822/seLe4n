...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.57` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 331,301 across 311 Lean files |
| **Test LoC** | 68,907 across 70 Lean test suites |
| **Proved declarations** | 11,023 theorem/lemma declarations (zero sorry/axiom) |
