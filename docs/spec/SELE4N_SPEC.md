...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.8` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 259,720 across 277 Lean files |
| **Test LoC** | 53,663 across 68 Lean test suites |
| **Proved declarations** | 8,668 theorem/lemma declarations (zero sorry/axiom) |
...
Not yet covered: information flow under fine locks.  That is WS-SM SM8.D; see
[`docs/planning/SMP_INFORMATION_FLOW_PLAN.md`](../planning/SMP_INFORMATION_FLOW_PLAN.md).
