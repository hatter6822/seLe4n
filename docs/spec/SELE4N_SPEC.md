...
| **Production LoC** | 302,262 across 296 Lean files |
| **Test LoC** | 65,182 across 69 Lean test suites |
| **Proved declarations** | 10,041 theorem/lemma declarations (zero sorry/axiom) |
...
bound on a post-state across all sixty-five statements in the family (the
