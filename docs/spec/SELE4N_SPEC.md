...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.86` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 339,955 across 317 Lean files |
| **Test LoC** | 70,646 across 70 Lean test suites |
| **Proved declarations** | 11,305 theorem/lemma declarations (zero sorry/axiom) |
