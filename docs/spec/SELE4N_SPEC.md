...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.54` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 161,631 across 226 Lean files |
| **Test LoC** | 35,847 across 55 Lean test suites |
| **Proved declarations** | 5,290 theorem/lemma declarations (zero sorry/axiom) |
