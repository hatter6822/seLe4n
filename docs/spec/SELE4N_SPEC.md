...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.63` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 172,493 across 233 Lean files |
| **Test LoC** | 37,344 across 58 Lean test suites |
| **Proved declarations** | 5,778 theorem/lemma declarations (zero sorry/axiom) |
