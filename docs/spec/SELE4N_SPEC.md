...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.75` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 283,662 across 285 Lean files |
| **Test LoC** | 62,116 across 69 Lean test suites |
| **Proved declarations** | 9,544 theorem/lemma declarations (zero sorry/axiom) |
