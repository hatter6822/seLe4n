...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.95` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 286,338 across 286 Lean files |
| **Test LoC** | 63,253 across 69 Lean test suites |
| **Proved declarations** | 9,599 theorem/lemma declarations (zero sorry/axiom) |
