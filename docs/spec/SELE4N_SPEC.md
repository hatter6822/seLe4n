...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.68` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 176,659 across 242 Lean files |
| **Test LoC** | 38,247 across 60 Lean test suites |
| **Proved declarations** | 5,911 theorem/lemma declarations (zero sorry/axiom) |
