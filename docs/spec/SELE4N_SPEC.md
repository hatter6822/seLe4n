...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.85` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 229,664 across 262 Lean files |
| **Test LoC** | 45,510 across 65 Lean test suites |
| **Proved declarations** | 7,424 theorem/lemma declarations (zero sorry/axiom) |
