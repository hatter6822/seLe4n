...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.1` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 287,770 across 287 Lean files |
| **Test LoC** | 64,260 across 69 Lean test suites |
| **Proved declarations** | 9,638 theorem/lemma declarations (zero sorry/axiom) |
