...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.159` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 187,115 across 251 Lean files |
| **Test LoC** | 39,822 across 61 Lean test suites |
| **Proved declarations** | 6,169 theorem/lemma declarations (zero sorry/axiom) |
