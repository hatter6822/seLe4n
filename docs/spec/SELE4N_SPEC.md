...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.150` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 239,148 across 266 Lean files |
| **Test LoC** | 48,581 across 67 Lean test suites |
| **Proved declarations** | 7,827 theorem/lemma declarations (zero sorry/axiom) |
