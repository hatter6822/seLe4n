...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.136` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 361,146 across 328 Lean files |
| **Test LoC** | 74,027 across 70 Lean test suites |
| **Proved declarations** | 12,084 theorem/lemma declarations (zero sorry/axiom) |
