...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.135` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 360,920 across 328 Lean files |
| **Test LoC** | 73,943 across 70 Lean test suites |
| **Proved declarations** | 12,076 theorem/lemma declarations (zero sorry/axiom) |
