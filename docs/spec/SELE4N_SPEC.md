...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.113` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 237,487 across 264 Lean files |
| **Test LoC** | 48,375 across 67 Lean test suites |
| **Proved declarations** | 7,768 theorem/lemma declarations (zero sorry/axiom) |
