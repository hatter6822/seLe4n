...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.42` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 154,426 across 217 Lean files |
| **Test LoC** | 33,862 across 51 Lean test suites |
| **Proved declarations** | 4,943 theorem/lemma declarations (zero sorry/axiom) |
