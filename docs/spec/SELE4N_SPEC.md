...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.43` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 154,404 across 216 Lean files |
| **Test LoC** | 33,886 across 51 Lean test suites |
| **Proved declarations** | 4,942 theorem/lemma declarations (zero sorry/axiom) |
