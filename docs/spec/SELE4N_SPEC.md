...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.53` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 281,241 across 285 Lean files |
| **Test LoC** | 61,303 across 69 Lean test suites |
| **Proved declarations** | 9,486 theorem/lemma declarations (zero sorry/axiom) |
