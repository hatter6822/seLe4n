...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.70` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 177,969 across 246 Lean files |
| **Test LoC** | 38,406 across 60 Lean test suites |
| **Proved declarations** | 5,944 theorem/lemma declarations (zero sorry/axiom) |
