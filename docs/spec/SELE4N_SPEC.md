...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.103` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 349,806 across 327 Lean files |
| **Test LoC** | 71,289 across 70 Lean test suites |
| **Proved declarations** | 11,680 theorem/lemma declarations (zero sorry/axiom) |
