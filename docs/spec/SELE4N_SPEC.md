...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.14` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 141,349 across 201 Lean files |
| **Test LoC** | 30,463 across 45 Lean test suites |
| **Proved declarations** | 4,299 theorem/lemma declarations (zero sorry/axiom) |
