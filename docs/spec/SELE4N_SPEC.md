...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.134` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 360,710 across 328 Lean files |
| **Test LoC** | 73,857 across 70 Lean test suites |
| **Proved declarations** | 12,070 theorem/lemma declarations (zero sorry/axiom) |
