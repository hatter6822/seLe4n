...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.35.85` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 388,275 across 332 Lean files |
| **Test LoC** | 78,892 across 70 Lean test suites |
| **Proved declarations** | 12,931 theorem/lemma declarations (zero sorry/axiom) |
