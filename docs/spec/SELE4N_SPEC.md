...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.46` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 271,003 across 280 Lean files |
| **Test LoC** | 58,209 across 69 Lean test suites |
| **Proved declarations** | 9,105 theorem/lemma declarations (zero sorry/axiom) |
