...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.17` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 142,296 across 202 Lean files |
| **Test LoC** | 30,913 across 46 Lean test suites |
| **Proved declarations** | 4,359 theorem/lemma declarations (zero sorry/axiom) |
