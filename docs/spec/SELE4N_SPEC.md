...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.79` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 284,096 across 285 Lean files |
| **Test LoC** | 62,306 across 69 Lean test suites |
| **Proved declarations** | 9,552 theorem/lemma declarations (zero sorry/axiom) |
