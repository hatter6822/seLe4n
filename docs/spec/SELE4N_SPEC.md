...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.137` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 361,351 across 328 Lean files |
| **Test LoC** | 74,073 across 70 Lean test suites |
| **Proved declarations** | 12,089 theorem/lemma declarations (zero sorry/axiom) |
