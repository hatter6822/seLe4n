...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.49` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 155,916 across 220 Lean files |
| **Test LoC** | 34,312 across 52 Lean test suites |
| **Proved declarations** | 5,014 theorem/lemma declarations (zero sorry/axiom) |
