...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.35.125` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 395,341 across 334 Lean files |
| **Test LoC** | 80,213 across 70 Lean test suites |
| **Proved declarations** | 13,117 theorem/lemma declarations (zero sorry/axiom) |
