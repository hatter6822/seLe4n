...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.91` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 342,838 across 323 Lean files |
| **Test LoC** | 71,065 across 70 Lean test suites |
| **Proved declarations** | 11,429 theorem/lemma declarations (zero sorry/axiom) |
