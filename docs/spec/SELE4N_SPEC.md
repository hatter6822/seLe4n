...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.77` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 227,760 across 261 Lean files |
| **Test LoC** | 45,085 across 65 Lean test suites |
| **Proved declarations** | 7,324 theorem/lemma declarations (zero sorry/axiom) |
