...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.48` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 155,901 across 220 Lean files |
| **Test LoC** | 34,297 across 52 Lean test suites |
| **Proved declarations** | 5,006 theorem/lemma declarations (zero sorry/axiom) |
