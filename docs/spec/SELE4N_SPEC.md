...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.74` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 338,946 across 316 Lean files |
| **Test LoC** | 70,292 across 70 Lean test suites |
| **Proved declarations** | 11,265 theorem/lemma declarations (zero sorry/axiom) |
