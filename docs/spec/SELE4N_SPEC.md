...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.38` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 147,335 across 210 Lean files |
| **Test LoC** | 32,133 across 48 Lean test suites |
| **Proved declarations** | 4,655 theorem/lemma declarations (zero sorry/axiom) |
