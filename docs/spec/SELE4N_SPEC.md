...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.95` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 346,230 across 324 Lean files |
| **Test LoC** | 71,194 across 70 Lean test suites |
| **Proved declarations** | 11,529 theorem/lemma declarations (zero sorry/axiom) |
...
bound on a post-state across all **164** statements in the family (the
