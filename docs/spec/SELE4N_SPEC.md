...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.72` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 222,555 across 257 Lean files |
| **Test LoC** | 43,930 across 65 Lean test suites |
| **Proved declarations** | 7,110 theorem/lemma declarations (zero sorry/axiom) |
