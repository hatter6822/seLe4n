...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.55` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 209,137 across 251 Lean files |
| **Test LoC** | 39,857 across 61 Lean test suites |
| **Proved declarations** | 6,670 theorem/lemma declarations (zero sorry/axiom) |
