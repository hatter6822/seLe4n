...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.42` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 270,177 across 280 Lean files |
| **Test LoC** | 57,884 across 69 Lean test suites |
| **Proved declarations** | 9,073 theorem/lemma declarations (zero sorry/axiom) |
