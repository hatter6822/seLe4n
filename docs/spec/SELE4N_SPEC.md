...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.57` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 211,815 across 251 Lean files |
| **Test LoC** | 39,955 across 61 Lean test suites |
| **Proved declarations** | 6,711 theorem/lemma declarations (zero sorry/axiom) |
