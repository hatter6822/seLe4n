...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.76` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 225,989 across 261 Lean files |
| **Test LoC** | 44,777 across 65 Lean test suites |
| **Proved declarations** | 7,243 theorem/lemma declarations (zero sorry/axiom) |
