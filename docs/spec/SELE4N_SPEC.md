...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.21` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 264,956 across 278 Lean files |
| **Test LoC** | 55,347 across 68 Lean test suites |
| **Proved declarations** | 8,861 theorem/lemma declarations (zero sorry/axiom) |
