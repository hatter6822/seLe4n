...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.35.58` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 385,041 across 330 Lean files |
| **Test LoC** | 78,456 across 70 Lean test suites |
| **Proved declarations** | 12,816 theorem/lemma declarations (zero sorry/axiom) |
