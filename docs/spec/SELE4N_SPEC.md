...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.81` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 284,480 across 285 Lean files |
| **Test LoC** | 62,513 across 69 Lean test suites |
| **Proved declarations** | 9,562 theorem/lemma declarations (zero sorry/axiom) |
