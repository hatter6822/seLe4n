...
| **Production LoC** | 138,880 across 200 Lean files |
| **Test LoC** | 29,318 across 42 Lean test suites |
| **Proved declarations** | 4,128 theorem/lemma declarations (zero sorry/axiom) |
...
2.12. **WS-SM Phase SM3.E (post-SM3.D) serializability, conflict-graph
   ...
   **every interleaved execution of kernel transitions under strict
   ...
   - **SM3.E.7/E.8 — tests**: `tests/SerializabilitySuite.lean`
     ...
     witnesses + 23 runtime assertions) + 8 major-theorem `#check`
