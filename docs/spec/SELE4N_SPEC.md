...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.13` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 263,865 across 278 Lean files |
| **Test LoC** | 55,141 across 68 Lean test suites |
| **Proved declarations** | 8,837 theorem/lemma declarations (zero sorry/axiom) |
