...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.66` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 282,699 across 285 Lean files |
| **Test LoC** | 61,942 across 69 Lean test suites |
| **Proved declarations** | 9,515 theorem/lemma declarations (zero sorry/axiom) |
