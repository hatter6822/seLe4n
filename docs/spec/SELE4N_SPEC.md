...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.64` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 282,646 across 285 Lean files |
| **Test LoC** | 61,893 across 69 Lean test suites |
| **Proved declarations** | 9,516 theorem/lemma declarations (zero sorry/axiom) |
