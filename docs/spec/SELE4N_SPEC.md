...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.15` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 264,237 across 278 Lean files |
| **Test LoC** | 55,270 across 68 Lean test suites |
| **Proved declarations** | 8,846 theorem/lemma declarations (zero sorry/axiom) |
