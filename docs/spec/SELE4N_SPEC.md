...
| **Production LoC** | 254,997 across 274 Lean files |
| **Test LoC** | 52,297 across 68 Lean test suites |
| **Proved declarations** | 8,486 theorem/lemma declarations (zero sorry/axiom) |
...
> instantiation, taking the cross-core inventory to twenty-one (fourteen live arms); the live `.call` arm
