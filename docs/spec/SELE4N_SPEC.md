...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.98` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 234,965 across 264 Lean files |
| **Test LoC** | 47,133 across 67 Lean test suites |
| **Proved declarations** | 7,643 theorem/lemma declarations (zero sorry/axiom) |
