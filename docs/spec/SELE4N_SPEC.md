...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.56` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 209,226 across 251 Lean files |
| **Test LoC** | 39,857 across 61 Lean test suites |
| **Proved declarations** | 6,672 theorem/lemma declarations (zero sorry/axiom) |
