...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.35.51` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 383,641 across 330 Lean files |
| **Test LoC** | 77,948 across 70 Lean test suites |
| **Proved declarations** | 12,767 theorem/lemma declarations (zero sorry/axiom) |
