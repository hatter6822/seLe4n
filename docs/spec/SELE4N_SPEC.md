...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.44` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 154,450 across 216 Lean files |
| **Test LoC** | 33,887 across 51 Lean test suites |
