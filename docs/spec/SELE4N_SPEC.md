...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.82` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 284,783 across 285 Lean files |
| **Test LoC** | 62,605 across 69 Lean test suites |
| **Proved declarations** | 9,566 theorem/lemma declarations (zero sorry/axiom) |
