...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.50` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 158,441 across 222 Lean files |
| **Test LoC** | 34,847 across 53 Lean test suites |
| **Proved declarations** | 5,134 theorem/lemma declarations (zero sorry/axiom) |
