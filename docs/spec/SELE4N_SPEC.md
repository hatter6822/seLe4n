...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.53` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 160,330 across 224 Lean files |
| **Test LoC** | 35,484 across 54 Lean test suites |
| **Proved declarations** | 5,226 theorem/lemma declarations (zero sorry/axiom) |
