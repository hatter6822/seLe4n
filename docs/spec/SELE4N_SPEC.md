...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.39` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 266,601 across 279 Lean files |
| **Test LoC** | 56,557 across 69 Lean test suites |
| **Proved declarations** | 8,931 theorem/lemma declarations (zero sorry/axiom) |
