...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.62` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 221,127 across 256 Lean files |
| **Test LoC** | 41,213 across 62 Lean test suites |
| **Proved declarations** | 7,048 theorem/lemma declarations (zero sorry/axiom) |
