...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.39` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 148,034 across 210 Lean files |
| **Test LoC** | 32,285 across 48 Lean test suites |
| **Proved declarations** | 4,688 theorem/lemma declarations (zero sorry/axiom) |
