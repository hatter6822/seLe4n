...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.104` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 351,182 across 327 Lean files |
| **Test LoC** | 71,319 across 70 Lean test suites |
| **Proved declarations** | 11,729 theorem/lemma declarations (zero sorry/axiom) |
