...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.61` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 282,349 across 285 Lean files |
| **Test LoC** | 61,792 across 69 Lean test suites |
| **Proved declarations** | 9,512 theorem/lemma declarations (zero sorry/axiom) |
