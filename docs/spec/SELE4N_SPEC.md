...
2. machine-checked invariant preservation (1,922 theorem/lemma declarations),
...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.21.6` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 64,824 across 101 Lean files |
| **Test LoC** | 8,322 across 10 Lean test suites |
...
| **Active workstream** | **WS-U Phase U7 COMPLETE** — Dead Code & Proof Hygiene (v0.21.6). Plan: [`AUDIT_v0.20.7_WORKSTREAM_PLAN.md`](../audits/AUDIT_v0.20.7_WORKSTREAM_PLAN.md). Prior: WS-U U6 (v0.21.5), WS-U U5 (v0.21.4), WS-U U4 (v0.21.3), WS-U U3 (v0.21.2), WS-U U2 (v0.21.1), WS-U U1 (v0.21.0), WS-T (v0.20.0–v0.20.7), WS-S–WS-B — all COMPLETE. |
