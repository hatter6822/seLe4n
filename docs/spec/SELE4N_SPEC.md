...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.35.23` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 376,503 across 330 Lean files |
| **Test LoC** | 76,048 across 70 Lean test suites |
| **Proved declarations** | 12,610 theorem/lemma declarations (zero sorry/axiom) |
