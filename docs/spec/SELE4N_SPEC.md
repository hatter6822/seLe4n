...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.32` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 145,518 across 208 Lean files |
| **Test LoC** | 31,701 across 47 Lean test suites |
| **Proved declarations** | 4,586 theorem/lemma declarations (zero sorry/axiom) |
