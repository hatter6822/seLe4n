...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.55` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 162,945 across 226 Lean files |
| **Test LoC** | 36,023 across 55 Lean test suites |
| **Proved declarations** | 5,346 theorem/lemma declarations (zero sorry/axiom) |
