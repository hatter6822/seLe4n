...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.83` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 339,301 across 317 Lean files |
| **Test LoC** | 70,565 across 70 Lean test suites |
| **Proved declarations** | 11,285 theorem/lemma declarations (zero sorry/axiom) |
