...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.94` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 344,934 across 324 Lean files |
| **Test LoC** | 71,128 across 70 Lean test suites |
| **Proved declarations** | 11,490 theorem/lemma declarations (zero sorry/axiom) |
