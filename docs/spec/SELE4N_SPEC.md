...
| **Production LoC** | 308,949 across 298 Lean files |
| **Test LoC** | 65,220 across 69 Lean test suites |
| **Proved declarations** | 10,237 theorem/lemma declarations (zero sorry/axiom) |
...
bound on a post-state across all **144** statements in the family (the
...
surface they compose) carry the bundle across the whole dispatcher.  The
