...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.52` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 277,642 across 283 Lean files |
| **Test LoC** | 60,038 across 69 Lean test suites |
| **Proved declarations** | 9,330 theorem/lemma declarations (zero sorry/axiom) |
