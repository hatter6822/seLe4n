...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.92` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 285,975 across 286 Lean files |
| **Test LoC** | 63,087 across 69 Lean test suites |
| **Proved declarations** | 9,578 theorem/lemma declarations (zero sorry/axiom) |
