...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.78` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 227,941 across 261 Lean files |
| **Test LoC** | 45,137 across 65 Lean test suites |
| **Proved declarations** | 7,332 theorem/lemma declarations (zero sorry/axiom) |
