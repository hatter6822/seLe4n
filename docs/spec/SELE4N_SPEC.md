...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.54` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 281,417 across 285 Lean files |
| **Test LoC** | 61,415 across 69 Lean test suites |
| **Proved declarations** | 9,491 theorem/lemma declarations (zero sorry/axiom) |
