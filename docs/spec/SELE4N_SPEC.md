...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.34` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 289,618 across 288 Lean files |
| **Test LoC** | 64,535 across 69 Lean test suites |
| **Proved declarations** | 9,685 theorem/lemma declarations (zero sorry/axiom) |
