...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.72` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 336,639 across 315 Lean files |
| **Test LoC** | 70,102 across 70 Lean test suites |
| **Proved declarations** | 11,206 theorem/lemma declarations (zero sorry/axiom) |
