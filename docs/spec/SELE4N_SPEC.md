...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.45` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 155,022 across 218 Lean files |
| **Test LoC** | 34,163 across 52 Lean test suites |
| **Proved declarations** | 4,971 theorem/lemma declarations (zero sorry/axiom) |
