...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.76` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 283,720 across 285 Lean files |
| **Test LoC** | 62,135 across 69 Lean test suites |
| **Proved declarations** | 9,546 theorem/lemma declarations (zero sorry/axiom) |
