...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.52` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 160,155 across 224 Lean files |
| **Test LoC** | 35,460 across 54 Lean test suites |
| **Proved declarations** | 5,218 theorem/lemma declarations (zero sorry/axiom) |
