...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.56` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 281,963 across 285 Lean files |
| **Test LoC** | 61,529 across 69 Lean test suites |
| **Proved declarations** | 9,503 theorem/lemma declarations (zero sorry/axiom) |
