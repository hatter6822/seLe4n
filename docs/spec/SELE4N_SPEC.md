...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.75` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 223,512 across 258 Lean files |
| **Test LoC** | 44,236 across 65 Lean test suites |
| **Proved declarations** | 7,151 theorem/lemma declarations (zero sorry/axiom) |
