...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.35.71` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 386,443 across 331 Lean files |
| **Test LoC** | 78,776 across 70 Lean test suites |
| **Proved declarations** | 12,905 theorem/lemma declarations (zero sorry/axiom) |
...
bound on a post-state across all **178** statements in the family (the
