...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.45` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 270,910 across 280 Lean files |
| **Test LoC** | 58,161 across 69 Lean test suites |
| **Proved declarations** | 9,101 theorem/lemma declarations (zero sorry/axiom) |
