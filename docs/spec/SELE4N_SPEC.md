...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.22` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 265,046 across 278 Lean files |
| **Test LoC** | 55,398 across 68 Lean test suites |
| **Proved declarations** | 8,864 theorem/lemma declarations (zero sorry/axiom) |
