...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.30` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 144,915 across 207 Lean files |
| **Test LoC** | 31,525 across 47 Lean test suites |
| **Proved declarations** | 4,537 theorem/lemma declarations (zero sorry/axiom) |
