...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.59` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 282,266 across 285 Lean files |
| **Test LoC** | 61,783 across 69 Lean test suites |
| **Proved declarations** | 9,510 theorem/lemma declarations (zero sorry/axiom) |
