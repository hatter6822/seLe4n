...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.92` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 343,521 across 323 Lean files |
| **Test LoC** | 71,084 across 70 Lean test suites |
| **Proved declarations** | 11,444 theorem/lemma declarations (zero sorry/axiom) |
