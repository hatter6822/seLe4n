...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.77` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 283,936 across 285 Lean files |
| **Test LoC** | 62,289 across 69 Lean test suites |
| **Proved declarations** | 9,547 theorem/lemma declarations (zero sorry/axiom) |
