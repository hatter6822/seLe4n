...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.64` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 221,352 across 256 Lean files |
| **Test LoC** | 41,317 across 62 Lean test suites |
| **Proved declarations** | 7,053 theorem/lemma declarations (zero sorry/axiom) |
