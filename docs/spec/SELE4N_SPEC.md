...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.73` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 338,888 across 316 Lean files |
| **Test LoC** | 70,253 across 70 Lean test suites |
| **Proved declarations** | 11,264 theorem/lemma declarations (zero sorry/axiom) |
