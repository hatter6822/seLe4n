...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.64` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 173,252 across 233 Lean files |
| **Test LoC** | 37,563 across 58 Lean test suites |
| **Proved declarations** | 5,806 theorem/lemma declarations (zero sorry/axiom) |
