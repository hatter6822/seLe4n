...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.59` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 216,924 across 254 Lean files |
| **Test LoC** | 40,194 across 61 Lean test suites |
| **Proved declarations** | 6,882 theorem/lemma declarations (zero sorry/axiom) |
