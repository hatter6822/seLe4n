...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.149` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 238,555 across 265 Lean files |
| **Test LoC** | 48,449 across 67 Lean test suites |
| **Proved declarations** | 7,801 theorem/lemma declarations (zero sorry/axiom) |
