...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.68` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 221,825 across 256 Lean files |
| **Test LoC** | 43,401 across 64 Lean test suites |
