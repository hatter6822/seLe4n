...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.96` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 347,188 across 325 Lean files |
| **Test LoC** | 71,244 across 70 Lean test suites |
| **Proved declarations** | 11,567 theorem/lemma declarations (zero sorry/axiom) |
