...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.112` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 354,786 across 328 Lean files |
| **Test LoC** | 71,694 across 70 Lean test suites |
| **Proved declarations** | 11,875 theorem/lemma declarations (zero sorry/axiom) |
