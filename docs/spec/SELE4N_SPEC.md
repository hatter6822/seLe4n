...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.35.83` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 387,521 across 331 Lean files |
| **Test LoC** | 78,892 across 70 Lean test suites |
| **Proved declarations** | 12,918 theorem/lemma declarations (zero sorry/axiom) |
