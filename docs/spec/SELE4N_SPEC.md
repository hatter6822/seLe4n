...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.31` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 145,028 across 207 Lean files |
| **Test LoC** | 31,606 across 47 Lean test suites |
| **Proved declarations** | 4,547 theorem/lemma declarations (zero sorry/axiom) |
