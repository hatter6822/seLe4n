...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.99` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 235,127 across 264 Lean files |
| **Test LoC** | 47,133 across 67 Lean test suites |
| **Proved declarations** | 7,648 theorem/lemma declarations (zero sorry/axiom) |
