...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.50` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 271,905 across 280 Lean files |
| **Test LoC** | 58,493 across 69 Lean test suites |
| **Proved declarations** | 9,131 theorem/lemma declarations (zero sorry/axiom) |
