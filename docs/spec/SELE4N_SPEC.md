...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.35.99` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 391,919 across 333 Lean files |
| **Test LoC** | 79,621 across 70 Lean test suites |
| **Proved declarations** | 13,056 theorem/lemma declarations (zero sorry/axiom) |
