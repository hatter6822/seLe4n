...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.79` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 339,181 across 317 Lean files |
| **Test LoC** | 70,493 across 70 Lean test suites |
| **Proved declarations** | 11,274 theorem/lemma declarations (zero sorry/axiom) |
