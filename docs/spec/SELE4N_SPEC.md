...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.16` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 264,386 across 278 Lean files |
| **Test LoC** | 55,295 across 68 Lean test suites |
| **Proved declarations** | 8,848 theorem/lemma declarations (zero sorry/axiom) |
