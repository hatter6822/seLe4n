...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.93` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 343,801 across 323 Lean files |
| **Test LoC** | 71,095 across 70 Lean test suites |
| **Proved declarations** | 11,449 theorem/lemma declarations (zero sorry/axiom) |
...
bound on a post-state across all **162** statements in the family (the
