...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.69` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 221,826 across 256 Lean files |
| **Test LoC** | 43,434 across 64 Lean test suites |
