...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.60` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 331,982 across 311 Lean files |
| **Test LoC** | 69,158 across 70 Lean test suites |
| **Proved declarations** | 11,041 theorem/lemma declarations (zero sorry/axiom) |
