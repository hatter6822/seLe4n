...
| **Production LoC** | 136,887 across 198 Lean files |
| **Test LoC** | 28,740 across 41 Lean test suites |
| **Proved declarations** | 4,017 theorem/lemma declarations (zero sorry/axiom) |
...
2.11. **WS-SM Phase SM3.D (post-SM3.C) deadlock-freedom, wait-graph
   ...
   **SM3.D.6 — `boundedWait_under_2pl`**: a transition with lock-set
   ...
   `|S| · (numCores − 1) · T_cs` by `totalWaitCost_eq`.
