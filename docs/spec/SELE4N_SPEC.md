...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.34.85` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 339,431 across 317 Lean files |
| **Test LoC** | 70,566 across 70 Lean test suites |
| **Proved declarations** | 11,287 theorem/lemma declarations (zero sorry/axiom) |
