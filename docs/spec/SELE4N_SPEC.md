...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.66` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 175,829 across 240 Lean files |
| **Test LoC** | 37,914 across 59 Lean test suites |
| **Proved declarations** | 5,891 theorem/lemma declarations (zero sorry/axiom) |
