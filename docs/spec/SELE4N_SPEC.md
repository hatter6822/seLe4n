...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.44` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 270,681 across 280 Lean files |
| **Test LoC** | 58,100 across 69 Lean test suites |
| **Proved declarations** | 9,090 theorem/lemma declarations (zero sorry/axiom) |
