...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.65` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 221,499 across 256 Lean files |
| **Test LoC** | 41,374 across 62 Lean test suites |
| **Proved declarations** | 7,054 theorem/lemma declarations (zero sorry/axiom) |
