...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.9` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 261,468 across 278 Lean files |
| **Test LoC** | 54,395 across 68 Lean test suites |
| **Proved declarations** | 8,755 theorem/lemma declarations (zero sorry/axiom) |
