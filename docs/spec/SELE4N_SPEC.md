...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.70` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 221,826 across 256 Lean files |
| **Test LoC** | 43,455 across 64 Lean test suites |
| **Proved declarations** | 7,065 theorem/lemma declarations (zero sorry/axiom) |
