...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.55` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 281,801 across 285 Lean files |
| **Test LoC** | 61,481 across 69 Lean test suites |
| **Proved declarations** | 9,498 theorem/lemma declarations (zero sorry/axiom) |
