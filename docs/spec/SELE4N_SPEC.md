...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.94` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 233,675 across 263 Lean files |
| **Test LoC** | 46,378 across 66 Lean test suites |
| **Proved declarations** | 7,578 theorem/lemma declarations (zero sorry/axiom) |
