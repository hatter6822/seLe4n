...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.86` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 229,923 across 262 Lean files |
| **Test LoC** | 45,563 across 65 Lean test suites |
| **Proved declarations** | 7,430 theorem/lemma declarations (zero sorry/axiom) |
