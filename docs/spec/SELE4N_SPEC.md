...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.41` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 153,051 across 215 Lean files |
| **Test LoC** | 33,765 across 51 Lean test suites |
| **Proved declarations** | 4,891 theorem/lemma declarations (zero sorry/axiom) |
