...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.35.199` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 415,446 across 339 Lean files |
| **Test LoC** | 84,404 across 70 Lean test suites |
| **Proved declarations** | 13,739 theorem/lemma declarations (zero sorry/axiom) |
