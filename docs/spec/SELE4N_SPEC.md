...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.10` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 262,088 across 278 Lean files |
| **Test LoC** | 54,942 across 68 Lean test suites |
| **Proved declarations** | 8,781 theorem/lemma declarations (zero sorry/axiom) |
...
by, so the two accepted timing channels are comparable.  Bounded is not closed:
`lockContentionAlphabet_at_least_two` says so.
