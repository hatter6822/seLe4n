...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.73` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 223,251 across 258 Lean files |
| **Test LoC** | 44,158 across 65 Lean test suites |
| **Proved declarations** | 7,141 theorem/lemma declarations (zero sorry/axiom) |
