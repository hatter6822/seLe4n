...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.67` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 282,807 across 285 Lean files |
| **Test LoC** | 61,948 across 69 Lean test suites |
| **Proved declarations** | 9,518 theorem/lemma declarations (zero sorry/axiom) |
