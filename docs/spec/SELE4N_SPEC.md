...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.7` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 257,136 across 275 Lean files |
| **Test LoC** | 53,027 across 68 Lean test suites |
| **Proved declarations** | 8,570 theorem/lemma declarations (zero sorry/axiom) |
