...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.80` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 284,252 across 285 Lean files |
| **Test LoC** | 62,447 across 69 Lean test suites |
| **Proved declarations** | 9,556 theorem/lemma declarations (zero sorry/axiom) |
