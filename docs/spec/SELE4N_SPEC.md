...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.51` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 274,287 across 282 Lean files |
| **Test LoC** | 59,324 across 69 Lean test suites |
| **Proved declarations** | 9,225 theorem/lemma declarations (zero sorry/axiom) |
