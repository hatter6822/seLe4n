...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.14` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 264,031 across 278 Lean files |
| **Test LoC** | 55,177 across 68 Lean test suites |
| **Proved declarations** | 8,842 theorem/lemma declarations (zero sorry/axiom) |
