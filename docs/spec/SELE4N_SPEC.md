...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.95` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 234,181 across 264 Lean files |
| **Test LoC** | 46,528 across 66 Lean test suites |
| **Proved declarations** | 7,612 theorem/lemma declarations (zero sorry/axiom) |
