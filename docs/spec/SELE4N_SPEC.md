...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.84` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 229,484 across 262 Lean files |
| **Test LoC** | 45,464 across 65 Lean test suites |
| **Proved declarations** | 7,416 theorem/lemma declarations (zero sorry/axiom) |
