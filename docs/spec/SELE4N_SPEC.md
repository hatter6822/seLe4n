...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.94` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 286,246 across 286 Lean files |
| **Test LoC** | 63,154 across 69 Lean test suites |
| **Proved declarations** | 9,596 theorem/lemma declarations (zero sorry/axiom) |
