...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.18` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 264,629 across 278 Lean files |
| **Test LoC** | 55,318 across 68 Lean test suites |
| **Proved declarations** | 8,852 theorem/lemma declarations (zero sorry/axiom) |
