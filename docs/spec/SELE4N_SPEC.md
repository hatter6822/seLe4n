...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.89` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 285,612 across 286 Lean files |
| **Test LoC** | 63,161 across 69 Lean test suites |
| **Proved declarations** | 9,576 theorem/lemma declarations (zero sorry/axiom) |
