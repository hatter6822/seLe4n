...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.60` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 165,957 across 231 Lean files |
| **Test LoC** | 36,482 across 56 Lean test suites |
| **Proved declarations** | 5,470 theorem/lemma declarations (zero sorry/axiom) |
