...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.17` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 264,552 across 278 Lean files |
| **Test LoC** | 55,317 across 68 Lean test suites |
| **Proved declarations** | 8,851 theorem/lemma declarations (zero sorry/axiom) |
