...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.11` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 263,135 across 278 Lean files |
| **Test LoC** | 55,035 across 68 Lean test suites |
| **Proved declarations** | 8,814 theorem/lemma declarations (zero sorry/axiom) |
