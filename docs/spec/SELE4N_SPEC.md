...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.35.98` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 391,805 across 333 Lean files |
| **Test LoC** | 79,486 across 70 Lean test suites |
| **Proved declarations** | 13,054 theorem/lemma declarations (zero sorry/axiom) |
