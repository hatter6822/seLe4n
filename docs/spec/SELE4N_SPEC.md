...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.70` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 283,129 across 285 Lean files |
| **Test LoC** | 61,990 across 69 Lean test suites |
| **Proved declarations** | 9,530 theorem/lemma declarations (zero sorry/axiom) |
