...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.63` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 282,422 across 285 Lean files |
| **Test LoC** | 61,825 across 69 Lean test suites |
| **Proved declarations** | 9,514 theorem/lemma declarations (zero sorry/axiom) |
