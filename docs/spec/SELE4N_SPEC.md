...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.35.22` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 376,395 across 330 Lean files |
| **Test LoC** | 76,029 across 70 Lean test suites |
| **Proved declarations** | 12,607 theorem/lemma declarations (zero sorry/axiom) |
