...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.47` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 155,819 across 220 Lean files |
| **Test LoC** | 34,272 across 52 Lean test suites |
| **Proved declarations** | 5,004 theorem/lemma declarations (zero sorry/axiom) |
