...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.60` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 218,390 across 255 Lean files |
| **Test LoC** | 40,813 across 62 Lean test suites |
| **Proved declarations** | 6,947 theorem/lemma declarations (zero sorry/axiom) |
