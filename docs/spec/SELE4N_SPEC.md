...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.66` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 221,816 across 256 Lean files |
| **Test LoC** | 41,464 across 62 Lean test suites |
