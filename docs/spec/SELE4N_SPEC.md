...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.58` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 214,340 across 253 Lean files |
| **Test LoC** | 40,056 across 61 Lean test suites |
| **Proved declarations** | 6,809 theorem/lemma declarations (zero sorry/axiom) |
