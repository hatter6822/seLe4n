...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.40` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 151,315 across 213 Lean files |
| **Test LoC** | 33,377 across 50 Lean test suites |
| **Proved declarations** | 4,819 theorem/lemma declarations (zero sorry/axiom) |
