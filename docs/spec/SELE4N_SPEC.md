...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.49` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 271,514 across 280 Lean files |
| **Test LoC** | 58,407 across 69 Lean test suites |
| **Proved declarations** | 9,120 theorem/lemma declarations (zero sorry/axiom) |
