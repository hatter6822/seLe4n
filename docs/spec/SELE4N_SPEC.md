...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.87` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 285,079 across 285 Lean files |
| **Test LoC** | 62,782 across 69 Lean test suites |
| **Proved declarations** | 9,569 theorem/lemma declarations (zero sorry/axiom) |
