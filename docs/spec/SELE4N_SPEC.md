...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.86` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 285,022 across 285 Lean files |
| **Test LoC** | 62,782 across 69 Lean test suites |
| **Proved declarations** | 9,567 theorem/lemma declarations (zero sorry/axiom) |
