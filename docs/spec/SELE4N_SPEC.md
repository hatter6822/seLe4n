...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.83` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 229,376 across 262 Lean files |
| **Test LoC** | 45,425 across 65 Lean test suites |
| **Proved declarations** | 7,412 theorem/lemma declarations (zero sorry/axiom) |
