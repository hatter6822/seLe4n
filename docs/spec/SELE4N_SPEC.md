...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.93` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 286,137 across 286 Lean files |
| **Test LoC** | 63,120 across 69 Lean test suites |
| **Proved declarations** | 9,594 theorem/lemma declarations (zero sorry/axiom) |
