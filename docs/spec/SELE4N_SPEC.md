...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.96` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 234,720 across 264 Lean files |
| **Test LoC** | 46,694 across 66 Lean test suites |
| **Proved declarations** | 7,636 theorem/lemma declarations (zero sorry/axiom) |
