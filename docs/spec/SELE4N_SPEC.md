...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.61` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 221,046 across 256 Lean files |
| **Test LoC** | 41,106 across 62 Lean test suites |
