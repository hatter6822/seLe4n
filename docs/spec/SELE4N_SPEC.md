...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.164` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 187,823 across 251 Lean files |
| **Test LoC** | 39,822 across 61 Lean test suites |
| **Proved declarations** | 6,186 theorem/lemma declarations (zero sorry/axiom) |
