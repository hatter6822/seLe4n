...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.35.200` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 417,397 across 340 Lean files |
| **Test LoC** | 84,404 across 70 Lean test suites |
| **Proved declarations** | 13,805 theorem/lemma declarations (zero sorry/axiom) |
