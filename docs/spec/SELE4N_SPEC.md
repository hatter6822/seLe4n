...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.65` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 175,744 across 239 Lean files |
| **Test LoC** | 37,907 across 59 Lean test suites |
| **Proved declarations** | 5,888 theorem/lemma declarations (zero sorry/axiom) |
