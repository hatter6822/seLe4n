...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.31.46` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 155,735 across 220 Lean files |
| **Test LoC** | 34,225 across 52 Lean test suites |
| **Proved declarations** | 5,002 theorem/lemma declarations (zero sorry/axiom) |
