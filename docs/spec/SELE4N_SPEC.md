...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.82` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 229,159 across 262 Lean files |
| **Test LoC** | 45,382 across 65 Lean test suites |
| **Proved declarations** | 7,397 theorem/lemma declarations (zero sorry/axiom) |
