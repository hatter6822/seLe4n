...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.80` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 228,599 across 262 Lean files |
| **Test LoC** | 45,295 across 65 Lean test suites |
| **Proved declarations** | 7,369 theorem/lemma declarations (zero sorry/axiom) |
