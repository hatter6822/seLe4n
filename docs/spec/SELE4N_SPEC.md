...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.74` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 223,334 across 258 Lean files |
| **Test LoC** | 44,185 across 65 Lean test suites |
| **Proved declarations** | 7,143 theorem/lemma declarations (zero sorry/axiom) |
