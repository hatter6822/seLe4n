...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.33.43` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 270,281 across 280 Lean files |
| **Test LoC** | 57,946 across 69 Lean test suites |
| **Proved declarations** | 9,077 theorem/lemma declarations (zero sorry/axiom) |
