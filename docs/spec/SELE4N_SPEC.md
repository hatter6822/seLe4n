...
| **Production LoC** | 135,127 across 196 Lean files |
| **Test LoC** | 28,108 across 40 Lean test suites |
| **Proved declarations** | 3,958 theorem/lemma declarations (zero sorry/axiom) |
...
2.10. **WS-SM Phase SM3.C (post-SM3.B) two-phase-locking discipline,
   ...
   **SM3.C inventory (70 entries)**: `withLockSetTheorems` in
   ...
   `.atomicity` = 8, `.dynamicChain` = 17) with a compile-time-checked
