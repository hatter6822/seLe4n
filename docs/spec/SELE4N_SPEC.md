...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.35.73` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 386,493 across 331 Lean files |
| **Test LoC** | 78,776 across 70 Lean test suites |
| **Proved declarations** | 12,909 theorem/lemma declarations (zero sorry/axiom) |
