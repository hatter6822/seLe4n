...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.35.105` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 392,459 across 333 Lean files |
| **Test LoC** | 79,904 across 70 Lean test suites |
| **Proved declarations** | 13,063 theorem/lemma declarations (zero sorry/axiom) |
