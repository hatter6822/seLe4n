...
| Attribute | Value |
|-----------|-------|
| **Package version** | `0.32.111` (`lakefile.toml`) |
| **Lean toolchain** | `v4.28.0` (`lean-toolchain`) |
| **Production LoC** | 237,103 across 264 Lean files |
| **Test LoC** | 48,279 across 67 Lean test suites |
| **Proved declarations** | 7,749 theorem/lemma declarations (zero sorry/axiom) |
