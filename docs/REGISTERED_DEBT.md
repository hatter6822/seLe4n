...
[`docs/planning/SCHEDCONTEXT_DONATION_CHAIN_PLAN.md`](planning/SCHEDCONTEXT_DONATION_CHAIN_PLAN.md)
(53 sub-tasks across OD1..OD6). It closes two section-A rows: the onward-donation
...
| **WS-OD** | v0.34.98– (in flight; OD1 closed at v0.34.108, OD2 at v0.34.125, OD3 at v0.35.1; closes before WS-RR RR8 — SchedContext donation chains, [`SCHEDCONTEXT_DONATION_CHAIN_PLAN.md`](planning/SCHEDCONTEXT_DONATION_CHAIN_PLAN.md)) |
