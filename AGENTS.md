...
- `SeLe4n/Kernel/InformationFlow/NonInterferenceCrossCore.lean` (~4154 lines)
...
- `tests/SmpInformationFlowSuite.lean` (~3263 lines)
...
- `SeLe4n/Kernel/Scheduler/PriorityInheritance/PerCore.lean` (~1905 lines)
...
- `SeLe4n/Kernel/IPC/Operations/Endpoint.lean` (~1517 lines)
