...
Lean 4.28.0 toolchain, Lake build system, version 0.33.102.
...
- `docs/spec/SELE4N_SPEC.md` (~4218 lines)
...
- `docs/planning/SMP_RUST_HAL_PLAN.md` (~3030 lines)
...
- `docs/DEVELOPMENT.md` (~1326 lines)
...
- `docs/planning/SMP_PER_CORE_SCHEDULER_PLAN.md` (~1152 lines)
