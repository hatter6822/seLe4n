...
Lean 4.28.0 toolchain, Lake build system, version 0.33.77.
...
- `SeLe4n/Kernel/Concurrency/Locks/LockSetTransitions.lean` (~2560 lines)
...
- `tests/OperationChainSuite.lean` (~2456 lines)
...
- `SeLe4n/Kernel/InformationFlow/TaintPropagation.lean` (~1971 lines)
...
- `SeLe4n/Kernel/Concurrency/Locks/Deadlock.lean` (~1275 lines)
...
- `SeLe4n/Kernel/FrozenOps/Operations.lean` (~1123 lines)
