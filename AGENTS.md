...
Lean 4.28.0 toolchain, Lake build system, version 0.32.76.
...
- `docs/gitbook/12-proof-and-invariant-map.md` (~3167 lines)
...
- `SeLe4n/Kernel/Architecture/TlbShootdown.lean` (~1430 lines)
- `SeLe4n/Platform/FFI.lean` (~1422 lines)
- `SeLe4n/Kernel/Architecture/TlbShootdownProtocol.lean` (~1421 lines)
...
- `tests/SmpTlbShootdownSuite.lean` (~1263 lines)
...
- **WS-SM SMP multi-core completion workstream IN FLIGHT (v0.31.2 → v1.0.0)**:
  ...
  **Rust HAL at v0.32.76**: 769 tests, zero clippy warnings,
  zero `#[ignore]`'d.
