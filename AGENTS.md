...
Lean 4.28.0 toolchain, Lake build system, version 0.32.150.
...
- `docs/spec/SELE4N_SPEC.md` (~3850 lines)
...
- `docs/planning/SMP_TLB_SHOOTDOWN_PLAN.md` (~2143 lines)
...
- `SeLe4n/Kernel/Architecture/Invariant.lean` (~1662 lines)
