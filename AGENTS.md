...
Lean 4.28.0 toolchain, Lake build system, version 0.32.94.
...
- `SeLe4n/Kernel/InformationFlow/Invariant/Operations.lean` (~4581 lines)
- `SeLe4n/Kernel/IPC/Invariant/Defs.lean` (~4351 lines)
- `SeLe4n/Model/State.lean` (~4143 lines)
...
- `SeLe4n/Kernel/API.lean` (~3019 lines)
...
- `tests/SmpTlbShootdownSuite.lean` (~2235 lines)
...
- `SeLe4n/Kernel/Lifecycle/Operations/RetypeWrappers.lean` (~1869 lines)
- `SeLe4n/Kernel/Concurrency/Locks/Serializability.lean` (~1854 lines)
- `SeLe4n/Model/FreezeProofs.lean` (~1802 lines)
...
- `SeLe4n/Platform/FFI.lean` (~1525 lines)
...
- `SeLe4n/Kernel/Architecture/PerCoreCacheModel.lean` (~1426 lines)
...
- `docs/planning/SMP_TLB_SHOOTDOWN_PLAN.md` (~1050 lines)
...
- `SeLe4n/Model/FrozenState.lean` (~819 lines)
- `docs/dev_history/audits/WS_RC_R4_CLOSEOUT_PLAN.md` (~818 lines)
- `tests/TwoPhaseArchSuite.lean` (~816 lines)
...
- **WS-SM SMP multi-core completion workstream IN FLIGHT (v0.31.2 → v1.0.0)**:
  ...
  **Rust HAL at v0.32.94**: 789 tests, zero clippy warnings,
  zero `#[ignore]`'d.
