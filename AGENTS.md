...
Lean 4.28.0 toolchain, Lake build system, version 0.32.88.
...
- **WS-SM SMP multi-core completion workstream IN FLIGHT (v0.31.2 → v1.0.0)**:
  ...
  **Key AK7 metrics at v0.32.87**: `RAW_MATCH_TOTAL` 134
  (`RAW_MATCH_VSPACEROOT` 12 → 13),
  `RAW_LOOKUP_TID` 1310, `GETTCB_ADOPTION` 2157,
  `GETSCHEDCTX_ADOPTION` 287 (re-anchored for the SM7.F review-3 cut —
