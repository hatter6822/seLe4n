...
Lean 4.28.0 toolchain, Lake build system, version 0.33.8.
...
- `tests/SmpInformationFlowSuite.lean` (~4831 lines)
...
- `docs/gitbook/12-proof-and-invariant-map.md` (~3728 lines)
...
- `SeLe4n/Kernel/InformationFlow/DeclassificationPerCore.lean` (~2326 lines)
...
- `docs/planning/SMP_INFORMATION_FLOW_PLAN.md` (~1788 lines)
...
- `tests/InformationFlowSuite.lean` (~1741 lines)
...
- `SeLe4n/Kernel/InformationFlow/Enforcement/Soundness.lean` (~1145 lines)
- `SeLe4n/Kernel/Architecture/VSpace.lean` (~1142 lines)
- `tests/KernelErrorMatrixSuite.lean` (~1139 lines)
- `SeLe4n/Kernel/InformationFlow/Policy.lean` (~1136 lines)
