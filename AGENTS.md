...
Lean 4.28.0 toolchain, Lake build system, version 0.32.78.
...
- **WS-SM SMP multi-core completion workstream IN FLIGHT (v0.31.2 → v1.0.0)**:
  ...
  **Rust HAL at v0.32.78**: 780 tests, zero clippy warnings,
  zero `#[ignore]`'d.
