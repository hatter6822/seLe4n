...
- `docs/spec/SELE4N_SPEC.md` (~4019 lines)
- `SeLe4n/Kernel/Scheduler/Operations/Preservation.lean` (~3911 lines)
- `docs/gitbook/12-proof-and-invariant-map.md` (~3610 lines)
...
- `SeLe4n/Kernel/InformationFlow/NonInterferencePerCore.lean` (~2807 lines)
...
- `tests/SmpInformationFlowSuite.lean` (~2098 lines)
