...
- `SeLe4n/Kernel/InformationFlow/Invariant/Operations.lean` (~4799 lines)
...
- `SeLe4n/Kernel/InformationFlow/NonInterferenceCrossCore.lean` (~4134 lines)
...
- `SeLe4n/Kernel/API.lean` (~3719 lines)
...
- `tests/SmpInformationFlowSuite.lean` (~3057 lines)
...
- `SeLe4n/Kernel/InformationFlow/CovertChannelPerCore.lean` (~1545 lines)
- `SeLe4n/Kernel/Lifecycle/Invariant/SuspendPreservation.lean` (~1488 lines)
- `docs/dev_history/audits/AUDIT_v0.28.0_WORKSTREAM_PLAN.md` (~1480 lines)
- `SeLe4n/Kernel/IPC/Operations/Endpoint.lean` (~1459 lines)
...
- `SeLe4n/Kernel/Lifecycle/Operations/CleanupPreservation.lean` (~1372 lines)
- `docs/dev_history/audits/AUDIT_v0.16.8_IPC_SUBSYSTEM_WORKSTREAM_PLAN.md` (~1357 lines)
- `docs/planning/SMP_INFORMATION_FLOW_PLAN.md` (~1352 lines)
