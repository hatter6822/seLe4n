...
- `tests/SmpInformationFlowSuite.lean` (~2259 lines)
...
- `SeLe4n/Kernel/InformationFlow/NonInterferenceCrossCore.lean` (~901 lines)
...
- `docs/planning/SMP_INFORMATION_FLOW_PLAN.md` (~805 lines)
