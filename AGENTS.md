...
Lean 4.28.0 toolchain, Lake build system, version 0.33.5.
...
- `SeLe4n/Kernel/InformationFlow/Invariant/Operations.lean` (~4807 lines)
...
- `SeLe4n/Kernel/API.lean` (~3660 lines)
...
- `SeLe4n/Kernel/InformationFlow/NonInterferenceCrossCore.lean` (~3073 lines)
...
- `tests/SmpInformationFlowSuite.lean` (~2966 lines)
...
- `SeLe4n/Kernel/Scheduler/PriorityInheritance/PerCore.lean` (~1680 lines)
...
- `SeLe4n/Kernel/InformationFlow/CovertChannelPerCore.lean` (~1468 lines)
...
- `docs/planning/SMP_INFORMATION_FLOW_PLAN.md` (~1269 lines)
