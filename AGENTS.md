...
Lean 4.28.0 toolchain, Lake build system, version 0.34.82.
...
- `docs/spec/SELE4N_SPEC.md` (~4887 lines)
...
- `SeLe4n/Kernel/IPC/Invariant/Structural/PerOperation.lean` (~2546 lines)
...
- `SeLe4n/Kernel/Scheduler/Operations/PerCoreCbs.lean` (~1948 lines)
...
- `tests/LockSetSuite.lean` (~1448 lines)
