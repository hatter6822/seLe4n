...
- `tests/SmpInformationFlowSuite.lean` (~3324 lines)
...
- `SeLe4n/Kernel/Scheduler/PriorityInheritance/PerCore.lean` (~2156 lines)
...
- `SeLe4n/Platform/FFI.lean` (~1743 lines)
...
- `SeLe4n/Kernel/IPC/Operations/Endpoint.lean` (~1616 lines)
