...
- `tests/SmpInformationFlowSuite.lean` (~4818 lines)
...
- `SeLe4n/Kernel/InformationFlow/DeclassificationPerCore.lean` (~2300 lines)
...
- `SeLe4n/Kernel/InformationFlow/Enforcement/Soundness.lean` (~979 lines)
