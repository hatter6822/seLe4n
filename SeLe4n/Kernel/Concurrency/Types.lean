...
At v0.32.x this is statically `4` (matching RPi5 BCM2712); the
...
v0.32.x this is the literal `0`, with `numCores_pos` discharging the
in-range obligation. -/
...
the concrete `numCores = 4` of v0.32.x the property is decidable
