...
/-!
# Service Dependency Acyclicity (TPI-D07)

BFS completeness framework: declarative graph definitions (Layer 0),
structural lemmas (Layer 1), BFS soundness (Layer 2), post-insertion
path decomposition (Layer 3), and acyclicity preservation (Layer 4).
-/
