...
Lean 4.28.0 toolchain, Lake build system, version 0.32.57.
...
- `docs/gitbook/12-proof-and-invariant-map.md` (~3076 lines)
...
- `SeLe4n/Kernel/IPC/CrossCore/EndpointCallInvariant.lean` (~2718 lines)
