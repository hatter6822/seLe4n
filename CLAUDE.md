...
- `tests/SmpInformationFlowSuite.lean` (~2831 lines)
...
- `SeLe4n/Kernel/InformationFlow/CovertChannelPerCore.lean` (~1202 lines)
...
- `docs/planning/SMP_INFORMATION_FLOW_PLAN.md` (~1127 lines)
...
- `SeLe4n/Kernel/InformationFlow/Projection.lean` (~997 lines)
