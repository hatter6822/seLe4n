...
Lean 4.28.0 toolchain, Lake build system, version 0.34.91.
...
- `SeLe4n/Kernel/Concurrency/Locks/LockSetTransitions.lean` (~3751 lines)
...
- `SeLe4n/Kernel/IPC/Invariant/PerCoreBundlePreservation.lean` (~1820 lines)
