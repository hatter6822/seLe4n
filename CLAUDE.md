...
Lean 4.28.0 toolchain, Lake build system, version 0.33.4.
...
- `docs/gitbook/12-proof-and-invariant-map.md` (~3566 lines)
...
- `SeLe4n/Kernel/InformationFlow/ObservableStatePerCore.lean` (~1662 lines)
...
- `tests/SmpInformationFlowSuite.lean` (~1435 lines)
