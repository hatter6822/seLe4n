...
Lean 4.28.0 toolchain, Lake build system, version 0.33.89.
...
- `CHANGELOG.md` (~44581 lines)
- `SeLe4n/Kernel/IPC/Invariant/Structural/DualQueueMembership.lean` (~20252 lines)
- `docs/WORKSTREAM_HISTORY.md` (~11910 lines)
- `tests/SmpInformationFlowSuite.lean` (~11136 lines)
- `SeLe4n/Kernel/Concurrency/Locks/RwLock.lean` (~7902 lines)
- `SeLe4n/Kernel/API.lean` (~5713 lines)
- `SeLe4n/Kernel/InformationFlow/NonInterferenceCrossCore.lean` (~5698 lines)
- `SeLe4n/Kernel/InformationFlow/Invariant/Operations.lean` (~5090 lines)
...
- `SeLe4n/Model/State.lean` (~4495 lines)
...
- `SeLe4n/Kernel/IPC/DualQueue/Transport.lean` (~3206 lines)
- `tests/OperationChainSuite.lean` (~3158 lines)
...
- `SeLe4n/Kernel/IPC/Invariant/Structural/StoreObjectFrame.lean` (~2639 lines)
...
- `SeLe4n/Kernel/Capability/Operations.lean` (~2471 lines)
...
- `SeLe4n/Kernel/IPC/Invariant/EndpointPreservation.lean` (~2296 lines)
...
- `SeLe4n/Kernel/IPC/Invariant/Structural/PerOperation.lean` (~2033 lines)
...
- `SeLe4n/Kernel/IPC/Invariant/PerCoreBundlePreservation.lean` (~1786 lines)
...
- `SeLe4n/Kernel/FrozenOps/Operations.lean` (~1272 lines)
...
- `tests/FrozenOpsSuite.lean` (~956 lines)
...
- `SeLe4n/Model/FrozenState.lean` (~916 lines)
...
- `tests/TwoPhaseArchSuite.lean` (~829 lines)
