...
Lean 4.28.0 toolchain, Lake build system, version 0.32.77.
...
- `SeLe4n/Model/State.lean` (~3927 lines)
...
- `SeLe4n/Platform/Boot.lean` (~3357 lines)
- `SeLe4n/Testing/MainTraceHarness.lean` (~3196 lines)
- `docs/gitbook/12-proof-and-invariant-map.md` (~3194 lines)
...
- `SeLe4n/Kernel/Architecture/Invariant.lean` (~1597 lines)
- `tests/SmpTlbShootdownSuite.lean` (~1571 lines)
- `SeLe4n/Kernel/Architecture/TlbShootdown.lean` (~1494 lines)
...
- `SeLe4n/Platform/FFI.lean` (~1422 lines)
...
- **WS-SM SMP multi-core completion workstream IN FLIGHT (v0.31.2 → v1.0.0)**:
  ...
  **Phase status** (current version: v0.32.76):
  ...
  **Rust HAL at v0.32.77**: 772 tests, zero clippy warnings,
  zero `#[ignore]`'d.
