...
- **Active workstream**: WS-M (Capability subsystem audit & remediation) — Phase 2 (WS-M2) **COMPLETED** (v0.16.15). Phase 3 (WS-M3) plan **REFINED** (v0.16.16, 20 subtasks). Phases M4–M5 remaining. See `docs/audits/AUDIT_v0.16.13_CAPABILITY_SUBSYSTEM_WORKSTREAM_PLAN.md`
...
- **Next milestone**: WS-M3 implementation → M4–M5, then Raspberry Pi 5 hardware binding
