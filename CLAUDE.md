...
- `docs/audits/AUDIT_v0.25.14_WORKSTREAM_PLAN.md` (~2340 lines)
...
- `SeLe4n/Kernel/Architecture/SyscallArgDecode.lean` (~1379 lines)
...
- `docs/gitbook/12-proof-and-invariant-map.md` (~2691 lines)
