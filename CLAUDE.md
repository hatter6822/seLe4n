...
Lean 4.28.0 toolchain, Lake build system, version 0.32.145.
...
- `tests/SmpTlbShootdownSuite.lean` (~3276 lines)
...
- `docs/planning/SMP_RUST_HAL_PLAN.md` (~3026 lines)
...
- `docs/planning/SMP_TLB_SHOOTDOWN_PLAN.md` (~1938 lines)
