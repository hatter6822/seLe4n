...
- `SeLe4n/Kernel/API.lean` (~3347 lines)
...
- `tests/SmpInformationFlowSuite.lean` (~2851 lines)
...
- `SeLe4n/Kernel/InformationFlow/NonInterferenceCrossCore.lean` (~2675 lines)
...
- `SeLe4n/Kernel/InformationFlow/CovertChannelPerCore.lean` (~1291 lines)
- `SeLe4n/Kernel/Scheduler/Operations/PerCoreDomain.lean` (~1267 lines)
- `docs/planning/SMP_INFORMATION_FLOW_PLAN.md` (~1253 lines)
...
- `SeLe4n/Kernel/InformationFlow/Projection.lean` (~1009 lines)
