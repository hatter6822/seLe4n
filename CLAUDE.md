...
Lean 4.28.0 toolchain, Lake build system, version 0.32.70.
...
- `SeLe4n/Kernel/InformationFlow/Invariant/Operations.lean` (~4552 lines)
...
- `tests/SmpIpcSuite.lean` (~1250 lines)
...
- `SeLe4n/Kernel/Lifecycle/Operations/CleanupPreservation.lean` (~1194 lines)
...
- **WS-SM SMP multi-core completion workstream IN FLIGHT (v0.31.2 → v1.0.0)**:
  ...
  **Phase status** (current version: v0.32.66):
