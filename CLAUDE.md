...
- `tests/SmpInformationFlowSuite.lean` (~2824 lines)
...
- `SeLe4n/Kernel/InformationFlow/NonInterferenceCrossCore.lean` (~2586 lines)
...
- `docs/planning/SMP_INFORMATION_FLOW_PLAN.md` (~1042 lines)
...
- `SeLe4n/Kernel/InformationFlow/CovertChannelPerCore.lean` (~1012 lines)
