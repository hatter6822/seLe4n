...
Lean 4.28.0 toolchain, Lake build system, version 0.32.103.
...
- `SeLe4n/Model/State.lean` (~4244 lines)
...
- **WS-SM SMP multi-core completion workstream IN FLIGHT (v0.31.2 → v1.0.0)**:
  ...
  **Phase status** (current version: v0.32.103):
  ...
  | SM8–SM9 | PENDING | — | Info-flow under SMP, release closure (→ v1.0.0) |
