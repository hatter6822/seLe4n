...
Lean 4.28.0 toolchain, Lake build system, version 0.25.7.
...
- **WS-AC Comprehensive Audit Remediation** (v0.25.3–v0.25.7): Phase AC1 COMPLETE (high-severity fixes: S-01, I-01, C-01). Phase AC2 COMPLETE (scheduler & SchedContext hardening: S-02/SC-01, S-03, S-04, S-05, S-06, F-04). Phase AC3 COMPLETE (IPC atomicity & invariant strengthening: I-02, I-04, API-01, F-03). Phases AC4–AC6 pending. See `docs/audits/AUDIT_v0.25.3_WORKSTREAM_PLAN.md`
