...
- `CHANGELOG.md` (~38609 lines)
- `SeLe4n/Kernel/IPC/Invariant/Structural/DualQueueMembership.lean` (~20449 lines)
- `docs/WORKSTREAM_HISTORY.md` (~10700 lines)
- `SeLe4n/Kernel/Concurrency/Locks/RwLock.lean` (~6869 lines)
- `tests/SmpInformationFlowSuite.lean` (~6093 lines)
...
- `docs/spec/SELE4N_SPEC.md` (~4118 lines)
...
- `docs/gitbook/12-proof-and-invariant-map.md` (~3796 lines)
...
- `docs/planning/SMP_INFORMATION_FLOW_PLAN.md` (~2062 lines)
...
- `SeLe4n/Kernel/InformationFlow/FineLockFlow.lean` (~1859 lines)
