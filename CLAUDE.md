...
Lean 4.28.0 toolchain, Lake build system, version 0.25.6.
...
- **WS-AC Comprehensive Audit Remediation** (v0.25.3–v0.25.6): Phase AC1 COMPLETE (high-severity fixes: S-01, I-01, C-01). Phase AC2 COMPLETE (scheduler & SchedContext hardening: S-02/SC-01, S-03, S-04, S-05, S-06, F-04). Phases AC3–AC6 pending. See `docs/audits/AUDIT_v0.25.3_WORKSTREAM_PLAN.md`
