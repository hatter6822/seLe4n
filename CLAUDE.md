...
Lean 4.28.0 toolchain, Lake build system, version 0.32.58.
...
- `SeLe4n/Kernel/IPC/Invariant/Defs.lean` (~4334 lines)
...
- `SeLe4n/Kernel/IPC/CrossCore/EndpointCallInvariant.lean` (~2951 lines)
...
- `SeLe4n/Kernel/Scheduler/PriorityInheritance/PerCore.lean` (~1522 lines)
...
- `SeLe4n/Kernel/IPC/Invariant/PerCoreBundlePreservation.lean` (~1352 lines)
...
- `SeLe4n/Kernel/Lifecycle/Suspend.lean` (~862 lines)
...
- **WS-SM SMP multi-core completion workstream IN FLIGHT (v0.31.2 → v1.0.0)**:
  ...
  **Phase status** (current version: v0.32.58):
